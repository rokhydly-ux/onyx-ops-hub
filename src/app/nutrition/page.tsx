...
const FATS_ICON =
  "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781375735/A_cute__highly_detailed_3D_202606131826_jbhb58.jpg";
const WATER_ICON =
  "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781375733/A_cute__highly_detailed_3D_202606131825_3_jyrhrd.jpg";
const PROTEINS_ICON =
  "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781375734/A_cute__highly_detailed_3D_202606131825_2_roav76.jpg";
const CARBS_ICON =
  "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781375738/A_cute__highly_detailed_3D_202606131825_1_epyark.jpg";
const CALS_ICON =
  "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781375768/A_cute__highly_detailed_3D_202606131825_mxabkm.jpg";

const MENU_ICONS = {
  dashboard:
    "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781535959/A_cute__highly_detailed_3D_202606151505_ytie6s.jpg",
  samaMenu:
    "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781535959/A_cute__highly_detailed_3D_202606151505_1_uvgqf0.jpg",
  monJour:
    "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781535958/A_cute__highly_detailed_3D_202606151505_2_akqmx4.jpg",
  fitness:
    "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781535958/A_cute__highly_detailed_3D_202606151505_3_punr1t.jpg",
  shop: "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781535958/A_cute__highly_detailed_3D_202606151505_4_erkmnd.jpg",
  profile:
    "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781536233/A_cute__highly_detailed_3D_202606151510_uj9z5c.jpg",
  favorites:
    "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781540350/A_cute__highly_detailed_3D_202606151617_hk2xbf.jpg",
  community:
    "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781804851/camera_ohydou.jpg",
  weight:
    "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781458367/A_cute__highly_detailed_3D_202606141732_kn3ujk.jpg",
  minuteDoc:
    "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781541191/A_cute__highly_detailed_3D_202606151632_qytnih.jpg",
  ...
  coaching:
    "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781540692/A_cute__highly_detailed_3D_202606151624_lzxhup.jpg",
};
...
const RECIPE_FILTERS = [
  ...
  { id: "Favoris", label: "Mes Favoris", icon: null },
  {
    id: "Populaire",
    label: "Top Recettes",
    icon: "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781443964/A_cute__highly_detailed_3D_202606141332_ggiubt.jpg",
  },
  {
    id: "Low Calories",
    label: "Ventre Plat / Woyof",
    icon: "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781444369/A_cute__highly_detailed_3D_202606141339_gqzmei.jpg",
  },
  {
    id: "Desserts",
    label: "Collations Saines",
    icon: "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781444566/supprimer_le_frame__remplace_le_202606141341_ayzsoe.jpg",
  },
  {
    id: "Healthy",
    label: "Fraîcheur / Détox",
    icon: "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781444564/A_cute__highly_detailed_3D_202606141342_yn2v23.jpg",
  },
  {
    id: "Main Course",
    label: "Plats de Résistance",
    icon: "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781444638/A_cute__highly_detailed_3D_202606141343_zsz5mp.jpg",
  },
];
...
const DEFAULT_SEED_POSTS = [
  {
    ...
    content:
      "🔥 Alhamdoulillah ! Regardez la transformation incroyable d'Amina après seulement 4 semaines sur le programme Mode Guidé. Thiéboudienne revisité et zéro sucre raffiné. Qui relève le défi ce mois-ci ? 👇",
    image_url:
      "https://res.cloudinary.com/dtr2wtoty/image/upload/v1782594141/bols_gjqh7n.jpg",
    ...
    clients: {
      id: "coach-rokhy",
      full_name: "Coach Rokhy",
      avatar_url:
        "https://res.cloudinary.com/dtr2wtoty/image/upload/v1784209735/557516971_10235324002253110_1070574324835198049_n_ch9we7.jpg",
    },
  },
  {
    id: "seed-2",
    client_id: "chef-kofi",
    content:
      "🍳 Astuce du Chef : Pour un Fufu léger et digeste, remplacez la moitié de la farine de manioc par de la purée de chou-fleur ou d'avoine fine. Testé et approuvé par tout le studio ! #Lekkologue #Santé",
    image_url:
    ...
    clients: {
      ...
      full_name: "Chef Kofi",
      avatar_url:
        "https://ui-avatars.com/api/?name=Chef+Kofi&background=39FF14&color=000",
    },
  },
  {
    id: "seed-3",
    client_id: "dr-fatima",
    content:
      "💧 Rappel hydratation : Boire 2 grands verres d'eau 15 minutes avant votre Thiéboudienne augmente la satiété et facilite la digestion. Combien de verres au compteur aujourd'hui ?",
    image_url:
      "https://res.cloudinary.com/dtr2wtoty/image/upload/v1783099524/Woman_drinking_clear_water_2K_202607031724_wuqqco.jpg",
    ...
    clients: {
      ...
      full_name: "Dr. Fatima",
      avatar_url:
        "https://ui-avatars.com/api/?name=Dr+Fatima&background=000&color=39FF14",
    },
  },
];
...
const DEFAULT_SEED_STORIES = [
  {
    ...
    client_id: "coach-rokhy",
    media_url:
      "https://res.cloudinary.com/dtr2wtoty/image/upload/v1783286332/IMG-20250820-WA0117_iegikb.jpg",
    media_type: "image",
...
const SHOP_DATA = [
  {
    ...
    produits: [
      {
        id: "prod_001",
        nom: "Fonio Premium Pré-lavé (500g)",
        description_courte:
          "Le miracle sans gluten à IG bas, prêt à cuire en 5 minutes.",
        description_longue:
          "Issu de coopératives locales, notre Fonio est soigneusement lavé et débarrassé de tout résidu sableux. L'alternative parfaite au riz blanc pour vos déjeuners.",
        prix_standard: 2500,
        prix_premium: 2100,
        stock: 100,
        rating: 4.8,
        image_url:
          "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781199255/A_premium_studio_shot_of_202606111733_kaohlz.jpg",
        badge: "Best Seller",
        goal: "cooking",
      },
      {
        id: "prod_002",
        nom: "Poudre de Moringa Bio (150g)",
        description_courte:
          "La multivitamine naturelle d'Afrique pour booster votre métabolisme.",
        description_longue:
          "Riche en fer, calcium et vitamines. Saupoudrez 1 cuillère par jour sur vos plats en fin de cuisson pour une énergie décuplée.",
        prix_standard: 3500,
        prix_premium: 2900,
        stock: 50,
        rating: 4.9,
      ...
      {
        id: "prod_005",
        nom: "Soumbala / Nététou Pur (100g)",
        description_courte:
          "L'exhausteur de goût santé qui protège votre cœur.",
        description_longue:
          "Le remplaçant idéal de vos bouillons cubes industriels. Donne une saveur profonde à vos plats tout en régulant la tension.",
        prix_standard: 1500,
        prix_premium: 1200,
        stock: 120,
        rating: 4.5,
  ...
  },
  {
    ...
    produits: [
      {
        id: "prod_006",
        nom: "Bissap Rouge Séché (250g)",
        description_courte:
          "Le diurétique naturel par excellence. Grandes fleurs de qualité.",
        description_longue:
          "Infusez à froid ou à chaud sans sucre. Aide à combattre la rétention d'eau et à dégonfler le ventre rapidement.",
        prix_standard: 2000,
        prix_premium: 1600,
        stock: 200,
        rating: 4.9,
      ...
      {
        id: "prod_009",
        nom: "Thé Vert Ataya Spécial (200g)",
        description_courte: "Les feuilles pures pour un Ataya brûle-graisse.",
        description_longue:
          "Remplacez le thé bas de gamme. Un thé vert riche en antioxydants (EGCG) conçu pour être bu sans sucre.",
        prix_standard: 3500,
        prix_premium: 2900,
        stock: 90,
        rating: 4.6,
  ...
  },
  {
    ...
    produits: [
      {
        id: "prod_011",
        nom: "Pâte d'Arachide Pure (300g)",
        description_courte:
          "100% arachide torréfiée. Zéro huile ajoutée, zéro sucre.",
        description_longue:
          "Le goût de l'enfance, version saine. Idéale pour vos mafés diététiques ou sur vos pancakes d'avoine.",
        prix_standard: 3000,
        prix_premium: 2500,
        stock: 70,
        rating: 4.9,
      ...
      {
        id: "prod_012",
        nom: "Noix de Cajou Grillées (250g)",
        description_courte: "Le snack parfait pour calmer le stress du bureau.",
        description_longue:
  ...
  },
  {
    ...
    produits: [
      {
        id: "prod_016",
        nom: "Gourde Motivante 'Jongoma'",
        description_courte: "Atteignez votre quota d'eau avec style (1.5L).",
        description_longue:
          "Marqueurs de temps imprimés pour vous rappeler de boire de l'eau fraîche toute la journée. Design Vert Néon.",
        prix_standard: 7000,
        prix_premium: 5500,
        stock: 150,
        rating: 4.9,
...
const DEFAULT_RECIPES = [
  {
    id: "def_1",
    type: "Petit-déjeuner",
    nom: "Lakh allégé (Mil & Lait) + Kinkeliba",
    calories: 300,
    is_bol_commun: false,
    bienfaits:
      "Riche en calcium et en sucres lents pour éviter le coup de barre de 11h.",
    ingredients: [
      { nom: "Mil", quantite: 50, unite: "g", rayon: "Marché local" },
      {
  ...
  },
  {
    id: "def_2",
    type: "Petit-déjeuner",
    nom: "Flocons d'avoine, Banane & Café Touba",
    calories: 320,
    is_bol_commun: false,
    bienfaits:
      "Les fibres solubles de l'avoine gonflent dans l'estomac pour une satiété longue durée.",
    ingredients: [
      {
      ...
      { nom: "Banane", quantite: 1, unite: "pièce", rayon: "Marché local" },
      {
        nom: "Café Touba allégé",
        quantite: 1,
        unite: "tasse",
        rayon: "Marché local",
      },
  ...
  },
  {
    id: "def_3",
    type: "Petit-déjeuner",
    nom: "Tartines de Seigle, Sardines & Thé Vert",
    calories: 310,
    is_bol_commun: false,
    bienfaits:
      "Plein d'Oméga-3 excellents pour le cœur et le cerveau, avec un pain à IG très bas.",
    ingredients: [
      {
        nom: "Pain de seigle",
        quantite: 2,
  ...
  },
  {
    id: "def_4",
    type: "Petit-déjeuner",
    nom: "Omelette aux Légumes & Infusion de Djar",
    calories: 280,
    is_bol_commun: false,
    bienfaits:
      "Des protéines de haute qualité dès le matin pour nourrir vos muscles.",
    ingredients: [
  ...
  },
  {
    id: "def_5",
    type: "Petit-déjeuner",
    nom: "Arraw (Bouillie de Mil) sans sucre & Kinkeliba",
    calories: 280,
    is_bol_commun: false,
    bienfaits:
      "Une infusion détoxifiante pour le foie associée à l'énergie douce du mil.",
    ingredients: [
      {
        nom: "Boules de mil (Arraw)",
        quantite: 50,
        unite: "g",
        rayon: "Marché local",
      },
      { nom: "Lait écrémé", quantite: 150, unite: "ml", rayon: "Supermarché" },
      {
        nom: "Feuilles de Kinkeliba",
        quantite: 1,
        unite: "poignée",
        rayon: "Marché local",
      },
  ...
  },
  {
    id: "def_6",
    type: "Déjeuner",
    nom: "Thieboudienne (Option Fonio)",
    calories: 600,
    is_bol_commun: true,
    bienfaits:
      "Le plat national allégé : riche en fibres et minéraux grâce à l'incorporation du Fonio.",
    ingredients: [
      {
        nom: "Thiof (Poisson)",
        quantite: 150,
        unite: "g",
        rayon: "Boucherie / Pêche",
      },
      { nom: "Fonio", quantite: 80, unite: "g", rayon: "Boutique Onyx" },
      { nom: "Chou", quantite: 0.5, unite: "pièce", rayon: "Marché local" },
      {
        nom: "Huile d'olive ou colza",
        quantite: 1,
        unite: "càs",
        rayon: "Supermarché",
      },
      { nom: "Carotte", quantite: 1, unite: "pièce", rayon: "Marché local" },
    ],
  },
  {
    id: "def_7",
    type: "Déjeuner",
    nom: "Mafé allégé au Poulet (Beurre d'arachide)",
    calories: 550,
    is_bol_commun: true,
    bienfaits:
      "L'énergie durable des bonnes graisses de l'arachide pure, sans exploser les calories.",
    ingredients: [
      {
        nom: "Blanc de Poulet",
        quantite: 150,
      ...
      {
        nom: "Pâte d'arachide pure",
        quantite: 30,
        unite: "g",
        rayon: "Boutique Onyx",
      },
      { nom: "Fonio ou Riz", quantite: 60, unite: "g", rayon: "Marché local" },
      { nom: "Oignon", quantite: 1, unite: "pièce", rayon: "Marché local" },
    ],
  },
  {
    id: "def_8",
    type: "Déjeuner",
    nom: "Salade de Fonio au Poulet",
    calories: 450,
    is_bol_commun: false,
    bienfaits:
      "Un repas léger et ultra-protéiné, particulièrement recommandé après le sport.",
    ingredients: [
      { nom: "Poulet", quantite: 150, unite: "g", rayon: "Boucherie / Pêche" },
      { nom: "Fonio", quantite: 60, unite: "g", rayon: "Boutique Onyx" },
      { nom: "Tomate", quantite: 2, unite: "pièce", rayon: "Marché local" },
      { nom: "Moutarde", quantite: 1, unite: "càc", rayon: "Supermarché" },
    ],
  },
  {
    id: "def_9",
    type: "Déjeuner",
    nom: "Yassa Poisson & Riz Étuvé",
    calories: 500,
    is_bol_commun: true,
    bienfaits:
      "Le citron et l'oignon du Yassa agissent comme des boosters d'immunité naturels.",
    ingredients: [
      {
        nom: "Poisson braisé",
        quantite: 150,
      ...
      { nom: "Oignons", quantite: 150, unite: "g", rayon: "Marché local" },
      {
        nom: "Riz local étuvé",
        quantite: 60,
        unite: "g",
      ...
      { nom: "Moutarde", quantite: 1, unite: "càs", rayon: "Supermarché" },
    ],
  },
  {
    id: "def_10",
    type: "Déjeuner",
    nom: "Poisson Braisé (Thiof) & Légumes",
    calories: 480,
    is_bol_commun: false,
    bienfaits:
      "Extrêmement faible en mauvaises graisses, et ultra riche en protéines marines.",
    ingredients: [
      { nom: "Poisson", quantite: 200, unite: "g", rayon: "Boucherie / Pêche" },
      {
        nom: "Légumes (Chou, Carotte)",
        quantite: 200,
        unite: "g",
        rayon: "Marché local",
      },
  ...
  },
  {
    id: "def_11",
    type: "Déjeuner",
    nom: "Soupe Kandia (Gombo) Diététique",
    calories: 520,
    is_bol_commun: true,
    bienfaits:
      "Le gombo agit comme un lubrifiant naturel pour un transit intestinal parfait.",
    ingredients: [
      {
        nom: "Bœuf maigre",
        quantite: 100,
      ...
      { nom: "Gombos frais", quantite: 150, unite: "g", rayon: "Marché local" },
      { nom: "Fonio", quantite: 60, unite: "g", rayon: "Boutique Onyx" },
    ],
  },
  {
    id: "def_12",
    type: "Déjeuner",
    nom: "Chili de Niébé à la Viande",
    calories: 490,
    is_bol_commun: true,
    bienfaits:
      "Le Niébé est le super-héros végétal pour consolider la masse musculaire.",
    ingredients: [
      {
        nom: "Viande hachée maigre",
        quantite: 100,
        unite: "g",
        rayon: "Boucherie / Pêche",
      },
      { nom: "Niébé", quantite: 80, unite: "g", rayon: "Marché local" },
      {
        nom: "Sauce tomate pure",
        quantite: 100,
        unite: "ml",
        rayon: "Supermarché",
      },
  ...
  },
  {
    id: "def_13",
    type: "Déjeuner",
    nom: "Couscous de Mil (Thiéré) Poulet",
    calories: 540,
    is_bol_commun: true,
    bienfaits:
      "Une céréale ancestrale et ultra digeste car totalement sans gluten.",
    ingredients: [
      { nom: "Poulet", quantite: 150, unite: "g", rayon: "Boucherie / Pêche" },
      {
        nom: "Thiéré (Couscous mil)",
        quantite: 60,
        unite: "g",
        rayon: "Marché local",
      },
      { nom: "Légumes", quantite: 150, unite: "g", rayon: "Marché local" },
    ],
  },
  {
    id: "def_14",
    type: "Déjeuner",
    nom: "Mbakhal Saloum Allégé",
    calories: 510,
    is_bol_commun: true,
    bienfaits:
      "Un plat traditionnel réconfortant avec un apport strictement contrôlé en glucides.",
    ingredients: [
      {
        nom: "Viande maigre",
        quantite: 100,
      ...
      { nom: "Riz brisé", quantite: 60, unite: "g", rayon: "Marché local" },
    ],
  },
  {
    id: "def_15",
    type: "Déjeuner",
    nom: "Fonio aux Crevettes & Poivrons",
    calories: 430,
    is_bol_commun: false,
    bienfaits:
      "Apporte une dose de Zinc et d'iode vitale pour réguler la thyroïde.",
    ingredients: [
      {
        nom: "Crevettes",
        quantite: 150,
      ...
      { nom: "Fonio", quantite: 60, unite: "g", rayon: "Boutique Onyx" },
      { nom: "Poivrons", quantite: 150, unite: "g", rayon: "Marché local" },
    ],
  },
  {
    id: "def_16",
    type: "Déjeuner",
    nom: "Yassa Poulet au Fonio",
    calories: 520,
    is_bol_commun: true,
    bienfaits:
      "Une synergie entre la vitamine C du citron et le fer naturel du fonio.",
    ingredients: [
      { nom: "Poulet", quantite: 150, unite: "g", rayon: "Boucherie / Pêche" },
      { nom: "Oignons", quantite: 150, unite: "g", rayon: "Marché local" },
      { nom: "Fonio", quantite: 60, unite: "g", rayon: "Boutique Onyx" },
      { nom: "Huile d'olive", quantite: 1, unite: "càs", rayon: "Supermarché" },
    ],
  },
  {
    id: "def_17",
    type: "Déjeuner",
    nom: "Salade Tiède Patate Douce & Poulet",
    calories: 480,
    is_bol_commun: false,
    bienfaits:
      "Le bêta-carotène de la patate douce favorise l'éclat de la peau et limite les pics de sucre.",
    ingredients: [
      { nom: "Patate douce", quantite: 150, unite: "g", rayon: "Marché local" },
      {
        nom: "Blanc de poulet",
        quantite: 120,
        unite: "g",
      ...
      { nom: "Tomates", quantite: 1, unite: "pièce", rayon: "Marché local" },
    ],
  },
  {
    id: "def_18",
    type: "Dîner",
    nom: "Salade de Niébé Fraîcheur",
    calories: 400,
    is_bol_commun: false,
    bienfaits:
      "Excellent pour une digestion très légère avant le sommeil sans sensation de faim.",
    ingredients: [
      {
        nom: "Niébé (Haricots)",
        quantite: 100,
  ...
  },
  {
    id: "def_19",
    type: "Dîner",
    nom: "Soupe de Légumes Locaux au Soumbala",
    calories: 300,
    is_bol_commun: false,
    bienfaits:
      "Hydrate en profondeur et régule naturellement la tension artérielle pendant la nuit.",
    ingredients: [
      { nom: "Carotte", quantite: 2, unite: "pièce", rayon: "Marché local" },
      { nom: "Navet", quantite: 1, unite: "pièce", rayon: "Marché local" },
      { nom: "Soumbala", quantite: 1, unite: "càc", rayon: "Boutique Onyx" },
    ],
  },
  {
    id: "def_20",
    type: "Dîner",
    nom: "Poisson braisé (Yaboye) & Jaxatu",
    calories: 380,
    is_bol_commun: false,
    bienfaits:
      "L'amertume du Jaxatu aide à nettoyer et purifier le foie en douceur.",
    ingredients: [
      { nom: "Yaboye", quantite: 150, unite: "g", rayon: "Boucherie / Pêche" },
      { nom: "Jaxatu", quantite: 100, unite: "g", rayon: "Marché local" },
    ],
  },
  {
    id: "def_21",
    type: "Dîner",
    nom: "Blanc de Poulet Sauté au Djar",
    calories: 350,
    is_bol_commun: false,
    bienfaits:
      "Des épices locales qui réchauffent le métabolisme sans ajouter aucune calorie.",
    ingredients: [
      {
        nom: "Blanc de poulet",
        quantite: 150,
  ...
  },
  {
    id: "def_22",
    type: "Dîner",
    nom: "Omelette Moringa & Champignons",
    calories: 320,
    is_bol_commun: false,
    bienfaits:
      "Une multivitamine naturelle pure favorisant la réparation cellulaire nocturne.",
    ingredients: [
      { nom: "Oeufs", quantite: 2, unite: "pièce", rayon: "Supermarché" },
      {
      ...
      { nom: "Champignons", quantite: 100, unite: "g", rayon: "Supermarché" },
    ],
  },
  {
    id: "def_23",
    type: "Dîner",
    nom: "Sauté de Bœuf aux Gombos",
    calories: 390,
    is_bol_commun: false,
    bienfaits:
      "Le gombo apporte une satiété ultra-rapide sans alourdir l'estomac le soir.",
    ingredients: [
      {
        nom: "Bœuf maigre",
        quantite: 120,
  ...
  },
  {
    id: "def_24",
    type: "Dîner",
    nom: "Papillote de Poisson Citronnée",
    calories: 310,
    is_bol_commun: false,
    bienfaits:
      "Une cuisson saine sans ajout de matière grasse, permettant au foie de se reposer.",
    ingredients: [
      {
        nom: "Poisson blanc",
        quantite: 150,
      ...
      { nom: "Courgettes", quantite: 150, unite: "g", rayon: "Marché local" },
    ],
  },
  {
    id: "def_25",
    type: "Dîner",
    nom: "Salade de Thon, Avocat & Tomates",
    calories: 420,
    is_bol_commun: false,
    bienfaits:
      "Riche en Oméga-3 pour apaiser le système nerveux et améliorer la qualité du sommeil.",
    ingredients: [
      { nom: "Thon nature", quantite: 100, unite: "g", rayon: "Supermarché" },
      { nom: "Avocat", quantite: 0.5, unite: "pièce", rayon: "Marché local" },
      { nom: "Tomate", quantite: 1, unite: "pièce", rayon: "Marché local" },
    ],
  },
  {
    id: "def_26",
    type: "Dîner",
    nom: "Velouté de Courge & Poudre de Moringa",
    calories: 280,
    is_bol_commun: false,
    bienfaits:
      "Concentré en Vitamine A et fibres très douces pour ne pas irriter les intestins.",
    ingredients: [
      { nom: "Courge", quantite: 200, unite: "g", rayon: "Marché local" },
      {
        nom: "Poudre de Moringa",
        quantite: 1,
        unite: "càc",
  ...
  },
  {
    id: "def_27",
    type: "Dîner",
    nom: "Émincé de Volaille aux Épices & Soumbala",
    calories: 360,
    is_bol_commun: false,
    bienfaits:
      "Protège le système cardio-vasculaire en remplaçant totalement le sel industriel.",
    ingredients: [
      {
        nom: "Volaille",
        quantite: 150,
  ...
  },
  {
    id: "def_28",
    type: "Dîner",
    nom: "Brochettes de Poisson et Tomates",
    calories: 350,
    is_bol_commun: false,
    bienfaits:
      "Apporte des protéines pures et du lycopène, un puissant antioxydant issu de la tomate cuite.",
    ingredients: [
      {
        nom: "Poisson blanc",
        quantite: 150,
      ...
      { nom: "Huile d'olive", quantite: 1, unite: "càc", rayon: "Supermarché" },
    ],
  },
  {
    id: "def_29",
    type: "Dîner",
    nom: "Steak de Viande Maigre & Salade Verte",
    calories: 390,
    is_bol_commun: false,
    bienfaits:
      "Recharge votre corps en fer assimilable, idéal pour la récupération cellulaire nocturne.",
    ingredients: [
      {
        nom: "Viande de Bœuf Maigre",
        quantite: 150,
        unite: "g",
        rayon: "Boucherie / Pêche",
      },
      ...
      { nom: "Vinaigrette", quantite: 1, unite: "càs", rayon: "Supermarché" },
    ],
  },
  {
    id: "def_30",
    type: "Collation",
    nom: "Yaourt Nature & Éclats d'Arachides",
    calories: 150,
    is_bol_commun: false,
    bienfaits:
      "Protéines du yaourt relevées par les bonnes graisses de l'arachide.",
    ingredients: [
      { nom: "Yaourt nature", quantite: 1, unite: "pot", rayon: "Supermarché" },
      {
  ...
  },
  {
    id: "def_31",
    type: "Collation",
    nom: "Fruit de Saison & Lait Caillé (Sow)",
    calories: 180,
    is_bol_commun: false,
    bienfaits: "Un mix parfait entre vitamines et ferments lactiques.",
    ingredients: [
      {
        nom: "Fruit au choix",
        quantite: 1,
      ...
      { nom: "Sow Nature", quantite: 100, unite: "ml", rayon: "Marché local" },
    ],
  },
  {
    id: "def_32",
    type: "Collation",
    nom: "Infusion Bissap Pur & Noix de Cajou",
    calories: 160,
    is_bol_commun: false,
    bienfaits:
      "Apport en Magnésium anti-stress et effet jambes légères grâce au Bissap.",
    ingredients: [
      {
        nom: "Bissap rouge séché",
        quantite: 1,
        unite: "tasse",
        rayon: "Boutique Onyx",
      },
  ...
  },
  {
    id: "def_33",
    type: "Collation",
    nom: "Yaourt Nature à la Poudre de Bouye",
    calories: 140,
    is_bol_commun: false,
    bienfaits:
      "Probiotiques du yaourt alliés aux fibres du baobab pour une flore intestinale en béton.",
    ingredients: [
      { nom: "Yaourt nature", quantite: 1, unite: "pot", rayon: "Supermarché" },
      {
        nom: "Poudre de Baobab",
        quantite: 1,
        unite: "càc",
        rayon: "Boutique Onyx",
      },
  ...
  },
  {
    id: "def_34",
    type: "Collation",
    nom: "Bâtonnets de Carotte & Concombre",
    calories: 80,
    is_bol_commun: false,
    bienfaits: "Une option zéro culpabilité, ultra-croquante et hydratante.",
    ingredients: [
      { nom: "Carotte", quantite: 1, unite: "pièce", rayon: "Marché local" },
      {
        nom: "Concombre",
  ...
  },
  {
    id: "def_35",
    type: "Collation",
    nom: "Fromage Blanc & Graines de Courge",
    calories: 150,
    is_bol_commun: false,
    bienfaits:
      "Excellente source de protéines et de zinc pour embellir la peau.",
    ingredients: [
      { nom: "Fromage blanc", quantite: 100, unite: "g", rayon: "Supermarché" },
      {
  ...
  },
  {
    id: "def_36",
    type: "Collation",
    nom: "Infusion Kinkeliba & Chocolat Noir",
    calories: 120,
    is_bol_commun: false,
    bienfaits:
      "Gourmandise antioxydante couplée au nettoyage hépatique du Kinkeliba.",
    ingredients: [
      { nom: "Kinkeliba", quantite: 1, unite: "tasse", rayon: "Marché local" },
      {
  ...
  },
  {
    id: "def_37",
    type: "Collation",
    nom: "Lait Caillé (Sow) Nature",
    calories: 130,
    is_bol_commun: false,
    bienfaits:
      "Riche en calcium et ferments lactiques indispensables pour une bonne digestion.",
    ingredients: [
      { nom: "Sow Nature", quantite: 150, unite: "ml", rayon: "Marché local" },
    ],
  },
  {
    id: "def_38",
    type: "Collation",
    nom: "Dattes & Thé Vert Menthe",
    calories: 110,
    is_bol_commun: false,
    bienfaits: "L'énergie rapide absolue associée aux antioxydants du thé.",
    ingredients: [
      { nom: "Dattes", quantite: 2, unite: "pièce", rayon: "Marché local" },
      {
        nom: "Thé vert menthe",
        quantite: 1,
        unite: "tasse",
...
const ALL_MENUS = [
  {
    ...
    meals: [
      "Lundi : Fonio au poulet (500 kcal)",
      "Mardi : Salade de Niébé (450 kcal)",
      "Mercredi : Thieboudienne revisité (600 kcal)",
    ],
  },
  {
    week: 2,
    ...
    meals: [
      "Lundi : Mafé allégé (550 kcal)",
      "Mardi : Poisson grillé et légumes locaux",
      "Mercredi : Couscous de mil (Thiéré)",
    ],
  },
  {
    week: 3,
  ...
  autopilot: [
    {
      type: "Petit-déjeuner",
      time: "08:00",
      meal: "Bouillie de Mil (Lakh) allégée",
      cals: 300,
      proteins: 8,
      carbs: 50,
      fats: 5,
      recipe:
        "Faire bouillir 50g de mil avec de l'eau. Ajouter un filet de lait demi-écrémé et de la noix de muscade.",
    },
    {
      type: "Déjeuner",
      time: "13:30",
      meal: "Thieboudienne Diététique",
      cals: 600,
      proteins: 35,
      carbs: 70,
      fats: 15,
      recipe:
        "Utiliser 1/4 d'assiette de riz brisé (ou de fonio). Beaucoup de légumes (chou, carotte). Morceau de poisson de 150g. Limiter l'huile à 1 cuillère à soupe par personne.",
    },
    {
      type: "Collation",
      time: "16:00",
      meal: "Poignée d'arachides",
      cals: 150,
      proteins: 5,
      carbs: 10,
      fats: 12,
      recipe:
        "Une petite poignée de cacahuètes grillées sans sel (environ 20g).",
    },
    {
      type: "Dîner",
      time: "19:30",
      meal: "Salade de Niébé",
      cals: 400,
      proteins: 20,
      carbs: 45,
      fats: 10,
      recipe:
        "Mélanger 100g de niébé cuit avec des tomates, concombres, oignons. Vinaigrette : 1 càc d'huile d'olive, citron, sel, poivre.",
    },
  ],
  compass: [
    {
      ...
      meal: "Limitez les féculents (Riz, Fonio, Mil) à 1/4 de votre assiette max.",
    },
    {
      type: "Protéines",
      time: "Repas principaux",
      meal: "Assurez-vous d'avoir une belle portion de poisson, poulet ou viande maigre.",
    },
    {
      type: "Légumes",
      time: "Repas principaux",
      meal: "Remplissez la moitié de votre assiette avec des légumes locaux (carottes, choux, aubergines).",
    },
  ],
};
...
const buildDynamicRecipes = async (foodDatabase: any[]) => {
  ...
  try {
    ...
    if (products && products.length > 0) {
      const validStandaloneProducts = products.filter((p: any) => {
        ...
        if (
          nom.includes("gourde") ||
          nom.includes("blender") ||
          nom.includes("t-shirt") ||
          nom.includes("tote bag")
        )
          return false;
        if (
          nom.includes("pâte") ||
          nom.includes("beurre de cajou") ||
          nom.includes("soumbala") ||
          nom.includes("nététou") ||
          nom.includes("djar") ||
          nom.includes("gingembre") ||
          nom.includes("moringa") ||
          nom.includes("bouye") ||
          nom.includes("bissap")
        )
          return false;
      ...
      dynamicRecipes = validStandaloneProducts.map((p: any) => {
        ...
        if (p.goal === "snacks") mType = "Collation";
          ...
          p.goal === "energy" ||
          p.categorie_nom?.toLowerCase().includes("infusion")
        )
          mType = "Petit-déjeuner";
        ...
        return {
          ...
          is_bol_commun: false,
          bienfaits:
            p.description_courte || "Une recette savoureuse et bénéfique.",
  ...
  const validStandaloneFoods = foodDatabase.filter((f: any) => {
    ...
    if (
      cat.includes("céréale") ||
      cat.includes("graine") ||
      cat.includes("féculent")
    )
      return false;
    if (
      nom.includes("pâte d'arachide") ||
      nom.includes("beurre de cajou") ||
      nom.includes("soumbala") ||
      nom.includes("nététou") ||
      nom.includes("djar") ||
  ...
  const foodDbRecipes = validStandaloneFoods.map((f: any) => ({
    id: `gen_food_${f.id}`,
    type:
      f.categorie === "Boissons"
        ? "Collation"
        : f.categorie === "Protéines"
          ? "Dîner"
          : "Déjeuner",
    ...
    bienfaits:
      f.message_coach_ia ||
      "Excellent pour un rééquilibrage nutritionnel africain.",
    recipe: `Cuisinez ${f.portion_standard_grammes}g de ${f.nom} avec un minimum d'huile.`,
    ingredients: [
      {
        nom: f.nom,
        quantite: f.portion_standard_grammes,
        unite: "g",
        rayon: "Marché / Supermarché",
      },
    ],
  }));
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <p className="text-[10px] font-black uppercase tracking-widest text-zinc-500 text-center">
        {label}
        <br />
        <span className="text-xs font-bold normal-case text-black">
          / {max} {unit}
        </span>
      </p>
...
export default function NutritionDashboard() {
  ...
  const [trackingMode, setTrackingMode] = useState<"guided" | "flexible">(
    "guided",
  );
  ...
  const [selectedMealPhoto, setSelectedMealPhoto] = useState<string | null>(
    null,
  );
  ...
  const [thiernoMessages, setThiernoMessages] = useState<any[]>([
    {
      sender: "bot",
      text: "Bonjour ! Je suis le Dr. Thierno. As-tu des questions sur la nutrition, tes portions ou comment adapter tes plats locaux (Mix Sénégalo-Moderne) ?",
    },
  ]);
  ...
  const processThiernoReply = (reply: string) => {
    ...
    setTimeout(() => {
      let botResponse =
        "C'est une très bonne question. N'oublie pas de consulter notre boutique pour découvrir nos super-aliments (Fonio, Moringa, Soumbala) qui t'aideront à atteindre ton objectif plus vite !";
      const lowerReply = reply.toLowerCase();

      if (lowerReply.includes("riz") || lowerReply.includes("thieb")) {
        botResponse =
          "Le riz brisé a un index glycémique élevé. Je te recommande fortement notre Fonio Premium disponible dans la boutique. Il est parfait pour remplacer le riz tout en gardant le ventre plat !";
      } else if (
        lowerReply.includes("sucre") ||
        lowerReply.includes("fatigue") ||
        lowerReply.includes("boost")
      ) {
        botResponse =
          "La fatigue vient souvent des pics de sucre. Essaye notre Poudre de Moringa Bio ou notre Thé Vert Ataya Spécial pour une énergie décuplée sans calorie !";
      } else if (
        lowerReply.includes("huile") ||
        lowerReply.includes("mafé") ||
        lowerReply.includes("yassa") ||
        lowerReply.includes("bouillon")
      ) {
        botResponse =
          "Attention aux bouillons industriels et à l'excès d'huile. Je te conseille d'utiliser notre Soumbala pur comme exhausteur de goût santé, et notre Pâte d'Arachide 100% pure pour tes mafés !";
      } else if (
        lowerReply.includes("jeûne") ||
        lowerReply.includes("matin") ||
        lowerReply.includes("boire") ||
        lowerReply.includes("eau")
      ) {
        botResponse =
          "Pour bien t'hydrater, notre Gourde Motivante 'Jongoma' (1.5L) est un must. Tu peux aussi infuser notre Bissap Rouge Séché sans sucre pour un effet détox garanti dès le matin !";
      } else if (
        lowerReply.includes("faim") ||
        lowerReply.includes("snack") ||
        lowerReply.includes("arachide") ||
        lowerReply.includes("cajou")
      ) {
        botResponse =
          "En cas de petite faim, évite les biscuits industriels. Nos Noix de Cajou Grillées sont le snack sain idéal pour te caler jusqu'au prochain repas !";
      }

      setThiernoMessages((prev) => [
        ...prev,
  ...
  const [weightCoachMessage, setWeightCoachMessage] = useState<{
    title: string;
    text: string;
    type: "warning" | "success" | "info";
  } | null>(null);
  ...
  const [viewerActiveGroupIndex, setViewerActiveGroupIndex] = useState<
    number | null
  >(null);
  const [viewerActiveStoryIndex, setViewerActiveStoryIndex] =
    useState<number>(0);
  ...
  const [emblaShopRef] = useEmblaCarousel({ loop: true, align: "start" }, [
  ...
  const [productMediaView, setProductMediaView] = useState<"image" | "video">(
    "image",
  );
  ...
  const [shopBannerUrl, setShopBannerUrl] = useState(
    "https://placehold.co/1200x300/111/39FF14?text=OFFRES+EXCLUSIVES",
  );
  ...
  const togglePushNotifications = () => {
    if (typeof window !== "undefined" && "Notification" in window) {
      if (Notification.permission === "granted") {
        alert(
          "Pour désactiver les notifications, veuillez modifier les paramètres de votre navigateur.",
        );
  ...
  const [emblaNewArrivalsRef] = useEmblaCarousel(
  ...
  const [emblaBlogRef] = useEmblaCarousel({ loop: true, align: "start" }, [
  ...
  useEffect(() => {
    ...
    const realtimeChannel = supabase
      .channel("custom-daily-logs-channel")
      .on(
        "postgres_changes",
        {
          event: "*",
  ...
  useEffect(() => {
    ...
    const handleOnline = async () => {
      ...
      const offlineLogs = JSON.parse(
        localStorage.getItem("onyx_offline_daily_logs") || "[]",
      );
      if (offlineLogs.length > 0) {
        ...
        setToastMessage(
          "Mode PWA : Vos bilans hors-ligne ont été synchronisés !",
        );
      ...
      try {
        ...
        if (dbProds && dbProds.length > 0) {
          ...
          const grouped = SHOP_DATA.reduce((acc: any, p: any) => {
            ...
            p.produits.forEach((prod: any) =>
              acc[p.categorie_nom].produits.push(prod),
            );
            return acc;
          }, {});
          setShopDataDB(Object.values(grouped));
        ...
        const { data: cPosts } = await supabase
          ...
          .select("*, clients!client_id(id, full_name, avatar_url)")
        ...
        const { data: rawStories } = await supabase
          ...
          .select(
            "*, clients!client_id(id, full_name, avatar_url), nutrition_story_views(viewer_id)",
          )
        ...
        setActiveChallenge({
          ...
          description:
            "Rejoignez-nous pour éliminer le sucre raffiné de notre alimentation pendant un mois.",
          badge_name: "Jongoma Détox",
          cover_url:
            "https://res.cloudinary.com/dtr2wtoty/video/upload/v1783098522/pexels-kelly-18069166_2_o207f2.mp4",
          reward_xp: 500,
          duration_days: 30,
        });
    ...
    const verifyAuth = async () => {
      try {
        ...
        setProfileForm((prev) => ({
          ...
          avatar_url:
            finalUser?.user_metadata?.avatar_url || finalUser?.avatar_url || "",
        }));

        // Récupérer le profil client complet depuis la table 'clients'
        const phoneMatch = finalUser?.email?.match(
          /^(\+?\d+)@clients\.onyxcrm\.com$/,
        );
        const userPhone = phoneMatch
          ? phoneMatch[1]
          : finalUser?.user_metadata?.phone || finalUser?.phone;
        ...
        if (activeProfile) {
          if (userPhone) {
            const welcome = localStorage.getItem(
              `onyx_nutrition_welcome_${userPhone}`,
            );
          ...
          if (activeProfile) {
            ...
            if (!activeProfile.daily_macros) {
              activeProfile.daily_macros = {
                calorieGoal: activeProfile.daily_calorie_goal || 0,
                proteinGoal: 100,
                fatsGoal: 50,
              };
            }
          ...
          const trialEnds = activeProfile.expiration_date
            ? new Date(activeProfile.expiration_date).getTime()
            : new Date(activeProfile.created_at || new Date()).getTime() +
              14 * 24 * 60 * 60 * 1000;
          ...
          if (activeProfile.id) {
            ...
            if (logsData) {
              ...
              if (todayLog) {
                ...
                if (
                  todayLog.report_data?.consumedMeals &&
                  Array.isArray(todayLog.report_data.consumedMeals)
                ) {
                  setConsumedMeals(todayLog.report_data.consumedMeals);
                }
                if (
                  todayLog.report_data?.moods &&
                  Array.isArray(todayLog.report_data.moods)
                ) {
                  setMoods(todayLog.report_data.moods);
                }
                if (todayLog.report_data?.moodNotes)
                  setMoodNotes(todayLog.report_data.moodNotes);
              } else {
                // Si aucun log n'est trouvé pour aujourd'hui, réinitialiser les états
                setCalories(0);
                setWaterGlasses(0);
                setProteins(0);
                setCarbs(0);
            ...
            if (nutritionData) {
              setClientProfile((prev) => ({
                ...
                weekly_budget_tier:
                  nutritionData.weekly_budget_tier || "famille_15k",
              }));
              ...
              setIsFastingMode(
                nutritionData.diagnostic_data?.fasting_mode || false,
              );
              if (
                nutritionData.weekly_menu &&
                Array.isArray(nutritionData.weekly_menu) &&
                nutritionData.weekly_menu.length > 0
              ) {
              ...
              if (nutritionData.diagnostic_data) {
                setProfileForm((prev) => ({
                  ...prev,
                  startingWeight:
                    nutritionData.diagnostic_data.startingWeight || "",
                  currentWeight:
                    nutritionData.diagnostic_data.currentWeight || "",
                  goalWeight:
                    nutritionData.diagnostic_data.targetWeight ||
                    nutritionData.diagnostic_data.goalWeight ||
                    "",
            ...
            const diagCurrentWeight =
              nutritionData?.diagnostic_data?.currentWeight;

            if (fetchedLogs.length === 0 && diagCurrentWeight) {
              const initialWeight = parseFloat(diagCurrentWeight);
              const initialDate = activeProfile.created_at
                ? new Date(activeProfile.created_at).toISOString().split("T")[0]
                : new Date().toISOString().split("T")[0];
              if (!isNaN(initialWeight)) {
                fetchedLogs = [
                  { log_date: initialDate, weight: initialWeight },
                ];
              }
            }
            ...
            if (fetchedLogs.length > 0) {
              ...
              diagCurrentWeight &&
              !isNaN(parseFloat(diagCurrentWeight))
            ) {
  ...
  const updateXP = async (amount: number, reason: string) => {
    ...
    if (jongomaXP < 500 && newXP >= 500) {
      ...
      setRokhyMessage({
        ...
        text: "Félicitations ! Tu viens de débloquer le badge Adhérente ! Continue comme ça, tes efforts paient !",
        type: "success",
      });
      ...
      setRokhyMessage({
        title: "Nouveau Badge Débloqué ! 🌟",
        text: "Incroyable ! Tu as atteint le niveau Star Nutrition ! Un grand bravo pour ta régularité, c'est exceptionnel !",
        type: "success",
      });
      setShowConfetti(true);
      setTimeout(() => setShowConfetti(false), 8000);
  ...
  const fetchLeaderboard = async () => {
    ...
    if (data && data.length > 0) {
      ...
      if (
        clientProfile &&
        !formattedData.some((d) => d.id === clientProfile.id)
      ) {
        formattedData.push({
          id: clientProfile.id,
  ...
  useEffect(() => {
    const checkReminder = () => {
      const now = new Date();
      const hasLoggedToday = dailyLogs.some(
        (log) => log.log_date === todayStr && log.report_data,
      );
      ...
      const fetchOFF = async () => {
        ...
        try {
          const res = await fetch(
            `https://world.openfoodfacts.org/cgi/search.pl?search_terms=${encodeURIComponent(foodSearchQuery)}&search_simple=1&action=process&json=1&page_size=5`,
          );
            ...
            const mapped = data.products
              .map((p: any) => ({
                ...
                valeurs_pour_100g: {
                  ...
                  glucides: p.nutriments?.carbohydrates_100g || 0,
                  lipides: p.nutriments?.fat_100g || 0,
                ...
                is_from_off: true,
                message_coach_ia:
                  p.nutriments?.sugars_100g > 15
                    ? `Alerte Sucre (${p.nutriments.sugars_100g}g/100g) ! Attention aux pics d'insuline. Privilégiez des alternatives naturelles.`
                    : p.nutriments?.sodium_100g > 0.6
                      ? `Trop salé ! Risque de rétention d'eau. Remplacez-le par du Soumbala brut.`
                      : p.nova_group === 4
                        ? `Produit ultra-transformé. À limiter fortement pour garder un ventre plat.`
                        : p.nutriments?.proteins_100g > 15
                          ? `Excellente source de protéines (${p.nutriments.proteins_100g}g) pour la satiété !`
  ...
  const handleViewerSkipBackward = () => {
    ...
    if (viewerActiveStoryIndex > 0) {
      ...
      setViewerActiveStoryIndex(
        groupedStories[viewerActiveGroupIndex - 1].stories.length - 1,
      );
    }
    setViewerProgress(0);
  };
  ...
  useEffect(() => {
    ...
    stories.forEach((story: any) => {
      ...
      const hasViewed = story.nutrition_story_views?.some(
        (v: any) => v.viewer_id === myId,
      );
      if (!hasViewed) {
    ...
    const groupArray = Object.values(groups).sort((a: any, b: any) => {
      if (a.allViewed === b.allViewed) {
        ...
        const bLast = new Date(
          b.stories[b.stories.length - 1].created_at,
        ).getTime();
  ...
  useEffect(() => {
    const waterInterval = setInterval(
      ...
      2 * 60 * 60 * 1000,
    ); // Déclenche toutes les 2 heures si la jauge n'est pas remplie
    return () => clearInterval(waterInterval);
  }, [waterGlasses]);

  // --- LOGIQUE SMART PLANNER ---
  const generateWeeklyMenu = async (fastingOverride?: boolean) => {
    const activeFastingMode =
      fastingOverride !== undefined ? fastingOverride : isFastingMode;
    ...
    currentRecipes = currentRecipes.filter((r) => {
      ...
      if (
        ...
        return false;
      if (
        nom.includes("pâte d'arachide pure") ||
        nom.includes("soumbala") ||
        nom.includes("nététou") ||
        nom.includes("épice")
      )
    ...
    const allergies =
      clientProfile?.diagnostic_data?.allergies?.toLowerCase() || "";
    ...
    if (allergies && allergies !== "aucune" && allergies !== "non") {
      ...
      safeRecipes = currentRecipes.filter((r) => {
        return !r.ingredients?.some((ing: any) =>
          allergyList.some((al) => ing.nom.toLowerCase().includes(al)),
        );
      });
    }
    ...
    const allowedTiers =
      budgetMapping[userBudgetTier] || budgetMapping["famille_15k"];
    safeRecipes = safeRecipes.filter(
      (r) => !r.budget_tier || allowedTiers.includes(r.budget_tier),
    );
    ...
    const mealTargets: Record<string, number> = activeFastingMode
      ? {
          ...
          Collation: targetDailyCals * 0.2,
          Dîner: targetDailyCals * 0.35,
        }
      : {
          "Petit-déjeuner": targetDailyCals * 0.25,
          Déjeuner: targetDailyCals * 0.4,
          Collation: targetDailyCals * 0.1,
      ...
      return {
        ...
        ingredients:
          recipe.ingredients?.map((ing: any) => ({
            ...ing,
            quantite:
              typeof ing.quantite === "number"
                ? Number((ing.quantite * ratio).toFixed(1))
                : ing.quantite,
          })) || [],
      };
    };
    ...
    days.forEach((day) => {
      const getAvailable = (type: string) => {
        let available = safeRecipes.filter(
          (r) => r.type === type && !recentMeals[type].slice(-2).includes(r.id),
        );
        if (available.length === 0)
          available = safeRecipes.filter(
            (r) =>
              r.type === type && !recentMeals[type].slice(-1).includes(r.id),
          );
        if (available.length === 0)
          available = safeRecipes.filter((r) => r.type === type);

        // MISSION : Prioritisation "Serré 8k" pour budgets restreints
        if (userBudgetTier !== "confort_25k") {
          const tightBudgetRecipes = available.filter(
            (r) => r.budget_tier === "Serré 8k",
          );
        ...
        if (type === "Petit-déjeuner") {
          const withHotDrinks = available.filter((r) =>
            r.ingredients?.some((ing: any) =>
              ["kinkeliba", "thé vert", "djar", "café touba"].some((drink) =>
                ing.nom.toLowerCase().includes(drink),
              ),
            ),
          );
      ...
      const breakfasts = activeFastingMode
        ? []
        : getAvailable("Petit-déjeuner");
      ...
      for (let i = 0; i < 30; i++) {
        ...
        if (bolCommunCount < 3 && Math.random() > 0.4 && bcLunches.length > 0) {
          lunchCandidate =
            bcLunches[Math.floor(Math.random() * bcLunches.length)];
        } else {
          lunchCandidate =
            normalLunches.length > 0
              ? normalLunches[Math.floor(Math.random() * normalLunches.length)]
        ...
        const getCals = (r: any) =>
          ...
          0;
        const totalCals =
          getCals(cBf) + getCals(cL) + getCals(cSn) + getCals(cD);
      ...
      const dayMeals: any = {
        Déjeuner:
          trackingMode === "guided"
            ? scaleRecipe(rawL, mealTargets["Déjeuner"])
            : safeMeal(rawL),
        Collation:
          trackingMode === "guided"
            ? scaleRecipe(rawSn, mealTargets["Collation"])
            : safeMeal(rawSn),
        Dîner:
          trackingMode === "guided"
            ? scaleRecipe(rawD, mealTargets["Dîner"])
            : safeMeal(rawD),
      };

      if (!activeFastingMode) {
        dayMeals["Petit-déjeuner"] =
          trackingMode === "guided"
            ? scaleRecipe(rawBf, mealTargets["Petit-déjeuner"])
            : safeMeal(rawBf);
      }

      if (dayMeals["Petit-déjeuner"])
        recentMeals["Petit-déjeuner"].push(dayMeals["Petit-déjeuner"].id);
      if (dayMeals["Déjeuner"])
        recentMeals["Déjeuner"].push(dayMeals["Déjeuner"].id);
      if (dayMeals["Collation"])
        recentMeals["Collation"].push(dayMeals["Collation"].id);
  ...
  const handleSwapMeal = async (
    ...
    let currentRecipes: any[] =
      allRecipesDB.length > 0 ? allRecipesDB : DEFAULT_RECIPES;
    ...
    const prevDayRecipeId =
      dayIndex > 0
        ? weeklyGeneratedMenu[dayIndex - 1].meals[mealType]?.id
        : null;
    const nextDayRecipeId =
      dayIndex < 6
        ? weeklyGeneratedMenu[dayIndex + 1].meals[mealType]?.id
        : null;

    let alternatives = currentRecipes.filter(
      (r) =>
        r.type === mealType &&
        r.id !== currentRecipeId &&
        r.id !== prevDayRecipeId &&
        r.id !== nextDayRecipeId,
    );

    if (alternatives.length === 0) {
      alternatives = currentRecipes.filter(
        (r) => r.type === mealType && r.id !== currentRecipeId,
      );
    }
    ...
    if (alternatives.length > 0) {
      ...
      if (trackingMode === "guided") {
        ...
        const ratio =
          mealTargets[mealType] / (newRecipe.calories || mealTargets[mealType]);
        newRecipe = {
          ...newRecipe,
          ...
          ingredients:
            newRecipe.ingredients?.map((ing: any) => ({
              ...ing,
              quantite:
                typeof ing.quantite === "number"
                  ? Number((ing.quantite * ratio).toFixed(1))
      ...
      const updatedMenu = JSON.parse(JSON.stringify(weeklyGeneratedMenu));
      if (!updatedMenu[dayIndex].meals) updatedMenu[dayIndex].meals = {};
      ...
      alert(
        "Aucune alternative disponible pour ce type de repas dans la base de données.",
      );
    }
  };
  ...
  const getHealthyDate = (currentW: number, targetW: number) => {
    ...
    return healthyDate.toLocaleDateString("fr-FR", {
      month: "long",
      year: "numeric",
    });
  };
  ...
  const calculateDailyCalories = (data: any) => {
    ...
    let bmr =
      heightCm > 0 && currentWeight > 0 && age > 0
    ...
    if (
      data.gender === "Femme" &&
      (data.femaleSpecific === "SOPK" ||
        data.femaleSpecific === "Périménopause / Ménopause" ||
        data.healthProfile === "Hypothyroïdie")
    ) {
      bmr = bmr * 0.9; // Malus métabolique de -10%
    }
    ...
    if (
      data.gender === "Femme" &&
      (data.femaleSpecific === "Allaitement" ||
        data.femaleSpecific === "Grossesse")
    ) {
    ...
    const userTargetDate = data.targetDate
    ...
    const daysToTarget = Math.max(
      1,
      Math.ceil(
        (userTargetDate.getTime() - now.getTime()) / (1000 * 3600 * 24),
      ),
    );
  ...
  const handleDiagSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Ratios standards
      let carbsRatio = 0.5;
      let proteinRatio = parseFloat(diagData.age) >= 50 ? 0.35 : 0.3;
  ...
  const getGroceryList = () => {
    const list: any = {
      "Produits Locaux / Épices": {},
      "Glucides & Laitages": {},
      "Protéines Fraîches": {},
    };
    const safeWeeklyMenu = Array.isArray(weeklyGeneratedMenu)
      ? weeklyGeneratedMenu
      : [];
    const cookingMultiplier =
      clientProfile?.diagnostic_data?.cooking_mode === "pour_toute_la_famille"
        ? 4
        : 1;
    ...
    safeWeeklyMenu.forEach((dayInfo) => {
      Object.values(dayInfo?.meals || {}).forEach((recipe: any) => {
        ...
        recipe.ingredients.forEach((ing: any) => {
          ...
          if (ing.rayon === "Boutique Onyx" || ing.rayon === "Marché local")
            finalRayon = "Produits Locaux / Épices";
          if (ing.rayon === "Boucherie / Pêche")
            finalRayon = "Protéines Fraîches";

          if (!list[finalRayon]) list[finalRayon] = {};

          const isStaple = stapleIngredients.some((staple) =>
            ing.nom.toLowerCase().includes(staple),
          );
          const finalQuantity = isStaple
            ? ing.quantite * cookingMultiplier
            : ing.quantite;

          if (list[finalRayon][ing.nom]) {
            list[finalRayon][ing.nom].quantite += finalQuantity;
          } else {
            list[finalRayon][ing.nom] = {
              quantite: finalQuantity,
              unite: ing.unite,
              price_cfa: ing.price_cfa || 0,
            };
          }
        });
      });
    ...
    if (
      clientProfile?.diagnostic_data?.health_conditions?.includes(
        "hypertension",
      )
    ) {
      if (!list["Produits Locaux / Épices"])
        list["Produits Locaux / Épices"] = {};
      if (!list["Produits Locaux / Épices"]["Nététou / Soumbala"]) {
        list["Produits Locaux / Épices"]["Nététou / Soumbala"] = {
          quantite: 1,
          unite: "sachet",
          price_cfa: 500,
        };
  ...
  const toggleExcludeIngredient = (nom: string) => {
    setExcludedIngredients((prev) => {
      const newEx = prev.includes(nom)
        ? prev.filter((i) => i !== nom)
        : [...prev, nom];
      if (clientProfile) {
        supabase
          .from("nutrition_profiles")
          .update({ excluded_ingredients: newEx })
          .eq("client_id", clientProfile.id);
      }
      return newEx;
    });
  ...
  const openProductModal = async (product: any) => {
    ...
    setShopDataDB((prev) =>
      prev.map((cat) => ({
        ...cat,
        produits: cat.produits.map((p: any) =>
    ...
    try {
      ...
      Object.entries(list).forEach(([rayon, items]: any) => {
        const activeItems = Object.entries(items).filter(
          ([nom]) => !excludedIngredients.includes(nom),
        );
        ...
        activeItems.forEach(([nom, data]: any) => {
          ...
          doc.text(`• ${nom}`, 20, y);
          doc.text(`${data.quantite} ${data.unite}`, 190, y, {
            align: "right",
          });
          y += 7;
        });
  ...
  const downloadGroceryListPDF = () => {
    ...
    doc.save(
      `Liste_Courses_Onyx_${new Date().toISOString().split("T")[0]}.pdf`,
    );

    const newHistory = [
      { date: new Date().toISOString(), type: "Liste de Courses", url: null },
      ...pdfHistory,
    ];
    setPdfHistory(newHistory);
    if (clientProfile) {
  ...
  const handleUpdateWater = async (delta: number) => {
    ...
    if (isNowCompleted && !reportData.gaugesCompletedXP) {
      ...
      setRokhyMessage({
        ...
        text: "Incroyable ! Tu as rempli toutes tes jauges aujourd'hui (Eau + Macros). Ton corps te remercie ! Profite de tes 50 XP bien mérités.",
        type: "success",
      });
    }
    ...
    await supabase.from("nutrition_daily_logs").upsert(
      {
        ...
        report_data: {
          ...
          moods,
          moodNotes,
          ...(newlyCompletedGauges ? { gaugesCompletedXP: true } : {}),
        },
      },
  ...
  const handleTabChange = (tab: string) => {
    ...
    const isSwitchingAway =
      tab !== "today" && tab !== "history" && activeTab !== tab;
    ...
    if (plannedMeal && plannedMeal.meal) {
      try {
        const { data: rec } = await supabase
          ...
          .select("id, views")
          .eq("nom", plannedMeal.meal)
          .maybeSingle();
        if (rec) {
          await supabase
            .from("nutrition_recipes")
            .update({ views: (rec.views || 0) + 1 })
            .eq("id", rec.id);
        }
      } catch (e) {}
    }
  ...
  const newlyCompletedGaugesCheck = (
    newCals?: number,
    newProts?: number,
    newCarbs?: number,
    newWater?: number,
  ...
  const confirmMealLog = async (
    ...
    const isNowCompleted =
      calorieGoal > 0 &&
      newCals >= calorieGoal * 0.85 &&
      newProts >= proteinGoal * 0.8 &&
      newCarbs >= carbsGoal * 0.8 &&
      waterGlasses >= 8;
    let newlyCompletedGauges = false;
    if (isNowCompleted && !reportData.gaugesCompletedXP) {
      newlyCompletedGauges = true;
    ...
    if (foodObj?.is_from_off) {
      ...
      supabase
        ...
        .then(({ error }) => {
          if (!error)
            setFoodDatabaseDB((prev) => [
              ...prev,
              { ...foodObj, is_from_off: false },
            ]);
        });
    }
    ...
    let alertText =
      foodObj?.message_coach_ia ||
      "Excellent choix ! Tu peux accompagner ça de notre Poudre de Moringa pour booster encore plus ton métabolisme !";
    ...
    if (foodObj?.flags_ia?.ultra_transforme) {
      ...
      alertText =
        foodObj.message_coach_ia ||
        "Ce produit industriel contient souvent des additifs. Remplaçons-le par nos super-aliments naturels (Fonio, Moringa) disponibles dans la boutique Onyx !";
      alertType = "warning";
    } else if (newlyCompletedGauges) {
      alertTitle = "Journée Parfaite ! 🎯";
      alertText =
        "Incroyable ! Tu as rempli toutes tes jauges aujourd'hui (Eau + Macros). Ton corps te remercie ! Profite de tes 50 XP bien mérités.";
      alertType = "success";
    } else if (calsRounded > 600) {
      alertTitle = "Repas très calorique 🔥";
      alertText =
        "Oula ! Ce repas est très riche en énergie. Pense à boire notre infusion de Bissap Rouge ou Thé Vert Ataya pour accélérer la digestion !";
      alertType = "warning";
    } else if (carbsRounded > 60) {
      alertTitle = "Alerte Glucides (Sucre) 🍞";
      alertText =
        "Ce plat va provoquer un pic d'insuline. La prochaine fois, remplace le riz par notre Fonio Premium à IG bas pour un ventre plat !";
      alertType = "warning";
    } else if (foodObj?.flags_ia?.high_sodium) {
      alertTitle = "Attention au sel ! 🧂";
      alertText =
        foodObj.message_coach_ia ||
        "Ce plat est très salé ! Remplace tes bouillons industriels par notre Soumbala / Nététou pur pour donner du goût tout en protégeant ton cœur.";
      alertType = "warning";
    } else if (newFats > fatsGoal) {
      alertTitle = "Quota de lipides atteint 🥑";
      alertText =
        "Attention aux huiles ! Pour tes besoins en bonnes graisses sans excès, nos Noix de Cajou ou notre Pâte d'Arachide Pure sont parfaites. N'en rajoute plus aujourd'hui.";
      alertType = "warning";
    }
      ...
      await supabase.from("nutrition_daily_logs").upsert(
        {
          ...
          report_data: {
            ...reportData,
            consumedMeals: updatedConsumedMeals,
            moods,
            moodNotes,
            ...(newlyCompletedGauges ? { gaugesCompletedXP: true } : {}),
          },
  ...
  const deleteMealLog = async (itemToDelete: any) => {
    ...
    const updatedConsumedMeals = useNutritionStore
      .getState()
      .consumedMeals.filter((m: any) => m.id !== itemToDelete.id);
  ...
  const handleProcessPayment = async () => {
    ...
    if (clientProfile) {
      ...
      alert(
        "Paiement validé ! Votre abonnement Premium est prolongé de 30 jours.",
      );
    } else {
    ...
    try {
      ...
      if (data.status === 1) {
        ...
        const newFood = {
          ...
          flags_ia: {
            is_local_senegal: false,
            ig_bas: nutriments.carbohydrates_100g < 15,
            high_sodium: nutriments.sodium_100g > 0.6,
            ultra_transforme: product.nova_group === 4 || true,
          },
          message_coach_ia:
            nutriments.sugars_100g > 15
              ? `Alerte Sucre (${nutriments.sugars_100g}g/100g) ! Attention aux pics d'insuline. Privilégiez des alternatives naturelles.`
              : nutriments.sodium_100g > 0.6
                ? `Trop salé ! Risque de rétention d'eau. Remplacez-le par du Soumbala brut.`
                : product.nova_group === 4
                  ? `Produit ultra-transformé. À limiter fortement pour garder un ventre plat.`
                  : nutriments.proteins_100g > 15
                    ? `Excellente source de protéines (${nutriments.proteins_100g}g) pour la satiété !`
        ...
        setBarcodeInput("");
        alert(
          `Produit trouvé : ${product.product_name}. Confirmez-vous l'ajout ?`,
        );
      } else {
  ...
  const handlePhotoUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const aiResult = {
        ...
        image_url: publicUrl,
        message_coach_ia:
          data.message_coach_ia ||
          "Estimation générée automatiquement d'après la photo.",
      };
  ...
  const handleSaveWeight = async () => {
    ...
    if (isNaN(newWeightVal) || newWeightVal <= 0)
      return alert("Veuillez saisir un poids valide.");

    const startWeight =
      weightLogs.length > 0
        ? weightLogs[0].weight
        : parseFloat(clientProfile?.diagnostic_data?.currentWeight || "0");
    const prevWeight = lastLog ? lastLog.weight : startWeight;
    const targetW = parseFloat(
      clientProfile?.diagnostic_data?.targetWeight || "0",
    );
    ...
    if (isGoalReached) {
      ...
      setWeightCoachMessage({
        ...
        text: "INCROYABLE ! Tu as atteint ton objectif de poids. Félicitations pour tous tes efforts, tu es une vraie championne !",
        type: "success",
      });
      const audio = new Audio(
        "https://assets.mixkit.co/active_storage/sfx/2003/2003-preview.mp3",
    ...
    if (clientProfile) {
      ...
      const { error: insertErr } = await supabase
        .from("nutrition_weight_logs")
        .upsert(payload as any, { onConflict: "client_id, log_date" });
      ...
      await supabase
        .from("nutrition_profiles")
        .update({ diagnostic_data: updatedDiagData })
        .eq("client_id", clientProfile.id);
      setClientProfile((prev: any) =>
        prev ? { ...prev, diagnostic_data: updatedDiagData } : prev,
      );
    }
    ...
    if (newWeight < prevWeight) {
      setCoachFeedback({
        type: "success",
        text: "🎉 Félicitations ! La méthode fonctionne, tes efforts paient de manière incroyable. Continue comme ça !",
      });
    } else if (newWeight > prevWeight) {
      setCoachFeedback({
        type: "warning",
        text: "🌱 Ne t'en fais pas ! Une légère hausse est souvent due à de la rétention d'eau. Zéro culpabilité, on garde le cap avec ton Sama Menu !",
      });
    } else {
      setCoachFeedback({
        type: "neutral",
        text: "⚖️ Stabilité parfaite ! Ton corps consolide ses acquis. Reste constante !",
      });
    }
  ...
  const handleDeleteWeight = async (logDate: string) => {
    if (
      !clientProfile ||
      !confirm(
        `Voulez-vous vraiment supprimer la pesée du ${new Date(logDate).toLocaleDateString("fr-FR")} ? Cette action est irréversible.`,
      )
    ) {
      return;
    }
  ...
  const handleStoryUpload = async () => {
    ...
    try {
      ...
      const mediaType = storyPreviewFile.type.startsWith("video/")
        ? "video"
        : "image";
  ...
  const handlePostCommunity = async () => {
    if (clientProfile?.plan_type !== "premium" && daysLeft <= 0)
      return alert(
        "La publication est réservée aux membres Premium pour garantir l'absence de spams.",
      );
    if (
      !newPostText &&
      !newPostImage &&
    ...
    if (clientProfile) {
      ...
      if (error) {
        ...
        alert(
          "Erreur de publication. Veuillez vérifier les permissions de la base de données.",
        );
      } else {
      ...
      prevPosts.map((post) => {
        if (post.id === postId) {
          ...
          return {
            ...
            reactions: {
              ...post.reactions,
              top: isNewLike ? currentLikes + 1 : currentLikes,
            },
            _likedByMe: true,
    ...
    try {
      ...
      if (postToUpdate && !postToUpdate.id.startsWith("seed-")) {
        ...
        await supabase
          .from("nutrition_community_posts")
          .update({
            reactions: { ...postToUpdate.reactions, top: currentLikes + 1 },
          })
          .eq("id", postId);
        ...
        if (clientProfile) {
          ...
          if (
            postToUpdate.client_id &&
            postToUpdate.client_id !== clientProfile.id
          ) {
  ...
  const handleBookmarkPost = async (postId: string) => {
    ...
    try {
      setCommunityPosts((prevPosts) =>
        prevPosts.map((post) => {
          if (post.id === postId)
            return { ...post, _bookmarkedByMe: !post._bookmarkedByMe };
          return post;
        }),
      );
      const isCurrentlyBookmarked = communityPosts.find(
        (p) => p.id === postId,
      )?._bookmarkedByMe;
      ...
      if (!isCurrentlyBookmarked) {
        ...
        await supabase
          .from("nutrition_saved_posts")
          .delete()
          .match({ client_id: clientProfile.id, post_id: postId });
  ...
  const handleRepost = async (post: any) => {
    if (!clientProfile) return;
    if (!confirm("Voulez-vous repartager cette publication sur votre mur ?"))
      return;
  ...
  const handleFollowUser = async (userIdToFollow: string) => {
    ...
    if (
      clientProfile &&
      !userIdToFollow.startsWith("coach-") &&
      !userIdToFollow.startsWith("chef-") &&
      !userIdToFollow.startsWith("dr-")
    ) {
      try {
  ...
  const handleUploadMealPhoto = async (
  ...
  const submitDailyReport = async () => {
    ...
    if (!navigator.onLine) {
      ...
      localStorage.setItem(
        "onyx_offline_daily_logs",
        JSON.stringify(offlineLogs),
      );
      if ("serviceWorker" in navigator && "SyncManager" in window) {
        navigator.serviceWorker.ready.then((reg) => {
          (reg as any).sync
            .register("sync-daily-logs")
            .catch(() => console.log("Sync err"));
        });
      }
      alert(
        "Mode hors-ligne : Votre bilan a été sauvegardé localement. Il sera synchronisé dès le retour d'Internet.",
      );
      setShowDailyReport(false);
      setDailyLogs((prev) => [
        ...prev.filter((l) => l.log_date !== selectedReportDate),
        payload,
      ]);
    ...
    try {
      ...
      alert(
        "Bilan de la journée enregistré avec succès ! L'IA adaptera votre menu de demain.",
      );
  ...
  const weeklyMenus = ALL_MENUS.map((menu) => {
    ...
    return {
      ...menu,
      status:
        clientProfile?.plan_type === "premium" || menu.week <= 2
          ? "unlocked"
          : "locked",
      meals: displayMeals,
    };
  ...
  const handleTrackingModeChange = async (mode: "guided" | "flexible") => {
    ...
    if (clientProfile?.id) {
      ...
      await supabase
        .from("nutrition_profiles")
        .update({ diagnostic_data: updatedDiag })
        .eq("client_id", clientProfile.id);
      setClientProfile((prev: any) =>
        prev ? { ...prev, diagnostic_data: updatedDiag } : prev,
      );
    }
  };
  ...
  const handleToggleFasting = async () => {
    ...
    if (clientProfile) {
      const newDiag = {
        ...clientProfile.diagnostic_data,
        fasting_mode: newMode,
      };
      await supabase
        .from("nutrition_profiles")
        .update({ diagnostic_data: newDiag })
        .eq("client_id", clientProfile.id);
    }
    alert(
      newMode
        ? "Mode Jeûne Intermittent activé. Votre menu va être recalculé sans petit-déjeuner."
        : "Mode Jeûne désactivé. Le petit-déjeuner est de retour !",
    );
  ...
  const handleExpertModeChange = async (mode: boolean) => {
    ...
    if (clientProfile) {
      const newDietMode = mode ? "expert" : "simple";
      setClientProfile((prev: any) => ({
        ...prev,
        expert_mode: mode,
        diagnostic_data: {
          ...(prev.diagnostic_data || {}),
          diet_mode: newDietMode,
        },
      }));
      await supabase
        .from("nutrition_profiles")
  ...
  const toggleFavorite = async (meal: any) => {
    ...
    setAllRecipesDB((prev) =>
      prev.map((r) =>
        r.nom === mealName
          ? { ...r, likes: Math.max(0, (r.likes || 0) + increment) }
          : r,
      ),
    );
    ...
    if (
      meal.id &&
      !String(meal.id).startsWith("def_") &&
      !String(meal.id).startsWith("gen_")
    ) {
      const { data: rec } = await supabase
        .from("nutrition_recipes")
        .select("likes")
      ...
      if (rec) {
        await supabase
          .from("nutrition_recipes")
          .update({ likes: Math.max(0, (rec.likes || 0) + increment) })
          .eq("id", meal.id);
      }
    }
  };
  ...
  const subTotal = shopCart.reduce(
    (acc, item) =>
      acc +
      (item.finalPrice || item.prix_premium || item.prix_standard || 0) *
        (item.quantity || 1),
    0,
  );
  ...
  const crossSellProducts = (Array.isArray(shopDataDB) ? shopDataDB : [])
    .flatMap((cat) => cat.produits || [])
    .filter((p: any) => !shopCart.some((c: any) => c.id === p.id))
    .slice(0, 2);

  // Calcul pour le badge de coaching (3 premiers jours)
  const createdDate = clientProfile?.created_at
    ? new Date(clientProfile.created_at)
    : new Date();
  const isNewUser =
    (new Date().getTime() - createdDate.getTime()) / (1000 * 3600 * 24) <= 3;
  ...
  const menuItems = [
    {
      id: "week",
      label: "Sama Menu",
      icon: "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781535959/A_cute__highly_detailed_3D_202606151505_1_uvgqf0.jpg",
    },
    {
      id: "today",
      label: "Mon Jour",
      icon: "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781535958/A_cute__highly_detailed_3D_202606151505_2_akqmx4.jpg",
    },
    {
      id: "favorites",
      label: "Galerie Recettes",
      icon: "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781540350/A_cute__highly_detailed_3D_202606151617_hk2xbf.jpg",
    },
    {
      id: "community",
      label: "Communauté",
      icon: "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781804851/camera_ohydou.jpg",
    },
    {
      id: "weight",
      label: "Mon Poids",
      icon: "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781458367/A_cute__highly_detailed_3D_202606141732_kn3ujk.jpg",
    },
    {
      id: "fitness",
      label: "Fitness",
      icon: "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781535958/A_cute__highly_detailed_3D_202606151505_3_punr1t.jpg",
    },
    {
      id: "minute-doc",
      label: "La Minute Doc",
      icon: "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781541191/A_cute__highly_detailed_3D_202606151632_qytnih.jpg",
    },
    {
      id: "shop",
      label: "Boutique",
      icon: "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781535958/A_cute__highly_detailed_3D_202606151505_4_erkmnd.jpg",
    },
    {
      id: "orders",
      label: "Mes Commandes",
      icon: "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781540553/A_cute__highly_detailed_3D_202606151621_l47tzv.jpg",
    },
    {
      id: "blog",
      label: "Blog & Conseils",
      icon: "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781540516/remplacer_tittle_par_CONSEILS_NUTRITION_202606151619_tb8clu.jpg",
    },
    {
      id: "coaching",
      label: "Coaching",
      icon: "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781540692/A_cute__highly_detailed_3D_202606151624_lzxhup.jpg",
    },
    {
      id: "history",
      label: "Historique",
      icon: "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781535959/A_cute__highly_detailed_3D_202606151505_ytie6s.jpg",
      dot: hasUnseenBadges,
    },
    {
      id: "profile",
      label: "Réglages",
      icon: "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781536233/A_cute__highly_detailed_3D_202606151510_uj9z5c.jpg",
    },
  ];
  ...
  const addToCart = (product: any) => {
    ...
    if (existingItem) {
      ...
      setShopCart([
        ...shopCart,
        { ...product, finalPrice: price, quantity: 1 },
      ]);
    }
  ...
  const applyShopPromo = () => {
    const codeObj = shopPromoCodesDB.find(
      (c) => c.code.toUpperCase() === shopPromoCode.toUpperCase(),
    );
    if (codeObj) {
      if (jongomaXP >= codeObj.min_xp) {
        ...
        alert(
          `Vous n'avez pas assez d'XP pour utiliser ce code (${codeObj.min_xp} XP requis).`,
        );
      }
    } else {
  ...
  const toggleSaveProduct = (prod: any) => {
    ...
    const newSaved = isSaved
      ? savedShopProducts.filter((p) => p.id !== prod.id)
      : [...savedShopProducts, prod];
    setSavedShopProducts(newSaved);
    if (clientProfile)
      localStorage.setItem(
        `onyx_nutrition_saved_products_${clientProfile.id}`,
  ...
  const handleShopCheckout = async () => {
    ...
    if (!deliveryAddress.trim()) {
      alert(
        "Veuillez renseigner votre adresse de livraison dans le panier avant de commander.",
      );
    ...
    const discountPct =
      isShopPromoApplied && appliedPromoData
        ? appliedPromoData.discount_pct
        : 0;
    const discountMultiplier = 1 - discountPct / 100;

    const originalTotal = shopCart.reduce(
      (acc, item) =>
        acc +
        (item.finalPrice || item.prix_premium || item.prix_standard || 0) *
          (item.quantity || 1),
    ...
    const cartText = shopCart
      .map(
        (item) =>
          `- ${item.quantity}x ${item.nom} (${((item.finalPrice || item.prix_premium || item.prix_standard || 0) * item.quantity).toLocaleString()} F)`,
      )
      .join("\n");
    ...
    if (clientProfile) {
      const tenantIdToUse =
        shopCart[0]?.tenant_id || clientProfile.tenant_id || "";
      ...
      if (error) {
        ...
        alert(
          "Oups, impossible de sauvegarder la commande dans l'historique. Erreur : " +
            error.message,
        );
    ...
    window.open(
      `https://wa.me/221785338417?text=${encodeURIComponent(msg)}`,
      "_blank",
    );
    setShopCart([]);
  ...
  const handleReorder = (order: any) => {
    ...
    itemsToAdd.forEach((item: any) => {
      const fullProduct =
        (Array.isArray(shopDataDB) ? shopDataDB : [])
          .flatMap((cat) => cat.produits || [])
          .find((p: any) => p.id === item.id) || item;
      ...
      if (existing) {
        ...
        updatedCart.push({
          ...
          finalPrice:
            item.finalPrice || item.price || fullProduct.prix_standard,
        });
      }
    });
  ...
  const downloadHistoryPDF = () => {
    ...
    if (weightLogs && weightLogs.length > 0) {
      weightLogs.forEach((log) => {
        ...
        doc.setFontSize(12);
        doc.text(
          `• ${new Date(log.log_date).toLocaleDateString("fr-FR")} : ${log.weight} kg`,
          20,
          y,
        );
        y += 8;
    ...
    if (sortedLogs.length > 0) {
      sortedLogs.forEach((log) => {
        ...
        doc.setFont("helvetica", "normal");
        doc.text(
          `${log.calories_consumed || 0} kcal, ${log.water_glasses || 0}/8 eau`,
          60,
          y,
        );
        y += 8;
    ...
    doc.save(
      `Historique_Progression_${user?.full_name?.replace(/\s+/g, "_") || "Client"}.pdf`,
    );
  };
  ...
  const handleDownloadDiagnosticPDF = async (sendWhatsApp: boolean = false) => {
    ...
    try {
      ...
      if (sendWhatsApp) {
        ...
        window.open(
          `https://wa.me/221785338417?text=${encodeURIComponent(text)}`,
          "_blank",
        );
      } else {
        doc.save(
          `Diagnostic_Nutrition_${user?.full_name?.replace(/\s+/g, "_") || "Client"}.pdf`,
        );
      }
    } catch (err: any) {
  ...
  const logoSrc =
    "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781198743/Modify_the_logo_from_the_202606111717_kftori.jpg";

  return (
    <div
      className={`flex flex-col min-h-screen w-full overflow-x-hidden ${theme === "dark" ? "bg-zinc-950 text-white" : "bg-[#f4f4f5] text-zinc-900"} font-sans selection:bg-[#39FF14]/30 transition-colors duration-300 pb-20 lg:pb-0`}
    >
      <style
      ...
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-[#39FF14]/30 px-4 md:px-8 py-4 flex items-center justify-between shadow-sm">
        <div className="flex items-center gap-4">
          <img
            src="https://res.cloudinary.com/dtr2wtoty/image/upload/v1781224243/logo_dore_um5fsr.png"
            alt="NutriAfro"
        ...
        <div className="hidden lg:flex items-center gap-2">
          <button
            onClick={() => handleTabChange("dashboard")}
            className="flex items-center gap-2 font-black uppercase text-[11px] tracking-widest text-black hover:text-[#39FF14] transition-colors py-2 bg-zinc-50 px-4 rounded-full border border-zinc-200"
          >
            <img
              src={MENU_ICONS.dashboard}
          ...
          <div className="relative group">
            ...
            <div className="absolute top-full left-0 mt-2 w-48 bg-white border border-zinc-200 rounded-2xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 flex flex-col overflow-hidden">
              <button
                ...
                className="px-4 py-3 text-xs font-bold text-zinc-700 text-left hover:bg-zinc-50 flex items-center gap-2"
              >
                <img
                  src={MENU_ICONS.monJour}
                  className="w-5 h-5 rounded"
                  alt=""
                  onError={(e: any) =>
                    (e.target.src =
                      "https://res.cloudinary.com/dtr2wtoty/image/upload/v1786107893/Ceramic_plate_with_herbs_on_202608071304_bl72q1.jpg")
                  }
                />{" "}
                Mon Jour
              </button>
              ...
              <button
                ...
                className="px-4 py-3 text-xs font-bold text-zinc-700 text-left hover:bg-zinc-50 flex items-center gap-2"
              >
                <UserIcon size={14} className="text-[#39FF14]" /> Profil
              </button>
            </div>
          </div>
          ...
          <div className="relative group">
            ...
            <div className="absolute top-full left-0 mt-2 w-48 bg-white border border-zinc-200 rounded-2xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 flex flex-col overflow-hidden">
              ...
              <button
                ...
                className="px-4 py-3 text-xs font-bold text-zinc-700 text-left hover:bg-zinc-50 flex items-center gap-2"
              >
                <BookOpen size={14} className="text-[#39FF14]" /> Galerie
                Recettes
              </button>
            </div>
          </div>
          ...
          <div className="relative group">
            ...
            <div className="absolute top-full left-0 mt-2 w-48 bg-white border border-zinc-200 rounded-2xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 flex flex-col overflow-hidden">
              <button
                ...
                className="px-4 py-3 text-xs font-bold text-zinc-700 text-left hover:bg-zinc-50 flex items-center gap-2"
              >
                <Heart size={14} className="text-red-500" /> Communauté
              </button>
              <button
              ...
              <button
                onClick={() => handleTabChange("minute-doc")}
                className="px-4 py-3 text-xs font-bold text-zinc-700 text-left hover:bg-zinc-50 flex items-center gap-2"
              >
                <Video size={14} className="text-[#39FF14]" /> La Minute Doc
              </button>
            </div>
          </div>
          ...
          <button
            ...
            className="bg-white border border-[#39FF14] text-zinc-700 hover:bg-[#39FF14] hover:text-black rounded-full px-4 py-2 font-black uppercase text-[10px] tracking-widest transition-all flex items-center gap-2 shadow-sm"
          >
            <img
              src={MENU_ICONS.shop}
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="hidden md:flex items-center bg-white border border-zinc-200 rounded-full px-3 py-1.5 shadow-sm">
            ...
            <input
              type="text"
              placeholder="Chercher une recette, un membre..."
              className="bg-transparent border-none text-xs text-zinc-700 outline-none w-48 focus:w-64 transition-all ml-2 placeholder:text-zinc-400"
            />
          </div>
          ...
          <button
            ...
            className="p-2 rounded-full bg-white border border-zinc-200 text-zinc-400 hover:text-yellow-500 transition-colors shadow-sm"
          ...
          <button
            onClick={() => handleExpertModeChange(!isExpertMode)}
            className={`p-2 rounded-full border transition-colors shadow-sm ${isExpertMode ? "bg-[#39FF14]/10 border-[#39FF14] text-[#39FF14]" : "bg-white border-zinc-200 text-zinc-400 hover:text-black"}`}
            title="Toggle Kcal"
          >
          ...
          <button
            ...
            className={`relative p-2 rounded-full bg-white border transition-all shadow-sm ${isCartBouncing ? "scale-125 border-[#39FF14] text-[#39FF14] shadow-[0_0_15px_rgba(57,255,20,0.5)] z-[100]" : "border-zinc-200 text-zinc-400 hover:text-black"}`}
          >
          ...
          <div className="relative group ml-2">
            <button className="flex items-center gap-2 focus:outline-none">
              <img
                src={
                  user?.avatar_url ||
                  `https://ui-avatars.com/api/?name=${encodeURIComponent(user?.full_name || "Membre")}&background=random`
                }
                alt="Profil"
                className="w-9 h-9 rounded-full border-2 border-[#39FF14]/50 object-cover shadow-sm"
              />
            </button>
            <div className="absolute right-0 mt-2 w-48 bg-white border border-zinc-200 rounded-2xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 overflow-hidden z-50 flex flex-col">
              ...
              <button
                ...
                className="px-4 py-3 text-xs font-bold text-red-500 text-left hover:bg-red-50 flex items-center gap-2"
              >
          ...
          <button
            ...
            className="lg:hidden p-2 text-zinc-700 z-50 cursor-pointer relative"
          >
            <MenuIcon size={24} />
          </button>
        </div>
      ...
      {/* MAIN CONTENT AREA */}
      <main
        className={`flex-1 flex flex-col min-w-0 overflow-x-hidden w-full transition-all duration-500 bg-gradient-to-br from-white to-[#39FF14]/5`}
      >
        {/* Header */}
        ...
        <div className="w-full max-w-7xl mx-auto px-6 mt-12 space-y-12">
          ...
          {activeTab === "minute-doc" && (
            <div className="space-y-8 animate-in fade-in slide-in-from-right-4 w-full">
              <button
                onClick={() => handleTabChange("dashboard")}
                className="flex items-center gap-2 text-zinc-500 hover:text-black font-black uppercase text-[10px] tracking-widest mb-6"
              >
              ...
              <div className="bg-white dark:bg-zinc-900 p-8 rounded-[2rem] border border-zinc-200 dark:border-zinc-800 shadow-sm flex flex-col md:flex-row items-center gap-6 w-full">
                <img
                  src="https://res.cloudinary.com/dtr2wtoty/image/upload/v1781541191/A_cute__highly_detailed_3D_202606151632_qytnih.jpg"
                  className="w-20 h-20 md:w-24 md:h-24 rounded-2xl object-cover shrink-0 shadow-lg"
                  alt="La Minute Doc"
                />
                <div>
                  <h2
                    className={`${spaceGrotesk.className} text-3xl md:text-4xl font-black uppercase tracking-tighter text-black dark:text-white flex items-center flex-wrap gap-3 mb-2`}
                  >
                    La Minute Doc{" "}
                    <span className="bg-black text-[#39FF14] text-[12px] px-3 py-1 rounded-full shadow-sm">
                      Par Dr. Thierno
                    </span>
                  </h2>
                  <p className="text-zinc-500 font-bold text-sm">
                    Découvrez nos podcasts et vidéos explicatives pour mieux
                    comprendre votre corps et votre alimentation.
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  {
                    id: "1",
                    title: "Le Fonio fait-il vraiment maigrir ?",
                    videoUrl: "https://www.youtube.com/embed/acFsObjm2E0",
                    duration: "12:05",
                  },
                  {
                    id: "2",
                    title: "Comment remplacer le cube Maggi ?",
                    videoUrl: "https://www.youtube.com/embed/acFsObjm2E0",
                    duration: "08:30",
                  },
                  {
                    id: "3",
                    title: "Le danger des jus locaux trop sucrés",
                    videoUrl: "https://www.youtube.com/embed/acFsObjm2E0",
                    duration: "15:20",
                  },
                  {
                    id: "4",
                    title: "L'attaya et la perte de poids",
                    videoUrl: "https://www.youtube.com/embed/acFsObjm2E0",
                    duration: "10:45",
                  },
                  {
                    id: "5",
                    title: "Jeûne intermittent & plats africains",
                    videoUrl: "https://www.youtube.com/embed/acFsObjm2E0",
                    duration: "18:10",
                  },
                ].map((podcast, idx) => (
                  <div
                    key={idx}
                    className="bg-zinc-950 p-4 rounded-[2rem] border border-zinc-800 shadow-xl flex flex-col group hover:border-[#39FF14] transition-colors"
                  >
                    <div className="relative aspect-video rounded-2xl overflow-hidden mb-4 bg-zinc-900 border border-zinc-800">
                      <iframe
                        src={`${podcast.videoUrl}?controls=1&rel=0`}
                        className="w-full h-full border-0"
                        allowFullScreen
                      ></iframe>
                    </div>
                    <div className="flex-1 flex flex-col justify-between">
                      <h3 className="text-white font-black uppercase leading-tight mb-2 group-hover:text-[#39FF14] transition-colors">
                        {podcast.title}
                      </h3>
                      <div className="flex justify-between items-center mt-2">
                        <span className="bg-white/10 text-zinc-300 px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest flex items-center gap-1">
          ...
          {activeTab === "dashboard" && (
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8 mt-4">
              <div>
                {isOffline && (
                  <span className="bg-orange-500 text-white px-2 py-0.5 rounded text-[8px] font-black uppercase tracking-widest flex items-center gap-1 shadow-md w-max mb-2">
                    <WifiOff size={10} /> Mode Hors-ligne
                  </span>
                )}
                <h1
                  className={`${spaceGrotesk.className} text-[2.5rem] md:text-4xl font-black uppercase tracking-tighter text-black`}
                >
                  {greetingText},{" "}
                  <span className="text-[#39FF14]">
                    {user?.full_name?.split(" ")[0] || "Membre"}
                  </span>{" "}
                  !
                </h1>
              ...
              <div className="flex flex-wrap items-center gap-4">
                <div
                  className={`flex items-center gap-3 bg-white p-2 pr-4 rounded-2xl border ${xpAnimation ? "border-[#39FF14] shadow-[0_0_15px_rgba(57,255,20,0.4)]" : "border-zinc-200 shadow-sm"} cursor-pointer hover:border-[#39FF14] transition-all duration-300`}
                ...
                >
                  ...
                  <div>
                    <p className="text-zinc-500 text-[10px] font-black uppercase tracking-widest">
                      Niveau :{" "}
                      <span className="text-zinc-800">{lvlInfo.name}</span>
                    </p>
                ...
                <div
                  className="bg-white border border-zinc-200 p-2 pr-4 rounded-2xl flex items-center gap-3 shadow-sm cursor-pointer hover:border-[#39FF14] transition-colors"
                  onClick={() => setShowPaymentModal(true)}
                >
                  <div className="bg-black border border-zinc-800 p-2.5 rounded-xl flex items-center justify-center">
                    <Clock
                      className={
                        daysLeft > 0 ? "text-[#39FF14]" : "text-red-500"
                      }
                      size={20}
                    />
                  </div>
            ...
            <div className="space-y-12 animate-in fade-in slide-in-from-right-4 w-full">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
                <div className="flex items-center gap-4">
                  <img
                    src={MENU_ICONS.monJour}
                    className="w-16 h-16 md:w-20 md:h-20 rounded-2xl object-cover shrink-0 shadow-lg"
                    alt="Mon Jour"
                    onError={(e: any) =>
                      (e.target.src =
                        "https://res.cloudinary.com/dtr2wtoty/image/upload/v1786107893/Ceramic_plate_with_herbs_on_202608071304_bl72q1.jpg")
                  ...
                  <div>
                    <h2
                      className={`${spaceGrotesk.className} text-3xl font-black uppercase tracking-tighter text-black`}
                    >
                      Mon Jour
                    </h2>
                    <p className="text-zinc-500 font-bold text-xs mt-1 max-w-lg leading-relaxed">
                      Enregistrez vos repas, suivez votre eau et complétez votre
                      bilan de la journée.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-zinc-100 p-1.5 rounded-full inline-flex relative shadow-inner shrink-0 h-fit">
                  <button
                    onClick={() => handleTrackingModeChange("guided")}
                    className={`px-6 py-2.5 rounded-full text-xs font-black uppercase tracking-widest transition-all ${trackingMode === "guided" ? "bg-black text-[#39FF14] shadow-md" : "text-zinc-400 hover:text-black"}`}
                  >
                    Mode Guidé
                  </button>
                  <button
                    onClick={() => handleTrackingModeChange("flexible")}
                    className={`px-6 py-2.5 rounded-full text-xs font-black uppercase tracking-widest transition-all ${trackingMode === "flexible" ? "bg-black text-[#39FF14] shadow-md" : "text-zinc-400 hover:text-black"}`}
                  >
                    Mode Libre
                  </button>
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 flex flex-col gap-6">
                    ...
                    <div className="relative w-40 h-40 shrink-0 mb-6 min-h-[160px] min-w-[160px]">
                      <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
                          <Pie
                            data={[
                              { name: "Consommé", value: calories },
                              { name: "Restant", value: remainingCalories },
                            ]}
                            cx="50%"
                            cy="50%"
                            innerRadius={50}
                    ...
                    <div className="w-full space-y-4">
                      <div>
                        <div className="flex justify-between text-xs font-bold mb-2">
                          <span className="text-black uppercase tracking-widest text-[9px]">
                            <img
                              src={PROTEINS_ICON}
                              className="w-3 h-3 rounded-full inline mr-1"
                            />{" "}
                            Protéines
                          </span>
                          <span className="text-zinc-500 text-[9px]">
                            {proteins} / {proteinGoal}g
                          </span>
                        </div>
                        <div className="h-2 w-full bg-zinc-100 rounded-full overflow-hidden">
                          <div
                            ...
                            style={{
                              width: `${Math.min((proteins / proteinGoal) * 100, 100)}%`,
                            }}
                          ></div>
                        </div>
                      </div>
                  ...
                  >
                    ...
                    <div className="relative z-10 flex flex-col items-center gap-3">
                      ...
                      <h3
                        className={`${spaceGrotesk.className} text-2xl md:text-3xl font-black uppercase text-white tracking-tighter drop-shadow-md text-center`}
                      >
                ...
                <div className="lg:col-span-2 flex flex-col gap-6">
                  ...
                  {trackingMode === "guided" ? (
                    (() => {
                      const todayMenu = weeklyGeneratedMenu.find(
                        (d) => d.day === formattedCurrentDay,
                      );
                      if (!todayMenu)
                        return (
                          <div className="bg-white border border-zinc-200 p-8 text-center text-zinc-500 font-bold rounded-[2.5rem] shadow-sm">
                            Aucun menu généré pour aujourd'hui. Veuillez générer
                            votre Sama Menu.
                          </div>
                        );
                      ...
                      return (
                        <div className="bg-white rounded-[2.5rem] shadow-sm border border-zinc-200 overflow-hidden flex flex-col relative">
                          <div className="h-48 w-full bg-zinc-100 relative overflow-hidden">
                            <img
                              src={
                                todayMenu.meals?.["Déjeuner"]?.image_url ||
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex flex-col justify-end p-5">
                              ...
                              <p className="text-white font-bold text-lg leading-tight line-clamp-1">
                                {todayMenu.meals?.["Déjeuner"]?.nom || "Repas"}
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="p-5 flex-1 flex flex-col gap-3">
                            {(isFastingMode
                              ...
                              if (!recipe) return null;
                              const isConsumed = consumedMeals.some(
                                (m: any) =>
                                  m.name === recipe.nom && m.type === mealType,
                              );

                              return (
                                <div
                                  key={mealType}
                                  className={`flex justify-between items-center p-4 rounded-2xl transition-all ${isConsumed ? "bg-[#39FF14]/15 shadow-sm opacity-90 border border-[#39FF14]" : "bg-zinc-50 hover:bg-white border border-zinc-100"}`}
                                >
                                  <div
                                  ...
                                  >
                                    <p className="text-[9px] font-black uppercase text-zinc-400 mb-0.5">
                                      {mealType}
                                    </p>
                                    <p
                                      className={`text-xs font-bold truncate ${isConsumed ? "text-[#39FF14]" : "text-black"}`}
                                    >
                                      {recipe.nom} {isConsumed && "✅"}
                                    </p>
                                  </div>
                                  <div className="text-right shrink-0 flex flex-col items-end gap-1">
                                    <div className="flex gap-2">
                                      <span
                                        className={`text-[10px] font-bold ${isConsumed ? "text-[#39FF14]" : "text-zinc-500"} flex items-center gap-1`}
                                      >
                                        <img
                                          src={CALS_ICON}
                                    ...
                                    {!isConsumed ? (
                                      <div className="flex flex-col gap-1 items-end mt-1">
                                        <button
                                          onClick={(e) => {
                                            ...
                                            confirmMealLog(
                                              ...
                                              recipe.carbs,
                                              recipe.fats,
                                              { ux_unit: recipe.ux_unit },
                                            );
                                            setToastMessage("Ajouté !");
                                            setTimeout(
                                              () => setToastMessage(null),
                                              3000,
                                            );
                                          }}
                                          className="bg-[#39FF14] text-black px-2 py-1.5 rounded-lg text-[9px] font-black uppercase shadow-sm hover:scale-105 transition-transform w-full"
                                        >
                                          ➕ Loguer
                                        </button>
                                        <div className="flex gap-1">
                                          <button
                                            ...
                                            className="bg-zinc-200 text-zinc-600 px-1.5 py-1 rounded text-[8px] font-black uppercase shadow-sm hover:bg-black hover:text-white transition-colors flex items-center gap-1"
                                      ...
                                      <div className="flex gap-1 mt-1">
                                        <span className="bg-[#39FF14] text-black px-2 py-1 rounded-lg text-[9px] font-black uppercase shadow-sm">
                                          Validé ✅
                                        </span>
                                        <button
                                          onClick={(e) => {
                                        ...
                                        >
                                          <img
                                            src="https://res.cloudinary.com/dtr2wtoty/image/upload/v1786103561/TRASH_xo3mys.png"
                                            className="w-3 h-3"
                                          />
                                        </button>
                                      </div>
                    ...
                    <div className="space-y-4 bg-white p-6 rounded-[2.5rem] border border-zinc-200 shadow-sm flex-1">
                      <div className="mb-4">
                        <h3 className="font-black text-lg text-black uppercase tracking-tighter">
                          Menu Libre
                        </h3>
                        <p className="text-zinc-500 text-xs font-bold">
                          Composez votre assiette avec vos propres repas.
                        </p>
                      </div>
                      {(isFastingMode
                        ? ["Déjeuner", "Collation", "Dîner"]
                        ...
                        const loggedMeals = consumedMeals.filter(
                          (m: any) => m.type === mealType,
                        );
                        return (
                          <div
                            key={mealType}
                            className="flex flex-col gap-2 p-4 rounded-2xl bg-zinc-50 border border-zinc-100 hover:border-black transition-colors cursor-pointer"
                            onClick={() => {
                              setActiveMealType(mealType);
                              setEditingMeal(null);
                              setIsSearchModalOpen(true);
                            ...
                            {loggedMeals.length > 0 && (
                              <div className="mt-2 space-y-1">
                                {loggedMeals.map((m: any, idx) => (
                                  <div
                                    key={idx}
                                    className="flex justify-between items-center bg-white p-2 rounded-lg border border-zinc-100 cursor-pointer hover:border-[#39FF14] transition-colors"
                                    onClick={(e) => {
                                      e.stopPropagation();
                                      setActiveMealType(mealType);
                                      setEditingMeal(m);
                                  ...
                                  >
                                    <span className="text-xs font-bold text-[#39FF14] truncate">
                                      {m.name}{" "}
                                    ...
                                    <div className="flex items-center gap-3 shrink-0">
                                      ...
                                      <button
                                        ...
                                        className="bg-red-50 text-red-500 p-1.5 rounded-lg hover:bg-red-500 hover:text-white transition-colors"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="rounded-[2rem] border border-blue-100 shadow-sm p-4 relative overflow-hidden flex flex-col justify-between group">
                      ...
                      <div className="relative z-10">
                        ...
                        <p className="text-xl font-black text-black mb-0 leading-none">
                          {waterGlasses}{" "}
                        ...
                        <p className="text-[10px] font-bold text-blue-400 uppercase tracking-widest mb-1">
                          {(waterGlasses * 312.5).toFixed(0)} ml
                        </p>
                        <p className="text-[8px] font-bold text-zinc-600 uppercase tracking-widest leading-tight max-w-[90%]">
                          ...
                          {waterGlasses > 0 &&
                            waterGlasses < 4 &&
                            "Continue comme ça ! Chaque verre compte."}
                          {waterGlasses >= 4 &&
                            waterGlasses < 8 &&
                            "Tu es à la moitié, bravo !"}
                          {waterGlasses >= 8 &&
                            "Objectif atteint ! Corps hydraté 💧"}
                        </p>
                      </div>
                      ...
                      <div className="grid grid-cols-4 gap-1 mt-3 z-10">
                        {Array.from({ length: 8 }).map((_, i) => (
                          <button
                            key={i}
                            onClick={() =>
                              handleUpdateWater(i + 1 - waterGlasses)
                            }
                    ...
                    <button
                      ...
                      className="bg-[#39FF14] p-4 rounded-[2rem] border border-black shadow-sm flex flex-col justify-center items-center text-center cursor-pointer hover:scale-[1.02] transition-transform"
                    >
                      <CheckCircle size={24} className="text-black mb-2" />
                      <h3 className="font-black text-xs uppercase tracking-tighter text-black mb-1">
                        Bilan du jour
                      </h3>
                      <p className="text-black/70 font-bold text-[9px]">
                        Clôturez pour gagner de l'XP.
                      </p>
                    </button>
                  </div>
                </div>
              ...
              <div className="bg-white border border-zinc-200 shadow-sm rounded-[2rem] p-8 mt-12 relative overflow-hidden">
                <h3 className="text-xl font-black uppercase text-black mb-6 flex items-center gap-2">
                  <ShoppingCart
                    className="text-[#39FF14] bg-black p-1.5 rounded-lg"
                    size={24}
                  />{" "}
                  La Boutique Onyx
                </h3>
                <p className="text-zinc-500 font-bold text-sm mb-6">
                  Boostez vos résultats avec nos produits 100% naturels.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {crossSellProducts.slice(0, 3).map((p: any) => (
                    <div
                      key={p.id}
                      className="bg-zinc-50 border border-zinc-200 rounded-3xl overflow-hidden flex flex-col group cursor-pointer hover:border-[#39FF14] transition-colors"
                      onClick={() => handleTabChange("shop")}
                    >
                      ...
                      <div className="p-4 flex flex-col flex-1">
                        <p className="text-sm font-black text-black group-hover:text-[#39FF14] transition-colors line-clamp-1">
                          {p.nom}
                        </p>
                        <p className="text-[10px] text-zinc-500 uppercase tracking-widest mt-1 mb-4">
                          {p.prix_standard} FCFA
                        </p>
              ...
              <section>
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-zinc-500 font-bold text-xs mt-1 max-w-lg leading-relaxed">
                        Votre programme quotidien visuel. Suivez ces
                        recommandations sans tracas. Loguez vos plats ici.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    <button
                      ...
                      className="bg-white border border-zinc-200 text-black px-6 py-3 rounded-xl font-black uppercase text-[10px] tracking-widest hover:bg-zinc-50 transition shadow-sm flex items-center gap-2"
                    >
                      <RefreshCcw size={14} /> Regénérer
                    </button>
                    <button
                      onClick={() => setShowGroceryList(true)}
                      className="bg-black text-[#39FF14] px-6 py-3 rounded-xl font-black uppercase text-[10px] tracking-widest hover:bg-zinc-800 transition shadow-sm flex items-center gap-2"
                    >
                      <ShoppingCart size={14} /> Liste de courses
                    </button>
                    <button
                      onClick={downloadGroceryListPDF}
                      className="bg-white border border-zinc-200 text-black px-6 py-3 rounded-xl font-black uppercase text-[10px] tracking-widest hover:bg-zinc-50 transition shadow-sm flex items-center gap-2 hidden sm:flex"
                    >
                ...
                {clientProfile?.plan_type !== "premium" && daysLeft <= 0 ? (
                  <div className="bg-white border-2 border-dashed border-zinc-300 rounded-[2rem] p-12 text-center relative overflow-hidden">
                    ...
                    <h3 className="font-black uppercase text-xl text-black mb-2">
                      Générateur Verrouillé
                    </h3>
                    <p className="text-sm font-medium text-zinc-500 mb-6 max-w-md mx-auto">
                      Votre période d'essai est terminée. Passez au plan Premium
                      pour réactiver le Smart Planner et votre liste de courses
                      automatique.
                    </p>
                    <button
                      onClick={() =>
                        window.open(
                          "https://wa.me/221785338417?text=Bonjour, je souhaite passer au plan Premium !",
                          "_blank",
                        )
                      }
                      className="bg-[#39FF14] text-black px-8 py-4 rounded-xl font-black uppercase text-xs tracking-widest hover:scale-105 transition-transform shadow-lg flex items-center justify-center gap-2 mx-auto"
                    >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 w-full">
                    {(() => {
                      const today = weeklyGeneratedMenu.find(
                        (d) => d.day === formattedCurrentDay,
                      );
                      const others = weeklyGeneratedMenu.filter(
                        (d) => d.day !== formattedCurrentDay,
                      );
                      const displayMenu = today
                        ? [today, ...others]
                        : weeklyGeneratedMenu;
                      return displayMenu.map((dayPlan, dIdx) => {
                        ...
                        return (
                          <div
                            key={`${dIdx}-${dayPlan.meals?.["Déjeuner"]?.id || "empty"}`}
                            className={`bg-white rounded-[2.5rem] shadow-[0_15px_40px_rgba(0,0,0,0.06)] border-0 overflow-hidden flex flex-col group relative animate-in fade-in zoom-in-95 slide-in-from-bottom-4 duration-500 ${isToday ? "ring-4 ring-[#39FF14]" : "opacity-80 grayscale-[20%] hover:grayscale-0 hover:opacity-100 transition-all"}`}
                            style={{
                              animationFillMode: "both",
                              animationDelay: `${dIdx * 100}ms`,
                            }}
                          >
                            <div
                              className={`absolute top-4 left-4 ${isToday ? "bg-[#39FF14] text-black" : "bg-black text-white"} px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest z-10 shadow-lg`}
                            >
                            ...
                            <div className="h-48 w-full bg-zinc-100 relative overflow-hidden">
                              <img
                                src={
                                  dayPlan.meals?.["Déjeuner"]?.image_url ||
                                  "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?q=80&w=800&auto=format&fit=crop"
                                }
                                alt="Repas"
                              ...
                              <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex flex-col justify-end p-5">
                                ...
                                <p className="text-white font-bold text-lg leading-tight line-clamp-1">
                                  {dayPlan.meals?.["Déjeuner"]?.nom || "Repas"}
                                </p>
                                {dayPlan.meals?.["Déjeuner"]?.is_boutique && (
                                  <span className="absolute top-4 right-4 bg-[#39FF14] text-black px-2 py-1 rounded text-[9px] font-black uppercase shadow-md">
                                    Boutique
                                  </span>
                                )}
                              </div>
                            ...
                            <div className="p-5 flex-1 flex flex-col gap-3">
                              {(isFastingMode
                                ...
                                if (!recipe) return null;
                                const isToday =
                                  dayPlan.day === formattedCurrentDay;
                                const isConsumed =
                                  isToday &&
                                  consumedMeals.some(
                                    (m: any) =>
                                ...
                                const isBolCommun =
                                  clientProfile?.diagnostic_data
                                    ?.lunch_context === "maison_bol_commun" &&
                                  mealType === "Déjeuner";
                                ...
                                return (
                                  <React.Fragment key={mealType}>
                                    <div
                                      className={`flex justify-between items-center p-4 rounded-2xl transition-all ${isConsumed ? "bg-[#39FF14]/15 shadow-sm opacity-90 border border-[#39FF14]" : "bg-zinc-50 hover:bg-white hover:shadow-md"}`}
                                    >
                                      <div
                                        className="flex-1 min-w-0 pr-2 cursor-pointer"
                                        onClick={() =>
                                      ...
                                      <div className="text-right shrink-0 flex flex-col items-end gap-1 relative">
                                        {isExpertMode ? (
                                          ...
                                          <span
                                            className={`text-[10px] font-bold ${isConsumed ? "text-[#39FF14]" : "text-zinc-500"}`}
                                          >
                                            {recipe.ux_unit || "1 portion"}
                                          </span>
                                        )}
                                        ...
                                        <div className="flex items-center gap-1 mt-0.5">
                                          {isToday && !isConsumed && (
                                            <button
                                              ...
                                              className="bg-[#39FF14] text-black px-1.5 py-1 rounded text-[8px] font-black uppercase shadow-sm hover:bg-black hover:text-[#39FF14] transition-colors"
                                              title="Ajouter à Mon Jour"
                                            >
                                              ➕ Ajouter
                                            </button>
                                          )}
                                          {isConsumed && (
                                            <span className="bg-[#39FF14] text-black px-2 py-0.5 rounded text-[8px] font-black uppercase shadow-sm">
                                              Validé ✅
                                            </span>
                                          )}
                                          {!isConsumed && !isToday && (
                                            <span className="bg-zinc-200 text-zinc-500 px-2 py-0.5 rounded text-[8px] font-black uppercase">
                                              Prévu
                                            </span>
                                          )}
                                          {!isConsumed && isToday && (
                                    ...
                                    {isBolCommun && (
                                      <div className="bg-zinc-100 border-2 border-[#39FF14] p-4 rounded-xl mt-1 mb-2">
                                        <p className="text-xs font-medium text-black leading-relaxed">
                                          💡 <strong>Conseil Woyof :</strong>{" "}
                                          Servez votre part dans une petite
                                          assiette creuse avant de rejoindre la
                                          famille, ou limitez votre espace de
                                          riz à la taille de votre poing dans le
                                          grand bol.
                                        </p>
                                      </div>
                                    )}
                ...
                {(clientProfile?.plan_type === "premium" || daysLeft > 0) &&
                  weeklyGeneratedMenu.length > 0 && (
                    <div className="mt-12 text-center">
                      <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
                        <button
                          onClick={() => setShowGroceryList(true)}
                          className="bg-black text-[#39FF14] px-10 py-5 rounded-[2.5rem] font-black uppercase text-sm md:text-base tracking-widest hover:scale-105 transition-transform shadow-[0_15px_40px_rgba(57,255,20,0.3)] flex items-center justify-center gap-3"
                        >
                          <ShoppingCart size={24} /> Voir ma liste de courses
                        </button>
                        {(() => {
                          const list = getGroceryList();
                          const totalCost = Object.values(list)
                            .flatMap((rayon) => Object.values(rayon as any))
                            .reduce(
                              (acc: number, item: any) =>
                                acc + item.price_cfa * item.quantite,
                              0,
                            );
                          return (
                            <p className="text-xs font-bold text-zinc-500 mt-2">
                              Coût estimé pour la semaine :{" "}
                              {totalCost.toLocaleString("fr-FR")} FCFA (Marché
                              Sandaga/Auchan)
                            </p>
                          );
                        })()}
                        <button
                          onClick={downloadGroceryListPDF}
                          className="bg-white text-black border-2 border-zinc-200 px-8 py-5 rounded-[2.5rem] font-black uppercase text-sm md:text-base tracking-widest hover:scale-105 transition-transform shadow-sm flex items-center justify-center gap-3"
                        >
                          <Download size={24} /> Télécharger PDF
                        </button>
                      </div>
                      <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest mt-4">
                        Calculée automatiquement d'après votre Sama Menu
                      </p>
                    </div>
                  )}
              </section>
                    ...
                    >
                      {menu.status === "locked" && (
                        <div className="absolute inset-0 bg-white/60 backdrop-blur-[2px] z-10 flex flex-col items-center justify-center p-6 text-center">
                          ...
                          <h3 className="font-black uppercase text-lg text-black mb-2">
                            Semaine Verrouillée
                          </h3>
                          <p className="text-xs font-bold text-zinc-500 mb-6">
                            Passez au plan Premium pour débloquer la suite de
                            votre programme.
                          </p>
                        </div>
                      )}
                      ...
                      <div className="flex justify-between items-start mb-6">
                        <div>
                          <span
                            className={`inline-block px-3 py-1 rounded-md text-[10px] font-black uppercase tracking-widest mb-3 ${menu.status === "unlocked" ? "bg-[#39FF14]/20 text-green-700" : "bg-zinc-200 text-zinc-500"}`}
                          >
                            Semaine {menu.week}
                          </span>
                          <h3
                            className={`${spaceGrotesk.className} text-xl font-black uppercase text-black`}
                          >
                            {menu.title}
                          </h3>
                        </div>
                      ...
                      {menu.status === "unlocked" && (
                        <div className="bg-zinc-50 border border-zinc-100 p-5 rounded-2xl">
                          <p className="text-[10px] font-black uppercase tracking-widest text-zinc-400 mb-3 border-b border-zinc-200 pb-2">
                            Aperçu du menu
                          </p>
                          <ul className="space-y-3">
                            {menu.meals.map((meal: string, i: number) => (
                              <li
                                key={i}
                                className="text-xs font-bold text-zinc-700 flex items-start gap-2"
                              >
                            ...
                            {safeWeeklyMenu.find(
                              ...
                              <li className="text-xs font-bold text-green-700 flex items-start gap-2 mt-4">
                                ...
                                />{" "}
                                Recette priorisée pour votre budget serré !
                              </li>
                            )}
                          </ul>
                        </div>
              ...
              <section>
                <div className="bg-white border border-zinc-200 p-8 md:p-10 rounded-[2rem] shadow-sm flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden group hover:border-[#39FF14] transition-colors">
                  <div className="flex items-center gap-6 relative z-10">
                    ...
                    <div>
                      <h2
                        className={`${spaceGrotesk.className} text-2xl font-black uppercase tracking-tighter mb-1`}
                      >
                        Le Guide Complet
                      </h2>
                      <p className="text-zinc-500 font-bold text-sm">
                        Nutrition à l'Africaine : Vos astuces et recettes de
                        base.
                      </p>
                    </div>
                  </div>
          ...
          {activeTab === "orders" && (
            <div className="space-y-8 animate-in fade-in slide-in-from-right-4 max-w-4xl mx-auto">
              ...
              <div className="bg-white p-8 rounded-[2rem] border border-zinc-200 shadow-sm">
                <h2
                  className={`${spaceGrotesk.className} text-2xl font-black uppercase tracking-tighter text-black flex items-center gap-3 mb-6`}
                >
                  <Package
                    className="text-[#39FF14] bg-black p-2 rounded-xl"
                    size={36}
                  />{" "}
                  Mes Commandes
                </h2>
                  ...
                  <div className="flex flex-col sm:flex-row items-end gap-4">
                    <div className="flex-1 w-full">
                      ...
                      <input
                        ...
                        className="w-full p-3 bg-white border border-zinc-200 rounded-xl font-bold text-sm outline-none focus:border-[#39FF14] transition"
                        placeholder="Ex: Dakar, Sicap Amitié 2..."
                      />
                    </div>
                    <button
                      onClick={async () => {
                      ...
                      disabled={isSaving}
                      className="w-full sm:w-auto bg-black text-[#39FF14] px-6 py-3 rounded-xl font-black text-xs uppercase hover:scale-105 transition shadow-md h-[46px] flex items-center justify-center"
                    >
                ...
                <div className="space-y-4">
                  {clientOrders.map((order) => (
                    <div
                      key={order.id}
                      className="bg-white border border-zinc-200 rounded-2xl p-6 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-6 hover:border-black transition-colors"
                    >
                      <div>
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <span
                            className={`px-2 py-1 rounded-md text-[10px] font-black uppercase tracking-widest ${order.status === "Nouveau" ? "bg-blue-100 text-blue-700" : order.status === "Livré" ? "bg-green-100 text-green-700" : order.status === "Annulé" ? "bg-red-100 text-red-700" : "bg-orange-100 text-orange-700"}`}
                          >
                            {order.status}
                          </span>
                        </div>
                        ...
                        <p className="text-xs font-medium text-zinc-500">
                          {order.items?.length || 0} article(s) • Livré à :{" "}
                          {order.address || "Non spécifié"}
                        </p>
                      </div>
                      <div className="text-left md:text-right flex flex-col items-start md:items-end">
                        ...
                        {order.promo_code && (
                          <p className="text-[10px] font-black uppercase text-zinc-400 mt-1">
                            Code : {order.promo_code}
                          </p>
                        )}
                        <button
                          onClick={() => handleReorder(order)}
                          className="mt-3 bg-zinc-100 text-black px-3 py-2 rounded-lg text-[10px] font-black uppercase tracking-widest hover:bg-[#39FF14] transition-colors flex items-center justify-center gap-1 shadow-sm w-full md:w-auto"
                        >
            ...
            <div className="space-y-8 animate-in fade-in slide-in-from-right-4">
              ...
              <div className="w-full bg-white dark:bg-zinc-950 rounded-[2.5rem] p-6 sm:p-10 shadow-[0_0_40px_rgba(57,255,20,0.08)] border border-zinc-200/80 dark:border-zinc-800/80 relative overflow-hidden mb-8">
                ...
                <div className="w-full h-40 sm:h-48 rounded-3xl bg-zinc-800 relative overflow-hidden mb-12 group">
                  {profileForm.cover_url || clientProfile?.cover_url ? (
                    <img
                      src={profileForm.cover_url || clientProfile?.cover_url}
                      alt="Cover"
                      className="w-full h-full object-cover"
                    />
                  ) : (
                    <div className="w-full h-full bg-gradient-to-r from-zinc-800 to-zinc-900 flex items-center justify-center text-zinc-600 text-sm font-poppins">
                      Bannière par défaut • Ajoutez une URL ci-dessous
                    </div>
                  )}
                  ...
                  <div
                    ...
                    title="Changer l'avatar par URL"
                  >
                    <img
                      src={
                        ...
                        "https://ui-avatars.com/api/?name=" +
                          encodeURIComponent(profileForm.firstName || "M")
                      }
                      alt="Avatar"
                      className="w-24 h-24 rounded-full border-4 border-white dark:border-zinc-900 object-cover shadow-lg cursor-pointer hover:opacity-80 transition-opacity bg-zinc-100"
                    />
                  </div>
                </div>
                ...
                <div className="mb-8 max-w-2xl">
                  ...
                  <input
                    ...
                    className="w-full rounded-2xl border-2 border-zinc-200 dark:border-zinc-800 focus:border-[#39FF14] bg-zinc-50 dark:bg-zinc-900 p-4 text-zinc-900 dark:text-white font-poppins text-sm transition-colors outline-none"
                    placeholder="https://..."
                  />
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center mt-6">
                  ...
                  <div className="lg:col-span-4 space-y-4 order-1">
                    <h3 className="font-poppins-bold text-lg text-zinc-900 dark:text-white mb-4 uppercase">
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-4 mb-4">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full rounded-2xl border-2 border-zinc-200 dark:border-zinc-800 focus:border-[#39FF14] bg-white dark:bg-zinc-900 p-4 text-zinc-900 dark:text-white font-poppins text-sm transition-colors outline-none"
                            required
                          />
                        </div>
                        <div>
                      ...
                      <div className="mb-4">
                        ...
                        <textarea
                          ...
                          className="w-full rounded-2xl border-2 border-zinc-200 dark:border-zinc-800 focus:border-[#39FF14] bg-white dark:bg-zinc-900 p-4 text-zinc-900 dark:text-white font-poppins text-sm transition-colors outline-none resize-none"
                          placeholder="African Wellness Warrior. Passionate about healthy eating..."
                        ></textarea>
                      </div>
                      ...
                      <div className="grid grid-cols-3 gap-4">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full rounded-2xl border-2 border-zinc-200 dark:border-zinc-800 focus:border-[#39FF14] bg-white dark:bg-zinc-900 p-3 text-zinc-900 dark:text-white font-poppins text-sm transition-colors outline-none"
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex flex-col  items-center gap-4 mt-8 pt-8 border-t border-zinc-100 dark:border-zinc-800">
                        <button
                          ...
                          disabled={isSaving}
                          className="w-full w-full bg-[#39FF14] text-black font-poppins-extrabold px-8 py-4 rounded-full shadow-lg hover:scale-105 transition-all"
                        >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                ...
                <div className="col-span-1 bg-[#39FF14]/10 rounded-3xl p-6 border border-zinc-200/60 dark:border-zinc-800 flex flex-col justify-center items-center text-center">
                  <span className="text-[10px] text-zinc-600 font-black uppercase tracking-widest mb-1">
                    Mon IMC
                  </span>
                ...
                <div className="col-span-1 bg-zinc-50 dark:bg-zinc-900 rounded-3xl p-6 border border-zinc-200/60 dark:border-zinc-800 flex flex-col justify-center items-center text-center">
                  ...
                  <div className="text-3xl font-black text-[#39FF14]">
                    {clientProfile?.jongoma_xp ||
                      clientProfile?.nutrition_profiles?.jongoma_xp ||
                      0}
                  </div>
                </div>
              </div>
              ...
              {earnedBadges.length > 0 && (
                <div className="bg-white dark:bg-zinc-950 p-8 rounded-[24px] border border-zinc-200 dark:border-zinc-800 shadow-[0_8px_30px_rgb(0,0,0,0.04)] mb-8">
                  <h3 className="text-lg font-black uppercase text-black dark:text-white mb-4 flex items-center gap-2">
                    <Trophy className="text-yellow-500" /> Mes Badges Débloqués
                  </h3>
                  <div className="flex flex-wrap gap-4">
                    {earnedBadges.map((badge, i) => (
                      <div
                        key={i}
                        className="flex items-center gap-2 bg-gradient-to-r from-yellow-500/10 to-orange-500/10 border border-yellow-500/30 px-4 py-2 rounded-xl text-yellow-700 dark:text-yellow-400 font-poppins-bold shadow-sm"
                      >
              ...
              <div className="bg-white p-8 rounded-[24px] border border-zinc-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] mt-8">
                <h3 className="text-lg font-black uppercase text-black mb-4 flex items-center gap-2">
                  <Bell className="text-orange-500" /> Notifications & Rappels
                </h3>
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 bg-zinc-50 border border-zinc-100 rounded-xl gap-4">
                  <div>
                    <p className="font-bold text-sm text-black">
                      Rappels d'hydratation (Eau)
                    </p>
                    <p className="text-[10px] font-black uppercase text-zinc-500 mt-1">
                      Toutes les 2 heures si objectif non atteint
                    </p>
                  </div>
                  <div className="flex items-center gap-3">
                    <button
                      onClick={sendWaterReminderPush}
                      className="text-[10px] font-bold text-zinc-400 hover:text-black uppercase underline"
                    >
                      Tester
                    </button>
                    <button
                      onClick={togglePushNotifications}
                      className={`px-4 py-2 rounded-lg font-black uppercase text-[10px] tracking-widest transition-colors ${pushEnabled ? "bg-green-100 text-green-700" : "bg-black text-[#39FF14] hover:bg-zinc-800"}`}
                    >
              ...
              <div className="bg-white p-8 rounded-[24px] border border-zinc-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] mt-8">
                <h3 className="text-lg font-black uppercase text-black mb-4 flex items-center gap-2">
                  <Download className="text-[#39FF14]" /> Historique des
                  Téléchargements PDF
                </h3>
                {Array.isArray(pdfHistory) && pdfHistory.length > 0 ? (
                  <div className="space-y-3 max-h-64 overflow-y-auto pr-2 custom-scrollbar">
                    {pdfHistory.map((item, idx) => (
                      <div
                        key={idx}
                        className="flex justify-between items-center bg-zinc-50 p-4 rounded-xl border border-zinc-100"
                      >
                        <div>
                          <p className="font-bold text-sm text-black">
                            {item.type}
                        ...
                        {item.url ? (
                          <a
                            ...
                            className="bg-black text-[#39FF14] px-4 py-2 rounded-lg text-[10px] font-black uppercase hover:scale-105 transition-transform flex items-center gap-2 w-max"
                          >
                            <ExternalLink size={14} /> Ouvrir
                          </a>
                        ) : (
                          <span className="bg-zinc-200 text-zinc-500 px-3 py-1 rounded-lg text-[10px] font-black uppercase w-max">
                            Local
                          </span>
                        )}
                      </div>
                  ...
                  <p className="text-sm font-medium text-zinc-500 italic">
                    Aucun PDF téléchargé ou partagé pour le moment.
                  </p>
                )}
              </div>
            </div>
          ...
          <div className="fixed bottom-6 right-6 z-[100] bg-black text-white p-4 rounded-2xl shadow-2xl border-l-4 border-red-500 max-w-sm flex items-start gap-4 animate-in slide-in-from-right-8">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-400 font-medium mb-3">
                Il est plus de 20h00, n'oubliez pas de remplir votre bilan de
                fin de journée pour adapter votre menu de demain.
              </p>
              <div className="flex gap-2">
                <button
                  onClick={() => {
                  ...
                  className="bg-[#39FF14] text-black px-4 py-2 rounded-lg font-black text-[10px] uppercase transition-transform hover:scale-105"
                >
                  Remplir maintenant
                </button>
                <button
                  onClick={() => setShowReminder(false)}
                  className="text-zinc-500 hover:text-white px-2 py-2 rounded-lg font-bold text-[10px] uppercase"
                >
                  Plus tard
                </button>
              </div>
        ...
        {showGroceryList && (
          <div
            id="grocery-overlay"
            onClick={(e: any) =>
              e.target.id === "grocery-overlay" && setShowGroceryList(false)
            }
          ...
          >
            <div className="bg-white p-8 sm:p-10 rounded-3xl max-w-2xl w-full relative shadow-2xl border-t-[8px] border-[#39FF14] animate-in zoom-in-95 my-auto max-h-[90vh] overflow-y-auto">
              <button
                ...
                className="absolute top-6 right-6 p-2 bg-zinc-100 rounded-full hover:bg-black hover:text-[#39FF14] transition-all"
              >
                <X size={20} />
              </button>
              <h2
                className={`${spaceGrotesk.className} text-3xl font-black uppercase text-black tracking-tighter mb-2 flex items-center gap-3`}
              >
                <ShoppingCart size={32} className="text-[#39FF14]" /> Liste de
                Courses
              </h2>
              <p className="text-xs font-bold text-zinc-500 uppercase tracking-widest mb-8">
                Générée automatiquement d'après votre menu
              </p>
              ...
              <div className="space-y-8">
                {Object.entries(getGroceryList()).map(([rayon, items]: any) => {
                  ...
                  let subtitle = "";
                  if (rayon === "Produits Locaux / Épices")
                    subtitle =
                      "Acheter au marché ou commander sur la boutique Onyx";
                  else if (rayon === "Glucides & Laitages")
                    subtitle = "Acheter au supermarché (Auchan, Casino)";
                  else if (rayon === "Protéines Fraîches")
                    subtitle = "Acheter chez le boucher / poissonnier";
                  ...
                  return (
                    ...
                    >
                      <h4 className="font-black uppercase text-sm text-black mb-1">
                        {rayon}
                      </h4>
                      ...
                      <ul className="grid md:grid-cols-2 gap-x-6 gap-y-3">
                        {Object.entries(items).map(([nom, data]: any) => {
                          ...
                          return (
                            <li
                              key={nom}
                              className="flex items-center justify-between text-sm font-medium border-b border-zinc-200 pb-2"
                            >
                              <label className="flex items-center gap-3 cursor-pointer group">
                                <div
                                  className={`w-6 h-6 rounded-xl flex items-center justify-center border-2 transition-colors ${isExcluded ? "bg-[#39FF14] border-[#39FF14]" : "bg-white border-zinc-300 group-hover:border-black"}`}
                                >
                                  {isExcluded && (
                                    <CheckCircle
                                      size={14}
                                ...
                                <input
                                  ...
                                  className="hidden"
                                  checked={isExcluded}
                                  onChange={() => toggleExcludeIngredient(nom)}
                                />
                                <span
                                  className={
                                    isExcluded
                              ...
                              <span
                                className={`font-black ${isExcluded ? "text-zinc-400 line-through" : "text-black dark:text-white"}`}
                              >
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-8">
                <button
                  onClick={downloadGroceryListPDF}
                  className="flex-1 bg-zinc-100 text-black py-4 rounded-xl font-black uppercase text-xs tracking-widest hover:bg-zinc-200 transition-colors shadow-sm flex items-center justify-center gap-2"
                >
                ...
                <button
                  ...
                  className="flex-1 bg-[#25D366] text-white py-4 rounded-xl font-black uppercase text-xs tracking-widest hover:scale-105 transition-transform shadow-lg flex items-center justify-center gap-2 disabled:opacity-50"
                >
                  {isSharingPDF ? (
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-right-4 w-full">
            ...
            <div className="bg-white p-8 rounded-[2rem] border border-zinc-200 shadow-sm w-full">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 w-full">
                {(() => {
                  const top10RecipeIds = [...allRecipesDB]
                  ...
                  let filteredRecipes = allRecipesDB.filter((r) => {
                    ...
                    const matchSearch =
                      ...
                      (numericQuery !== "" &&
                        r.calories?.toString().includes(numericQuery)) ||
                      (numericQuery !== "" &&
                        r.proteins?.toString().includes(numericQuery));
                    if (!matchSearch) return false;
                    if (recipeFilter === "Favoris")
                      return favoriteMeals.some(
                        (f) => (f.meal || f.nom) === r.nom,
                      );
                    if (recipeFilter === "Populaire") return true;
                    if (recipeFilter === "Main Course")
                      return r.type === "Déjeuner" || r.type === "Dîner";
                    if (recipeFilter === "Healthy")
                      return r.carbs <= 40 && r.fats <= 15;
                    if (recipeFilter === "Low Calories")
                      return r.calories <= 350;
                    if (recipeFilter === "Desserts")
                      return (
                        r.type === "Collation" || r.type === "Petit-déjeuner"
                      );
                    return true;
                  });
                  ...
                  return filteredRecipes.map((fav, i) => {
                    ...
                    return (
                      <div
                        key={fav.id || i}
                        className="w-full flex flex-col bg-zinc-50 p-5 rounded-2xl border border-zinc-100 justify-between hover:border-[#39FF14] transition-colors group"
                      >
                        <div className="w-full">
                          ...
                          <div className="flex justify-between items-start mb-2">
                            <div className="flex flex-col">
                              ...
                              <p
                                className={`text-[10px] font-bold flex items-center gap-1 mt-0.5 ${(fav.preparation_time || 15) > 45 ? "text-red-500" : "text-zinc-500"}`}
                              >
                                <Clock size={12} /> {fav.preparation_time || 15}{" "}
                                min
                              </p>
                            </div>
                            <button
                              onClick={() => toggleFavorite(fav)}
                              className={`transition-colors ${isFav ? "text-red-500 hover:text-red-700" : "text-zinc-300 hover:text-red-500"} shrink-0`}
                            >
                              <HeartPulse
                                size={18}
                          ...
                          <div className="flex flex-wrap gap-1 mb-3">
                            {isTop10 && (
                              <span className="bg-yellow-400 text-yellow-900 px-1.5 py-0.5 rounded text-[8px] font-black uppercase tracking-widest flex items-center gap-1 shadow-sm">
                                <Trophy size={10} /> Top 10
                              </span>
                            )}
                            {tags.map((t) => (
                              <span
                                key={t}
                                className="bg-black text-[#39FF14] px-1.5 py-0.5 rounded text-[8px] font-black uppercase tracking-widest"
                              >
                                {t}
                              </span>
                            ))}
                            {fav.budget_tier && (
                              <span
                                className={`px-1.5 py-0.5 rounded text-[8px] font-black uppercase tracking-widest shadow-sm ${
                                  fav.budget_tier === "Serré 8k"
                                    ? "bg-green-500 text-white"
                                    : fav.budget_tier === "Famille 15k"
        ...
        {activeTab === "shop" && (
          <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4">
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                <h2
                  className={`${spaceGrotesk.className} text-3xl md:text-4xl font-black uppercase tracking-tighter text-black dark:text-white`}
                >
                  Boutique Onyx
                </h2>
                <p className="text-zinc-500 font-bold text-sm mt-1">
                  Super-aliments & Équipements
                </p>
              </div>
            </div>
            ...
            <div className="w-full h-48 md:h-64 rounded-[2.5rem] overflow-hidden mb-12 shadow-xl relative border border-zinc-200 dark:border-zinc-800 flex items-center justify-between">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-black/80 to-transparent flex flex-col justify-center p-10">
                <h2
                  className={`${spaceGrotesk.className} text-white text-3xl md:text-5xl font-black uppercase tracking-tighter shadow-sm mb-2`}
                >
                  Essentiels <span className="text-[#39FF14]">Nutrition</span>
                </h2>
                <p className="text-zinc-300 font-bold uppercase tracking-widest text-[10px] md:text-xs">
              ...
              {shopCart.length > 0 && (
                <div className="absolute right-6 top-1/2 -translate-y-1/2 flex flex-col items-end gap-3 z-10 bg-black/60 backdrop-blur-md p-6 rounded-3xl border border-white/10">
                  <button
                    onClick={() => setShowCartModal(true)}
                    className="bg-[#39FF14] text-black px-8 py-4 rounded-xl font-black uppercase text-xs hover:scale-105 transition shadow-[0_0_40px_#39FF14] flex items-center gap-3"
                  >
            ...
            <div
              className={`flex flex-col md:flex-row items-center justify-between gap-6 p-8 rounded-[2.5rem] mb-12 shadow-sm border ${theme === "dark" ? "bg-zinc-900 border-zinc-800" : "bg-white border-zinc-200"}`}
            >
              <div>
                <h3 className="text-2xl font-black uppercase text-black dark:text-white mb-2 flex items-center gap-2">
                  <Sparkles className="text-yellow-500" /> Ticket Surprise
                </h3>
                <p className="text-sm font-medium text-zinc-500 max-w-sm mb-4">
                  Grattez la zone grise ci-contre (survolez ou touchez) pour
                  révéler votre code promo exclusif du jour.
                </p>
              </div>
              <div className="shrink-0 relative w-64 h-32 rounded-2xl overflow-hidden shadow-inner border-4 border-[#39FF14] bg-black select-none touch-none">
                <div className="absolute inset-0 flex flex-col items-center justify-center z-0 p-4">
                  ...
                  <p className="text-3xl font-black text-[#39FF14] tracking-widest">
                    CODE10
                  </p>
                ...
                <div
                  className={`absolute inset-0 grid grid-cols-8 grid-rows-4 z-10 transition-opacity duration-1000 ${scratchedBlocks.length > 16 ? "opacity-0 pointer-events-none" : "opacity-100"}`}
                >
                ...
                {scratchedBlocks.length <= 16 && (
                  <div className="absolute inset-0 z-20 pointer-events-none flex items-center justify-center opacity-90">
                    <p className="font-black text-white uppercase text-lg rotate-[-10deg] drop-shadow-lg bg-black/40 px-3 py-1 rounded-xl border border-white/20 backdrop-blur-sm">
                      Grattez-moi !
                    </p>
                  </div>
                )}
            ...
            <div className="mb-16">
              <h3
                className={`${spaceGrotesk.className} text-2xl font-black uppercase tracking-tighter mb-6 flex items-center gap-2 text-black dark:text-white`}
              >
                <Sparkles className="text-[#39FF14]" /> Nouveautés de la semaine
              </h3>
                  ...
                  {(Array.isArray(shopDataDB) ? shopDataDB : [])
                    ...
                    .map((product) => (
                      <div
                        ...
                        className={`flex-[0_0_auto] w-64 ${theme === "dark" ? "bg-zinc-900 border-zinc-800" : "bg-white border-zinc-100"} border rounded-[2rem] p-4 cursor-pointer hover:border-[#39FF14] transition-all group shadow-sm mr-4`}
                      >
                        <div className="aspect-square rounded-2xl bg-zinc-50 dark:bg-zinc-950 overflow-hidden mb-4 relative">
                          <img
                            ...
                            className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                          />
                          <span className="absolute top-2 right-2 bg-black text-[#39FF14] px-2 py-1 rounded text-[8px] font-black uppercase tracking-widest shadow-lg">
                            New
                          </span>
                          {product.stock <= 10 && (
                            <span className="absolute top-2 left-2 bg-red-600 text-white px-2 py-1 rounded text-[8px] font-black uppercase tracking-widest shadow-lg animate-pulse">
                              Quantité Limitée
                            </span>
                          )}
                        </div>
                        <h4 className="font-black text-sm uppercase text-black dark:text-white line-clamp-1">
                          {product.nom}
                        </h4>
                        <div className="flex items-center justify-between mt-2">
                          <p className="text-[#39FF14] font-black text-lg">
                            {product.prix_premium.toLocaleString()} F
                          </p>
                          <button
                            onClick={(e) => {
                              e.stopPropagation();
                            ...
                            className="bg-black text-[#39FF14] p-2 rounded-xl hover:bg-[#39FF14] hover:text-black transition-colors shadow-sm"
            ...
            <div className="flex flex-col md:flex-row gap-4 mb-8 items-center">
              <div className="relative flex-1 w-full">
                ...
                <input
                  ...
                  className={`w-full p-4 pl-12 rounded-2xl font-bold text-sm outline-none transition-colors border ${theme === "dark" ? "bg-zinc-900 border-zinc-800 text-white focus:border-[#39FF14]" : "bg-white border-zinc-200 text-black focus:border-black"}`}
                />
              </div>
              <div
                className={`flex gap-3 items-center p-2 px-4 rounded-2xl border w-full md:w-auto ${theme === "dark" ? "bg-zinc-900 border-zinc-800" : "bg-white border-zinc-200"}`}
              >
                ...
                <input
                  ...
                  max="50000"
                  step="1000"
                  value={shopMaxPrice || 50000}
                  onChange={(e) => setShopMaxPrice(Number(e.target.value))}
                  className="w-24 md:w-32 accent-[#39FF14] cursor-pointer"
                />
                <input
                  type="number"
                  placeholder="Max"
                  ...
                  className={`w-20 p-2 rounded-lg text-sm font-bold outline-none text-center ${theme === "dark" ? "bg-zinc-800 text-white" : "bg-zinc-100 text-black"}`}
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <button
                onClick={() => setSelectedShopGoal("all")}
                className={`p-2 rounded-xl border-2 font-black uppercase text-[8px] tracking-widest transition-all ${selectedShopGoal === "all" ? "bg-black text-[#39FF14] border-black" : "bg-white border-zinc-100 text-zinc-400"}`}
              >
                Tous
              </button>
              {SHOP_GOALS.map((goal) => (
                <button
                  key={goal.id}
                  onClick={() => setSelectedShopGoal(goal.id)}
                  className={`p-2 rounded-xl border-2 flex flex-col items-center justify-center gap-1.5 font-black uppercase text-[8px] tracking-widest transition-all ${selectedShopGoal === goal.id ? "bg-black text-[#39FF14] border-black shadow-xl" : "bg-white border-zinc-100 text-zinc-400"}`}
                >
              ...
              {(Array.isArray(shopDataDB) ? shopDataDB : [])
                ...
                .filter((p) => {
                  const matchSearch =
                    ...
                    p.nom
                      ?.toLowerCase()
                      .includes(shopSearchQuery.toLowerCase());
                  const matchMin =
                    shopMinPrice === "" || p.prix_standard >= shopMinPrice;
                  const matchMax =
                    shopMaxPrice === "" || p.prix_standard <= shopMaxPrice;
                  const matchGoal =
                    selectedShopGoal === "all" ||
                    (selectedShopGoal === "saved"
                      ? savedShopProducts.some((sp: any) => sp.id === p.id)
                      : p.goal === selectedShopGoal);
                  return matchSearch && matchMin && matchMax && matchGoal;
                })
                .map((product, index) => (
                  <div
                    key={product.id}
                    className={`${theme === "dark" ? "bg-zinc-900 border-zinc-800" : "bg-white border-zinc-100"} border rounded-3xl p-4 flex flex-col hover:border-[#39FF14] transition-all hover:shadow-2xl group animate-in fade-in zoom-in-95 slide-in-from-bottom-4 duration-700`}
                    style={{
                      animationFillMode: "both",
                  ...
                  >
                    <div
                      className="relative aspect-square rounded-2xl bg-zinc-50 overflow-hidden mb-4 cursor-pointer"
                      onClick={() => openProductModal(product)}
                    >
                      <img
                        src={
                          product.image_url ||
                          "https://placehold.co/400x400/111/39FF14?text=Produit"
                        }
                        alt={product.nom}
                      ...
                      />
                      {product.badge && (
                        <span className="absolute top-2 right-2 bg-black text-[#39FF14] px-2 py-1 rounded-full text-[8px] sm:text-[10px] font-black uppercase tracking-widest shadow-xl">
                          {product.badge}
                        </span>
                      )}
                      {product.stock <= 10 && (
                        <span className="absolute top-2 left-2 bg-red-600 text-white px-2 py-1 rounded-full text-[8px] sm:text-[10px] font-black uppercase tracking-widest shadow-xl animate-pulse">
                          Qté Limitée
                        </span>
                      )}
                    </div>
                    <h4 className="font-black text-xs sm:text-sm uppercase text-black mb-2 line-clamp-2 leading-tight">
                      {product.nom}
                    </h4>
                    ...
                    <div className="flex flex-col gap-1 mb-4 mt-auto">
                      <p className="text-zinc-400 text-sm font-bold line-through">
                        {product.prix_standard.toLocaleString()} F
                      </p>
                      <p className="text-sm sm:text-lg font-black text-[#39FF14] bg-black px-3 py-1 rounded-lg w-max italic">
                        {product.prix_premium.toLocaleString()} F
                      </p>
                    </div>
                    <div className="flex gap-2">
                      <button
                        ...
                        className="flex-1 bg-black text-white hover:bg-[#39FF14] hover:text-black py-2.5 rounded-xl font-black uppercase text-[9px] sm:text-[10px] tracking-widest transition-all flex items-center justify-center gap-1.5 shadow-sm"
                      >
                      ...
                      <button
                        ...
                        className={`p-2.5 sm:p-3 rounded-xl border-2 transition-all flex items-center justify-center ${savedShopProducts.some((sp: any) => sp.id === product.id) ? "border-red-500 bg-red-50 text-red-500" : "border-zinc-200 bg-white text-zinc-400 hover:border-red-500 hover:text-red-500"}`}
                      >
                        <Heart
                          size={16}
                          className={
                            savedShopProducts.some(
                              (sp: any) => sp.id === product.id,
                            )
                              ? "fill-current"
                              : ""
                          }
            ...
            <div className="mt-20 pt-12 border-t border-zinc-100">
              <h3
                className={`${spaceGrotesk.className} text-2xl font-black uppercase tracking-tighter mb-8 flex items-center gap-3`}
              >
                <BookOpen className="text-[#39FF14]" /> Nos Conseils Bien-être
              </h3>
              <div className="grid md:grid-cols-2 gap-8">
                {[
                  {
                    title: "Réussir ses pancakes d'avoine ?",
                    desc: "L'astuce pour une texture parfaite sans farine de blé. Idéal avec notre pâte d'arachide pure.",
                    link: "prod_011",
                  },
                  {
                    title: "Pourquoi le Fonio est indispensable ?",
                    desc: "Découvrez pourquoi cette céréale millénaire est le secret d'un ventre plat durable.",
                    link: "prod_001",
                  },
                ].map((article, idx) => (
                  <div
                    key={idx}
                    className="bg-zinc-950 border border-zinc-800 p-8 rounded-[2.5rem] flex flex-col"
                  >
                    <h4 className="font-black text-lg uppercase mb-3 text-[#39FF14]">
                      {article.title}
                    </h4>
                    <p className="text-sm text-zinc-400 font-medium mb-6 flex-1">
                      {article.desc}
                    </p>
                    <button
                      onClick={() => {
                        setSelectedShopGoal("all");
                        document
                          .getElementById("shop-grid")
                          ?.scrollIntoView({ behavior: "smooth" });
                      }}
                      className="bg-white text-black px-6 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest w-max hover:bg-[#39FF14] transition-colors"
                    >
        ...
        <AnimatePresence>
          {selectedProduct && (
            <div
              id="product-overlay"
              onClick={(e: any) =>
                e.target.id === "product-overlay" && setSelectedProduct(null)
              }
              className="fixed inset-0 z-[150] bg-black/90 backdrop-blur-md flex items-center justify-center p-4 sm:p-6 animate-in fade-in overflow-y-auto"
            >
              <motion.div
                initial={{ scale: 0.9, y: 20 }}
                animate={{ scale: 1, y: 0 }}
                exit={{ scale: 0.9, opacity: 0 }}
                className="bg-white rounded-[2rem] w-full max-w-4xl max-h-[90vh] overflow-y-auto custom-scrollbar flex flex-col md:flex-row relative shadow-2xl my-auto"
              >
                <button
                  onClick={() => setSelectedProduct(null)}
                  className="absolute top-6 right-6 p-2 bg-zinc-100 rounded-full hover:bg-black hover:text-white transition z-20"
                >
                  <X size={20} />
                </button>
                <div className="w-full md:w-1/2 bg-zinc-50 flex flex-col items-center justify-center p-6 relative shrink-0 min-h-[300px]">
                  {productMediaView === "image" ||
                  !selectedProduct.video_url ? (
                    <div className="relative w-full h-full flex items-center justify-center group/mainimg">
                      <img
                        src={productActiveImage || selectedProduct.image_url}
                        alt={selectedProduct.nom}
                        className="max-w-full h-auto max-h-[60vh] object-contain drop-shadow-2xl rounded-2xl"
                      />
                          ...
                          <button
                            onClick={(e) => {
                              ...
                              const currentIndex = images.indexOf(
                                productActiveImage || selectedProduct.image_url,
                              );
                              const prevIndex =
                            ...
                            className="absolute left-2 top-1/2 -translate-y-1/2 bg-black/50 text-white p-2 rounded-full hover:bg-black transition-colors opacity-0 group-hover/mainimg:opacity-100"
                          >
                            <ChevronLeft size={20} />
                          </button>
                          <button
                            ...
                            className="absolute right-2 top-1/2 -translate-y-1/2 bg-black/50 text-white p-2 rounded-full hover:bg-black transition-colors opacity-0 group-hover/mainimg:opacity-100"
                          >
                  ...
                  {(selectedProduct.gallery?.length > 0 ||
                    ...
                    <div className="flex gap-2 mt-4 overflow-x-auto custom-scrollbar w-full pb-2">
                      <button
                        onClick={() => {
                          setProductMediaView("image");
                          setProductActiveImage(selectedProduct.image_url);
                        }}
                        className={`w-16 h-16 rounded-xl border-2 shrink-0 ${productMediaView === "image" && (productActiveImage === selectedProduct.image_url || !productActiveImage) ? "border-[#39FF14]" : "border-transparent"}`}
                      >
                        <img
                          src={
                            selectedProduct.image_url ||
                          ...
                          className="w-full h-full object-cover rounded-lg bg-zinc-200"
                          onError={(e: any) =>
                            (e.target.src =
                              "https://placehold.co/400x400/111/39FF14?text=Produit")
                          }
                      ...
                      {selectedProduct.gallery?.map(
                        (img: string, idx: number) => (
                          <button
                            ...
                            onClick={() => {
                              setProductMediaView("image");
                              setProductActiveImage(img);
                            }}
                            className={`w-16 h-16 rounded-xl border-2 shrink-0 ${productMediaView === "image" && productActiveImage === img ? "border-[#39FF14]" : "border-transparent"}`}
                          >
                            <img
                              src={img}
                              className="w-full h-full object-cover rounded-lg bg-zinc-200"
                      ...
                      {selectedProduct.video_url && (
                        <button
                          onClick={() => setProductMediaView("video")}
                          className={`w-16 h-16 rounded-xl border-2 shrink-0 flex items-center justify-center bg-zinc-200 transition-colors ${productMediaView === "video" ? "border-[#39FF14]" : "border-transparent hover:bg-zinc-300"}`}
                        >
                ...
                <div className="w-full md:w-1/2 p-6 md:p-10 flex flex-col text-black shrink-0">
                  <span className="bg-black text-[#39FF14] px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest mb-6 w-max">
                    Zoom Produit
                  </span>
                  ...
                  <div className="flex items-center gap-1 mb-4">
                    ...
                    <span className="text-xs font-bold text-zinc-500 ml-2">
                      ({selectedProduct.rating || 5}/5) -{" "}
                      {selectedProduct.views || 0} vues
                    </span>
                  </div>
                  <p className="text-zinc-500 font-medium leading-relaxed mb-8">
                    {selectedProduct.description_longue}
                  </p>
                  <div className="space-y-3 mb-10">
                    ...
                    <div className="flex items-center gap-3 text-sm font-bold">
                      <CheckCircle size={18} className="text-[#39FF14]" /> 🇸🇳
                      Fabrication locale : Coopératives de femmes.
                    </div>
                    <div className="flex items-center gap-3 text-sm font-bold">
                      <CheckCircle size={18} className="text-[#39FF14]" /> 📦
                      Livraison rapide : Dakar en 24h.
                    </div>
                  </div>
                  <div className="mt-auto pt-8 border-t border-zinc-100 flex flex-col gap-6">
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
                      <div>
                        ...
                        <p className="text-4xl font-black text-black">
                          {selectedProduct.prix_premium.toLocaleString()} F
                        </p>
                      </div>
                      <div className="flex flex-col gap-2 w-full sm:w-auto">
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="flex-1 bg-[#39FF14] text-black px-6 py-4 rounded-2xl font-black uppercase text-[10px] tracking-widest shadow-xl hover:scale-105 transition-transform flex items-center justify-center gap-2"
                          >
                            <Plus size={18} /> Ajouter au panier
                          </button>
                          <button
                            onClick={() => handleShareProduct(selectedProduct)}
                            className="bg-zinc-100 text-black p-4 rounded-2xl hover:bg-zinc-200 transition-colors shadow-sm shrink-0"
                          >
                            <Share2 size={18} />
                          </button>
                        </div>
                        <div className="flex gap-2">
                          <button
                            ...
                            className="flex-1 bg-black text-white px-4 py-3 rounded-2xl font-black uppercase text-[10px] tracking-widest shadow-xl hover:scale-105 transition-transform flex items-center justify-center gap-2"
                          >
                            <ShoppingCart size={16} /> Mon panier
                          </button>
                          <button
                            onClick={() => setSelectedProduct(null)}
                            className="flex-1 bg-zinc-100 text-black px-4 py-3 rounded-2xl font-black uppercase text-[10px] tracking-widest shadow-sm hover:bg-zinc-200 transition-colors flex items-center justify-center"
                          >
                            Continuer
                          </button>
                        </div>
                    ...
                    {(() => {
                      const similarShopProducts = (
                        Array.isArray(shopDataDB) ? shopDataDB : []
                      )
                        .flatMap((cat) => cat.produits || [])
                        .filter(
                          (p: any) =>
                            p.categorie_nom === selectedProduct.categorie_nom &&
                          ...
                          <div className="pt-6 border-t border-zinc-100">
                            ...
                            <div className="flex gap-4 overflow-x-auto pb-2 custom-scrollbar">
                              {similarShopProducts.map((simProd: any) => (
                                <div
                                  key={simProd.id}
                                  onClick={() => setSelectedProduct(simProd)}
                                  className="flex items-center gap-3 bg-zinc-50 p-2 rounded-xl border border-zinc-100 cursor-pointer hover:border-[#39FF14] transition-colors shrink-0 w-64"
                                >
                                  <img
                                    src={
                                      simProd.image_url ||
                                  ...
                                  <div className="flex-1 min-w-0">
                                    <p className="font-bold text-xs truncate text-black">
                                      {simProd.nom}
                                    </p>
                                    <p className="text-[#39FF14] font-black text-xs mt-0.5">
                                      {simProd.prix_premium.toLocaleString()} F
                                    </p>
                                  </div>
                                </div>
                              ))}
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-right-4 w-full">
            ...
            <div className="bg-white p-8 rounded-[2rem] border border-zinc-200 shadow-sm">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-zinc-50 p-6 rounded-2xl border border-zinc-100">
                  <h3 className="text-sm font-black uppercase text-zinc-500 mb-6 flex items-center gap-2">
                    <Flame size={16} /> Calories Consommées
                  </h3>
                  <div className="flex items-end justify-between h-40 gap-2">
                    {Array.from({ length: 7 }, (_, i) => {
                      const d = new Date();
                      ...
                      const heightPct =
                        count > 0 ? Math.min((count / target) * 100, 100) : 0;
                      return (
                        <div
                          key={i}
                          className="flex flex-col items-center flex-1 h-full justify-end group"
                        >
                          <div
                            className={`w-full max-w-[30px] rounded-t-lg transition-all duration-500 relative ${count > target ? "bg-red-500 group-hover:bg-red-400" : "bg-orange-500 group-hover:bg-orange-400"}`}
                            style={{
                              height: `${heightPct}%`,
                              minHeight: "4px",
                            }}
            ...
            <div className="bg-white p-8 rounded-[2rem] border border-zinc-200 shadow-sm">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
                <h2
                  className={`${spaceGrotesk.className} text-2xl md:text-4xl font-black uppercase tracking-tighter text-black flex items-center gap-4`}
                >
                  <img
                    src={MENU_ICONS.dashboard}
                    className="w-16 h-16 md:w-20 md:h-20 rounded-2xl object-cover shrink-0 shadow-lg"
                ...
                <button
                  ...
                  className="bg-black text-[#39FF14] px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest hover:scale-105 transition-transform shadow-md flex items-center gap-2"
                >
              ...
              <div className="space-y-4">
                {Array.from({ length: 7 }).map((_, idx) => {
                  ...
                  const dateStr = d.toISOString().split("T")[0];
                  const log = (Array.isArray(dailyLogs) ? dailyLogs : []).find(
                  ...
                  if (log && log.report_data) {
                    return (
                      <div
                        key={idx}
                        className="bg-zinc-50 p-5 rounded-2xl border border-zinc-100 flex flex-col md:flex-row md:items-center justify-between gap-4"
                      >
                        <div>
                    ...
                    return (
                      <div
                        key={idx}
                        className="bg-white p-5 rounded-2xl border border-zinc-100 flex flex-col md:flex-row md:items-center justify-between gap-4 opacity-80"
                      >
                        <div>
                          <p className="font-black text-sm text-black mb-1">
                            {d.toLocaleDateString("fr-FR", {
                          ...
                          <div className="flex flex-wrap gap-2 mt-2">
                            <span className="bg-zinc-100 text-zinc-400 px-2 py-1 rounded text-[10px] font-black uppercase">
                              Non suivi
                            </span>
                          </div>
                        </div>
                        <div className="flex items-center justify-between md:justify-end gap-6 text-sm font-bold text-zinc-500 w-full md:w-auto mt-4 md:mt-0">
                          <div className="flex items-center gap-4">
                            <span className="flex items-center gap-1 text-zinc-400">
                              <img
                                src={CALS_ICON}
                                className="w-4 h-4 rounded-full shadow-sm grayscale opacity-50"
                              />{" "}
                              0 kcal
                            </span>
                            <span className="flex items-center gap-1 text-zinc-400">
        ...
        {activeTab === "blog" && selectedArticle && (
          <div className="animate-in fade-in slide-in-from-right-4 w-full">
            <button
              ...
              className="mb-6 flex items-center gap-2 text-zinc-500 hover:text-black dark:text-zinc-400 dark:hover:text-white transition-colors font-bold text-sm bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 px-4 py-2 rounded-xl w-fit shadow-sm hover:shadow-md"
            >
              <ChevronLeft size={16} />
              Retour au blog
            </button>
              ...
              <div className="lg:w-[70%] space-y-8">
                <div className="bg-white dark:bg-zinc-900 rounded-[2.5rem] border border-zinc-200 dark:border-zinc-800 p-6 md:p-10 lg:p-12 shadow-sm space-y-6">
                  <div className="flex items-center gap-3 mb-4">
                    <span className="bg-[#39FF14] text-black px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest">
                      {selectedArticle.category || "Nutrition"}
                    </span>
                    <span className="bg-zinc-100 dark:bg-zinc-800 text-zinc-500 dark:text-zinc-400 px-3 py-1.5 rounded-full text-[10px] font-black uppercase flex items-center gap-1">
                      <Clock size={12} />{" "}
                      {selectedArticle.readTime ||
                        `${Math.max(1, Math.ceil((selectedArticle.content || selectedArticle.desc || "").split(" ").length / 200))} min`}
                    </span>
                    <span className="bg-zinc-100 dark:bg-zinc-800 text-zinc-500 dark:text-zinc-400 px-3 py-1.5 rounded-full text-[10px] font-black uppercase flex items-center gap-1">
                      <Eye size={12} /> {selectedArticle.views_count || 0} vues
                    </span>
                  </div>
                  <h1
                    className={`${spaceGrotesk.className} text-2xl md:text-4xl font-black uppercase text-zinc-900 dark:text-white tracking-tight leading-tight mb-6`}
                  >
                  ...
                  <div className="prose prose-zinc dark:prose-invert max-w-none font-medium text-zinc-600 dark:text-zinc-300 leading-relaxed">
                    {(() => {
                      ...
                      let aiNote = null;
                      const aiNoteMatch =
                        textToRender.match(/\[([^\]]+IA[^\]]+)\]/i) ||
                        textToRender.match(/\[(Généré[^\]]+)\]/i);
                      if (aiNoteMatch) {
                        ...
                        <div className="flex flex-col">
                          {paragraphs.map(
                            (paragraph: string, index: number) => (
                              <p
                                key={index}
                                className="mb-5 text-zinc-700 dark:text-zinc-300 leading-relaxed text-base md:text-lg font-normal"
                ...
                <div className="mt-16 pt-8 border-t border-zinc-100 dark:border-zinc-800">
                  <h3
                    className={`${spaceGrotesk.className} text-2xl font-black uppercase mb-6 text-black dark:text-white`}
                  >
                    Articles{" "}
                    ...
                    {articles
                      ...
                      .map((article: any) => (
                        <div
                          ...
                          className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-[2.5rem] p-6 shadow-sm hover:shadow-xl hover:border-[#39FF14] transition-all cursor-pointer flex flex-col h-full group"
                        >
                          {article.image_url && (
                          ...
                          <div className="flex gap-2 mb-3">
                            <span className="bg-black text-[#39FF14] px-2 py-1 rounded-full text-[9px] font-black uppercase tracking-widest">
                              {article.category || "Nutrition"}
                            </span>
                            <span className="bg-zinc-100 dark:bg-zinc-800 text-zinc-500 dark:text-zinc-400 px-2 py-1 rounded-full text-[9px] font-black uppercase flex items-center gap-1">
                              <Eye size={10} /> {article.views_count || 0}
                            </span>
                          </div>
                          <h4
                            className={`${spaceGrotesk.className} text-sm font-black uppercase mb-2 leading-tight text-black dark:text-white group-hover:text-[#39FF14] transition-colors line-clamp-2`}
                          >
                            {article.title}
                          </h4>
                        </div>
              ...
              <div className="lg:w-[30%] space-y-6">
                ...
                <div className="bg-zinc-50 dark:bg-zinc-900/50 backdrop-blur-xl border border-zinc-200 dark:border-zinc-800 rounded-[2rem] p-6 flex flex-col items-center text-center shadow-sm relative overflow-hidden">
                  ...
                  <img
                    ...
                    alt="Coach Rokhy"
                    className="w-24 h-24 rounded-full border-4 border-white dark:border-zinc-800 shadow-xl object-cover bg-black mb-4 z-10"
                  />
                  <h3
                    className={`${spaceGrotesk.className} text-xl font-black uppercase text-black dark:text-white z-10`}
                  >
                    Coach Rokhy
                  </h3>
                  <span className="text-[#39FF14] text-[10px] font-black uppercase tracking-widest bg-black px-3 py-1 rounded-full mb-4 shadow-md z-10">
                    Experte Nutrition
                  </span>
                  <p className="text-zinc-500 dark:text-zinc-400 text-xs font-medium leading-relaxed z-10">
                    Créatrice de la méthode "Nutrition à l'Africaine". Je vous
                    aide à perdre du poids sans régime restrictif en
                    rééquilibrant vos plats locaux favoris.
                  </p>
                </div>
                ...
                <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-[2rem] p-6 shadow-sm">
                  <h3
                    className={`${spaceGrotesk.className} flex items-center gap-2 text-lg font-black uppercase mb-4 text-black dark:text-white`}
                  >
                    <TrendingUp className="text-[#39FF14]" size={18} /> Top
                    Trending
                  </h3>
                  <div className="space-y-4">
                    {[...articles]
                      ...
                      .map((article: any, idx: number) => (
                        <div
                          key={article.id}
                          onClick={() => handleArticleClick(article)}
                          className="flex items-start gap-4 cursor-pointer group pb-4 border-b border-zinc-100 dark:border-zinc-800 last:border-0 last:pb-0"
                        >
                          <span className="text-3xl font-black text-zinc-200 dark:text-zinc-800 group-hover:text-[#39FF14] transition-colors">
                            0{idx + 1}
                          </span>
                          <div>
                            <h4 className="text-xs font-bold text-black dark:text-white group-hover:text-[#39FF14] transition-colors line-clamp-2 leading-tight mb-1">
                              {article.title}
                            </h4>
                            <p className="text-[10px] font-bold text-zinc-500 flex items-center gap-1">
                              <Eye size={10} /> {article.views_count || 0} vues
                            </p>
                          </div>
                        </div>
                      ))}
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-right-4 w-full">
            ...
            >
              <div className="flex">
                {articles.slice(0, 3).map((article: any) => (
                  <div
                    key={article.id}
                    className="flex-[0_0_100%] min-w-0 relative h-[400px] md:h-[500px] cursor-pointer group"
                    onClick={() => handleArticleClick(article)}
                  >
                    <img
                      src={
                        article.image_url ||
                        "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781444566/supprimer_le_frame__remplace_le_202606141341_ayzsoe.jpg"
                      }
                      alt={article.title}
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent flex flex-col justify-end p-8 md:p-12">
                      <div className="max-w-3xl backdrop-blur-sm bg-black/20 p-6 rounded-[2rem] border border-white/10 relative">
                        <div className="flex items-center gap-3 mb-4">
                          ...
                          <span className="bg-black/50 text-white border border-white/10 px-3 py-1.5 rounded-full text-[10px] font-black uppercase flex items-center gap-1 backdrop-blur-md">
                            <Clock size={12} />{" "}
                            {article.readTime ||
                              `${Math.max(1, Math.ceil((article.content || article.desc || "").split(" ").length / 200))} min`}
                          </span>
                          <span className="bg-black/50 text-white border border-white/10 px-3 py-1.5 rounded-full text-[10px] font-black uppercase flex items-center gap-1 backdrop-blur-md">
                            <Eye size={12} /> {article.views_count || 0} vues
                          </span>
                        </div>
                        <h2
                          className={`${spaceGrotesk.className} text-3xl md:text-5xl font-black uppercase text-white mb-4 leading-tight group-hover:text-[#39FF14] transition-colors`}
                        >
                          {article.title}
                        </h2>
                        <p className="text-zinc-300 text-sm md:text-base font-medium line-clamp-2 mb-6 max-w-2xl">
                          {article.desc}
                        </p>
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            <img
                              src="https://i.ibb.co/N6FwP9jD/LOGO-ONYX.png"
                              alt={article.author_name || "Coach Rokhy"}
                              className="w-10 h-10 rounded-full border-2 border-white/20 object-cover bg-black"
                            />
                            <div>
                              <p className="text-white text-xs font-bold uppercase tracking-widest">
                                {article.author_name || "Coach Rokhy"}
                              </p>
                              <p className="text-[#39FF14] text-[9px] font-black uppercase">
                                Expert Nutrition
                              </p>
                            </div>
                          </div>
                ...
                {articles.length === 0 && (
                  <div className="flex-[0_0_100%] min-w-0 h-[400px] flex items-center justify-center bg-zinc-900 text-zinc-500 font-bold">
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center justify-between bg-white dark:bg-zinc-900 p-4 rounded-[2rem] border border-zinc-200 dark:border-zinc-800 shadow-sm">
              <div className="flex items-center gap-2 overflow-x-auto w-full custom-scrollbar pb-2 md:pb-0">
                {["Tous", "Nutrition", "Santé", "Astuces", "Témoignages"].map(
                  (cat) => (
                    <button
                      key={cat}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {articles
                .filter(
                  (a: any) =>
                    blogCategory === "Tous" || a.category === blogCategory,
                )
                .filter(
                  (a: any) =>
                    blogSearch === "" ||
                ...
                .map((article: any) => (
                  ...
                  >
                    ...
                    <div className="flex gap-2 mb-4">
                      <span className="bg-black text-[#39FF14] px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest">
                        {article.category || "Nutrition"}
                      </span>
                      <span className="bg-zinc-100 dark:bg-zinc-800 text-zinc-500 dark:text-zinc-400 px-3 py-1 rounded-full text-[10px] font-black uppercase flex items-center gap-1">
                        <Clock size={10} />{" "}
                        {article.readTime ||
                          `${Math.max(1, Math.ceil((article.content || article.desc || "").split(" ").length / 200))} min`}
                      </span>
                    ...
                    <h2
                      className={`${spaceGrotesk.className} text-xl font-black uppercase mb-3 leading-tight text-black dark:text-white group-hover:text-[#39FF14] transition-colors`}
                    >
                      {article.title}
                    </h2>
                    <p className="text-zinc-500 text-xs font-medium mb-6 flex-1 line-clamp-3">
                      {article.desc}
                    </p>
                    <div className="flex items-center justify-between mt-auto pt-4 border-t border-zinc-100 dark:border-zinc-800">
                      <div className="flex items-center gap-2">
                        <img
                          src="https://i.ibb.co/N6FwP9jD/LOGO-ONYX.png"
                          alt={article.author_name || "Coach Rokhy"}
                          className="w-6 h-6 rounded-full border border-zinc-200 dark:border-zinc-700 object-cover bg-black"
                        />
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-right-4 w-full h-full min-h-[70vh] flex flex-col max-w-4xl mx-auto bg-zinc-50 rounded-[2.5rem] border border-zinc-200 overflow-hidden shadow-sm relative">
            <div className="bg-white px-6 py-4 border-b border-zinc-200 flex items-center justify-between sticky top-0 z-20 shrink-0">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="font-black text-black uppercase tracking-tighter flex items-center gap-2">
                    Coach Rokhy{" "}
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6 flex flex-col custom-scrollbar">
              ...
              <div className="flex items-end gap-3 w-full md:w-3/4">
                ...
                <div className="bg-white border border-zinc-200 p-4 rounded-2xl rounded-bl-sm shadow-sm">
                  <p className="text-sm font-medium text-black">
                    Salut ! C&apos;est Coach Rokhy. Comment se passe ta semaine
              ...
              {coachingChatStep > 0 && (
                <div
                  className="flex items-end gap-3 w-full md:w-3/4 animate-in fade-in slide-in-from-bottom-2"
                ...
                >
                  ...
                  <div className="bg-white border border-zinc-200 p-4 rounded-2xl rounded-bl-sm shadow-sm">
                    {coachingChatStep === 1 && (
                      <>
                        <p className="text-sm font-medium text-black mb-4">
                          La stagnation est normale, ne lâche rien ! As-tu pensé
                          à remplacer ton riz brisé par du Fonio cette semaine
                          pour relancer la machine sans te priver ?
                        </p>
                        <button
                          onClick={() => handleTabChange("shop")}
                          className="bg-[#39FF14] text-black px-6 py-3 rounded-xl font-black text-xs uppercase tracking-widest hover:scale-105 transition-transform shadow-md w-full sm:w-auto flex items-center justify-center gap-2"
                        >
                          🛒 Découvrir le Fonio
                        </button>
                      </>
                    ...
                    {coachingChatStep === 2 && (
                      <>
                        <p className="text-sm font-medium text-black mb-4">
                          Zéro culpabilité ! L&apos;important c&apos;est le
                          prochain repas. Fais-toi une petite infusion de
                          Kinkéliba ou de Bissap sans sucre ce soir pour aider
                          la digestion.
                        </p>
                        <button
                          onClick={() => handleTabChange("today")}
                          className="bg-black text-[#39FF14] px-6 py-3 rounded-xl font-black text-xs uppercase tracking-widest hover:scale-105 transition-transform shadow-md w-full sm:w-auto flex items-center justify-center gap-2"
                        >
                          💪 Reprendre mon menu
                        </button>
                      </>
                    ...
                    {coachingChatStep === 3 && (
                      <>
                        <p className="text-sm font-medium text-black mb-4">
                          Pas de souci, chaque métabolisme est unique.
                          Discutons-en directement de vive voix pour adapter ton
                          programme.
                        </p>
                        <button
                          onClick={() =>
                            window.open("https://wa.me/221785338417", "_blank")
                          }
                          className="bg-[#25D366] text-white px-6 py-4 rounded-2xl font-black text-xs md:text-sm uppercase tracking-widest hover:scale-105 transition-transform shadow-lg w-full flex items-center justify-center gap-2"
                        >
            ...
            <div className="bg-white p-4 border-t border-zinc-200 shrink-0">
              {coachingChatStep === 0 ? (
                <div className="flex flex-wrap gap-2 justify-center">
                  <button
                    onClick={() => setCoachingChatStep(1)}
                    className="bg-zinc-100 hover:bg-zinc-200 border border-zinc-200 text-black px-4 py-3 rounded-full text-xs font-bold transition-colors"
                  >
                    Je stagne un peu...
                  </button>
                  <button
                    onClick={() => setCoachingChatStep(2)}
                    className="bg-zinc-100 hover:bg-zinc-200 border border-zinc-200 text-black px-4 py-3 rounded-full text-xs font-bold transition-colors"
                  >
                    J&apos;ai fait un gros écart !
                  </button>
                  <button
                    onClick={() => setCoachingChatStep(3)}
                    className="bg-zinc-100 hover:bg-zinc-200 border border-zinc-200 text-black px-4 py-3 rounded-full text-xs font-bold transition-colors"
                  >
                    J&apos;ai une question spécifique.
                  </button>
                ...
                <div className="flex justify-center">
                  <button
                    onClick={() => setCoachingChatStep(0)}
                    className="text-zinc-400 hover:text-black text-[10px] font-black uppercase tracking-widest flex items-center gap-2 transition-colors"
                  >
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-right-4 w-full max-w-7xl mx-auto">
            ...
            <div className="relative rounded-[2.5rem] p-6 md:p-8 border border-zinc-200 shadow-sm overflow-hidden min-h-[70vh] flex flex-col justify-between">
              ...
              <div className="absolute inset-0 z-0 hidden md:block">
                <img
                  src="https://res.cloudinary.com/dtr2wtoty/image/upload/v1783280413/Woman_standing_on_scale_smiling_202607051938_e6h39p.jpg"
                  alt="Background"
              ...
              <div className="absolute inset-0 z-0 block md:hidden">
                <img
                  src="https://res.cloudinary.com/dtr2wtoty/image/upload/v1783280897/weight_gfpje9.jpg"
                  alt="Background"
                  className="w-full h-full object-cover opacity-10"
                />
              </div>
              ...
              <div className="relative z-10 w-full mb-6">
                <button
                  onClick={() => handleTabChange("dashboard")}
                  className="flex items-center gap-2 text-zinc-500 hover:text-black font-black uppercase text-[10px] tracking-widest mb-4"
                >
                  <ChevronLeft size={16} /> Retour à l&apos;accueil
                </button>
                <h2 className="text-2xl font-black uppercase tracking-tighter flex items-center gap-2 text-black">
                  <img
                    src="https://res.cloudinary.com/dtr2wtoty/image/upload/v1781458367/A_cute__highly_detailed_3D_202606141732_kn3ujk.jpg"
                    alt="Balance 3D"
                    className="w-8 h-8 rounded-full object-cover mix-blend-multiply"
                  />
                  Mon Poids
                </h2>
              </div>
              ...
              <div className="relative z-10 grid grid-cols-1 md:grid-cols-12 gap-6 w-full flex-grow">
                ...
                <div className="col-span-12 lg:col-span-4 bg-white/80 backdrop-blur-md rounded-3xl p-6 shadow-sm border border-white flex flex-col min-h-[300px] justify-between">
                  ...
                  <div className="flex-grow flex flex-col gap-3 overflow-y-auto custom-scrollbar">
                    <div className="flex items-start gap-3 bg-zinc-50/80 p-3 rounded-2xl">
                      <img
                        src="https://res.cloudinary.com/dtr2wtoty/image/upload/v1786107893/Ceramic_plate_with_herbs_on_202608071304_bl72q1.jpg"
                        alt="Aïssatou K."
                        className="w-10 h-10 rounded-full object-cover shadow-sm border border-white"
                      />
                      <div className="bg-[#39FF14] text-black text-xs font-bold p-3 rounded-2xl rounded-tl-sm shadow-sm relative flex flex-col gap-1 w-full">
                        <span className="absolute -left-2 top-0 text-[10px] bg-yellow-400 w-4 h-4 rounded-full flex items-center justify-center shadow-sm">
                          1
                        </span>
                        <span>Aïssatou K.</span>
                    ...
                    <div className="flex items-start gap-3 bg-zinc-50/80 p-3 rounded-2xl flex-row-reverse">
                      <img
                        ...
                        className="w-10 h-10 rounded-full object-cover shadow-sm border border-white"
                      />
                      <div className="bg-[#39FF14] text-black text-xs font-bold p-3 rounded-2xl rounded-tr-sm shadow-sm relative flex flex-col items-end gap-1 w-full">
                        <span className="absolute -right-2 top-0 text-[10px] bg-zinc-300 w-4 h-4 rounded-full flex items-center justify-center shadow-sm">
                          2
                        </span>
                        <span>Penda D.</span>
                        <span className="text-[10px] font-normal opacity-80">
                    ...
                    <div className="flex items-start gap-3 bg-zinc-50/80 p-3 rounded-2xl">
                      <img
                        ...
                        className="w-10 h-10 rounded-full object-cover shadow-sm border border-white"
                      />
                      <div className="bg-white border border-zinc-100 text-black text-xs font-bold p-3 rounded-2xl rounded-tl-sm shadow-sm relative flex flex-col gap-1 w-full">
                        <span className="absolute -left-2 top-0 text-[10px] bg-amber-600 text-white w-4 h-4 rounded-full flex items-center justify-center shadow-sm">
                          3
                        </span>
                        <span>Amadou T.</span>
                        <span className="text-[10px] font-normal opacity-80">
                  ...
                  <button
                    onClick={() => handleTabChange("community")}
                    className="w-full mt-4 bg-[#39FF14] hover:bg-[#32e612] text-black font-black uppercase text-xs py-3 rounded-xl transition-colors shadow-sm tracking-widest"
                  >
                    Voir la communauté
                  </button>
                </div>
                ...
                <div
                  className="col-span-12 md:col-span-6 lg:col-span-3 bg-white/80 backdrop-blur-md rounded-3xl p-6 shadow-sm border border-white flex flex-col justify-between relative overflow-hidden cursor-pointer"
                  onClick={() => setShowWeightModal(true)}
                >
                  <h3 className="text-sm font-black text-black mb-6">
                  ...
                  <div className="flex justify-between items-center mb-6">
                    ...
                    <div className="flex flex-col gap-2">
                      <button
                        ...
                        className="w-10 h-10 rounded-xl bg-red-100 hover:bg-red-200 text-red-500 flex items-center justify-center font-black text-xl transition-colors shadow-sm"
                      >
                        +
                      </button>
                      <button
                        ...
                        className="w-10 h-10 rounded-xl bg-green-100/50 hover:bg-green-100 text-red-400 flex items-center justify-center font-black text-xl transition-colors shadow-sm"
                      >
                        -
                      </button>
                    </div>
                  ...
                  <div className="flex justify-between items-end border-t border-zinc-100 pt-4">
                    ...
                    <div className="flex flex-col items-center gap-2">
                      ...
                      {weightLogs.length > 0 &&
                      parseFloat(weightLogs[weightLogs.length - 1].weight) <=
                        parseFloat(
                          clientProfile?.diagnostic_data?.targetWeight || "0",
                        ) ? (
                        <span className="text-xl" title="Objectif Atteint">
                          😎
                        </span>
                      ) : (
                        <span className="text-xl" title="En cours">
                          🤨
                        </span>
                      )}
                    </div>
                  ...
                  <div className="space-y-3 flex-grow overflow-y-auto max-h-[220px] custom-scrollbar pr-2">
                    {weightLogs.length > 0 ? (
                      [...weightLogs].reverse().map((log, idx, arr) => {
                        const hM =
                          (clientProfile?.diagnostic_data?.height || 170) / 100;
                        ...
                        let diff = 0;
                        if (prevLog)
                          diff = currentW - parseFloat(prevLog.weight);

                        return (
                          <div
                            key={log.log_date}
                            className="bg-zinc-100/80 p-3 sm:p-4 rounded-2xl flex justify-between items-center group hover:bg-zinc-200 transition-colors"
                          >
                            <div className="flex items-center gap-2">
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <button
                                onClick={() => handleDeleteWeight(log.log_date)}
                ...
                <div className="col-span-12 md:col-span-6 lg:col-span-3 bg-white/80 backdrop-blur-md rounded-3xl p-4 shadow-sm border border-white flex flex-col h-[280px]">
                  <h3 className="text-sm font-black text-black mb-3 px-2">
                    Recettes
                  </h3>
                  <div className="relative flex-grow rounded-2xl overflow-hidden mb-3">
                    <img
                      src="https://res.cloudinary.com/dtr2wtoty/image/upload/v1783286332/IMG-20250820-WA0117_iegikb.jpg"
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-3">
                      <p className="text-white text-xs font-bold leading-tight">
                        {trackingMode === "guided"
                          ? "Recette de votre plan"
                          : "Recette minceur recommandée"}
                      </p>
                    </div>
                  </div>
                  <button
                    onClick={() => handleTabChange("favorites")}
                    className="w-full bg-white border border-zinc-200 hover:bg-zinc-50 text-black font-black uppercase text-[10px] py-2.5 rounded-xl transition-colors shadow-sm tracking-widest"
                  >
                    Voir Recettes
                  </button>
                </div>
                ...
                <div className="col-span-12 md:col-span-6 lg:col-span-3 bg-white/80 backdrop-blur-md rounded-3xl p-4 shadow-sm border border-white flex flex-col h-[280px]">
                  ...
                  <div
                    className="relative flex-grow rounded-2xl overflow-hidden group cursor-pointer"
                    onClick={() => handleTabChange("fitness")}
                  >
                    <img
                      src="https://res.cloudinary.com/dtr2wtoty/image/upload/v1783286277/Woman_wearing_workout_clothes_2K_202607052117_cn1ehb.jpg"
                      alt="Fitness"
                      className="w-full h-full object-cover transition-transform group-hover:scale-105"
                    />
                    <div className="absolute inset-x-3 bottom-3">
                      <button className="w-full bg-[#39FF14] hover:bg-[#32e612] text-black font-black uppercase text-[10px] py-2.5 rounded-xl transition-colors shadow-md tracking-widest">
                        Démarrer Séance
                      </button>
                    </div>
                  </div>
              ...
              <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in">
                <div className="bg-white rounded-3xl p-6 md:p-8 w-full max-w-sm shadow-2xl relative">
                  <button
                    ...
                    className="absolute top-4 right-4 text-zinc-400 hover:text-black bg-zinc-100 p-2 rounded-full transition-colors"
                  >
                    <X size={16} />
                  </button>
                  <div className="flex flex-col items-center mb-6">
                    ...
                    <h3 className="text-xl font-black uppercase text-center">
                      Nouveau Poids
                    </h3>
                    <p className="text-xs font-bold text-zinc-500 mt-1">
                      Quelle est votre pesée du jour ?
                    </p>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full py-4 bg-black text-[#39FF14] rounded-2xl font-black uppercase text-sm tracking-widest hover:scale-105 transition-transform shadow-lg flex justify-center items-center gap-2"
                  >
        ...
        {activeTab === "fitness" && (
          <div className="space-y-6 animate-in fade-in slide-in-from-right-4 w-full max-w-7xl mx-auto">
            <button
              onClick={() => handleTabChange("dashboard")}
              className="flex items-center gap-2 text-zinc-500 hover:text-black font-black uppercase text-[10px] tracking-widest mb-2"
            >
              <ChevronLeft size={16} /> Retour à l&apos;accueil
            </button>
            <ClientFitnessView
        ...
        {activeTab === "community" && (
          <div className="space-y-6 animate-in fade-in slide-in-from-right-4 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
              <h2
                className={`${spaceGrotesk.className} text-2xl md:text-4xl font-black uppercase tracking-tighter text-black flex items-center gap-3`}
              >
                <Heart
                  className="text-[#39FF14] bg-black p-2 rounded-xl"
                  size={40}
                />{" "}
                Club des Lekkologues
              </h2>
              <div className="flex items-center gap-3 w-full md:w-auto">
                <div className="flex items-center bg-white border border-zinc-200 rounded-full px-4 py-2 flex-1 md:w-64 shadow-sm">
                  ...
                  <input
                    ...
                    className="bg-transparent border-none text-xs text-black outline-none w-full ml-2 placeholder:text-zinc-400"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-4 overflow-x-auto pb-4 pt-2 scrollbar-none mb-4 relative z-10">
              ...
              >
                ...
                <span className="text-xs font-poppins text-center mt-1 truncate w-16 text-zinc-600 font-medium">
                  Ajouter
                </span>
                <input
                  type="file"
              ...
              {groupedStories.map((group, idx) => (
                ...
                >
                  <div
                    className={`w-16 h-16 rounded-full p-0.5 relative transition-transform hover:scale-105 ${group.allViewed ? "border-2 border-zinc-300 dark:border-zinc-700" : "border-[3px] border-[#39FF14] shadow-md shadow-[#39FF14]/30"}`}
                  >
                    <img
                      src={
                        group.client.avatar_url ||
                        `https://ui-avatars.com/api/?name=${encodeURIComponent(group.client.full_name || "Membre")}&background=random`
                      }
                      className="w-full h-full rounded-full object-cover border-2 border-white dark:border-zinc-950 pointer-events-none"
                      alt={group.client.full_name}
                    />
                  </div>
                  <span className="text-xs font-poppins text-center mt-1 truncate w-16 text-zinc-800 font-medium">
                    {group.client.full_name?.split(" ")[0]}
                  </span>
                </div>
              ))}
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <div className="hidden lg:flex lg:col-span-3 flex-col gap-6">
                ...
                <div className="bg-white border border-zinc-200 rounded-[2rem] overflow-hidden shadow-sm relative mb-6">
                  <div className="h-24 bg-zinc-800 w-full relative">
                    {clientProfile?.cover_url ? (
                      ...
                      <div className="absolute inset-0 bg-gradient-to-r from-black to-zinc-800">
                  ...
                  <div className="px-6 pb-6 relative flex flex-col items-center">
                    <img
                      ...
                      className="w-16 h-16 rounded-full border-4 border-white shadow-md -mt-8 mb-3 bg-zinc-100 object-cover"
                      alt="Moi"
                    />
                    <div className="bg-black text-[#39FF14] px-3 py-1 rounded-full text-[8px] font-black uppercase tracking-widest shadow-sm absolute top-4 left-4">
                      Lekkologue Pro
                    </div>
                    ...
                    <p className="text-xs text-zinc-500 font-poppins mt-1 line-clamp-2 text-center">
                      {clientProfile?.bio ||
                        "Ajoutez une bio dans vos réglages..."}
                    </p>

                    <div className="grid grid-cols-2 w-full gap-4 text-center border-t border-zinc-100 pt-4 mb-2 mt-4">
                      <div
                        onClick={openLeaderboard}
                        className="cursor-pointer hover:bg-zinc-50 rounded-xl p-1 transition-colors"
                      >
                ...
                <div className="bg-white border border-zinc-200 rounded-[2rem] p-6 shadow-sm">
                  ...
                  <div className="space-y-4">
                    {["Coach Rokhy", "Dr. Thierno", "Amina Fall"].map(
                      (name, i) => (
                        <div
                          key={i}
                          className="flex items-center justify-between cursor-pointer hover:bg-zinc-50 p-2 -mx-2 rounded-xl transition-colors group"
                        >
                          <div className="flex items-center gap-3">
                            <img
                              ...
                              alt={name}
                            />
                            <p className="text-xs font-bold text-black group-hover:text-[#39FF14] transition-colors">
                              {name}
                            </p>
                          </div>
                          <Heart
                ...
                <div className="bg-white border border-zinc-200 rounded-[2rem] p-6 shadow-sm">
                  ...
                  <div className="space-y-4">
                    {["Sophie Diop", "Marietou Sall", "Ndeye Ndiaye"].map(
                      (name, i) => (
                        <div
                          key={i}
                          className="flex items-center justify-between cursor-pointer hover:bg-zinc-50 p-2 -mx-2 rounded-xl transition-colors group"
                        >
                          <div className="flex items-center gap-3">
                            <img
                              src={`https://ui-avatars.com/api/?name=${encodeURIComponent(name)}&background=random`}
                              className="w-8 h-8 rounded-full border border-zinc-200 grayscale group-hover:grayscale-0 transition-all"
                              alt={name}
                            />
                            <p className="text-xs font-bold text-black group-hover:text-[#39FF14] transition-colors">
                              {name}
                          ...
                          <button className="text-[10px] font-black text-zinc-400 hover:text-black">
                            Suivre
                          </button>
                        </div>
                      ),
              ...
              <div className="col-span-1 lg:col-span-6 space-y-6">
                ...
                <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-6 rounded-[2rem] shadow-sm focus-within:border-[#39FF14]/50 transition-colors">
                  ...
                  {postMode === "normal" && (newPostImage || newPostVideo) && (
                    <div className="relative w-full aspect-[4/3] mb-4 rounded-2xl overflow-hidden border border-zinc-200 bg-black">
                      ...
                      <button
                        ...
                        className="absolute top-2 right-2 p-2 bg-black/50 text-white rounded-full hover:bg-red-500 z-10"
                      >
                        <X size={14} />
                      </button>
                    </div>
                  ...
                  <div className="flex items-start gap-4">
                    {postMode === "normal" && (
                      <img
                        ...
                        className="w-10 h-10 rounded-full border border-zinc-200 object-cover mt-1"
                        alt="Moi"
                      />
                    )}
                    <div
                      className={`flex-1 relative transition-all ${postMode === "text_only" ? `h-64 rounded-2xl ${TEXT_BACKGROUNDS[textBgIndex]} bg-cover bg-center p-6 flex flex-col justify-center items-center` : ""}`}
                    >
                      <textarea
                        value={newPostText}
                        onChange={(e) => {
                        ...
                        placeholder={
                          postMode === "text_only"
                            ? "Exprimez-vous..."
                            : "Partagez votre repas, un défi, ou une vidéo..."
                        }
                      ...
                      {postMode === "text_only" && (
                        <>
                          <div className="absolute bottom-4 right-4 text-white/50 text-xs font-black tracking-widest">
                            NXA
                          </div>
                          <div className="absolute top-4 right-4 text-white/80 text-xs font-bold">
                  ...
                  {(locationName || taggedFriends.length > 0) &&
                    postMode === "normal" && (
                      <div className="flex flex-wrap gap-2 mt-3 ml-14">
                        {locationName && (
                          <span className="text-[10px] bg-zinc-100 dark:bg-zinc-800 px-2 py-1 rounded-md text-zinc-600 dark:text-zinc-300 font-bold flex items-center gap-1">
                            <Compass size={12} /> {locationName}
                          </span>
                        )}
                        {taggedFriends.map((f, i) => (
                          <span
                            key={i}
                            className="text-[10px] bg-blue-50 dark:bg-blue-900/30 px-2 py-1 rounded-md text-blue-600 dark:text-blue-400 font-bold"
                          >
                            @{f}
                          </span>
                        ))}
                  ...
                  <div className="flex justify-between items-center mt-4 pt-4 border-t border-zinc-100 dark:border-zinc-800">
                      ...
                      {postMode === "normal" ? (
                        ...
                        <div className="flex gap-2 overflow-x-auto max-w-[200px] scrollbar-none">
                          <button
                            ...
                            className="w-8 h-8 rounded-full bg-zinc-200 flex items-center justify-center text-zinc-500 shrink-0 hover:bg-zinc-300"
                          >
                            <X size={14} />
                          </button>
                          {TEXT_BACKGROUNDS.map((bg, idx) => (
                            <button
                              ...
                              className={`w-8 h-8 rounded-full shrink-0 ${bg} bg-cover border-2 ${textBgIndex === idx ? "border-black" : "border-transparent"}`}
                            ></button>
                          ))}
                        </div>
                      )}
                    ...
                    <button
                      ...
                      className="bg-black text-[#39FF14] px-8 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest hover:scale-105 transition-transform shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      Publier
                    </button>
                  </div>
                ...
                {showSavedOnly && (
                  <div className="flex items-center justify-between bg-zinc-100 dark:bg-zinc-800 p-4 rounded-xl border border-zinc-200 dark:border-zinc-700">
                    <span className="text-xs font-black uppercase tracking-widest text-zinc-600 dark:text-zinc-300 flex items-center gap-2">
                ...
                <div className="space-y-6">
                  ...
                  communityPosts.length > 0 ? (
                    communityPosts
                      .filter((p) => (showSavedOnly ? p._bookmarkedByMe : true))
                      .map((post, idx) => (
                        <div
                          key={post.id || idx}
                          className="bg-white border border-zinc-200 rounded-[2rem] p-6 shadow-sm flex flex-col group"
                        >
                          <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center gap-3">
                              {post.clients?.avatar_url &&
                              !post.clients.avatar_url.includes(
                                "ui-avatars",
                              ) ? (
                                <img
                                  src={post.clients.avatar_url}
                                  alt={post.client}
                                  className="w-12 h-12 rounded-full border border-zinc-200 object-cover shadow-inner"
                                />
                              ) : (
                                <div className="w-12 h-12 bg-black text-[#39FF14] rounded-full flex items-center justify-center font-black text-xl shadow-inner">
                                  {post.client?.charAt(0) || "M"}
                                </div>
                              )}
                              <div>
                                <div className="flex items-center gap-2">
                                  <p className="font-black text-sm text-black flex items-center gap-1">
                                    {post.client || "Membre"}{" "}
                                    <CheckCircle
                                      size={12}
                                      className="text-[#39FF14] fill-[#39FF14] text-black"
                                    />
                                  </p>
                                  {post.client_id &&
                                    ...
                                    (followedUsers.includes(post.client_id) ? (
                                      ...
                                      <button
                                        onClick={() =>
                                          handleFollowUser(post.client_id)
                                        }
                                        className="text-[10px] bg-zinc-100 dark:bg-zinc-800 text-[#39FF14] px-2 py-0.5 rounded-full font-poppins-bold hover:bg-[#39FF14] hover:text-black transition-all shadow-sm"
                                      >
                                        + Suivre
                                      </button>
                                    ))}
                                    ...
                                    post.client_id !== clientProfile?.id && (
                                      <div className="flex items-center gap-2 ml-2">
                                        <button
                                          ...
                                          onClick={() =>
                                            alert(
                                              "La messagerie privée arrive bientôt !",
                                            )
                                          }
                                        >
                                          <MessageSquare size={14} />
                                        </button>
                                        {post.clients?.nutrition_profiles?.[0]
                                          ?.diagnostic_data?.instagram && (
                                          <a
                                            href={`https://instagram.com/${post.clients.nutrition_profiles[0].diagnostic_data.instagram.replace("@", "")}`}
                                            target="_blank"
                                            rel="noopener noreferrer"
                                        ...
                                        {post.clients?.nutrition_profiles?.[0]
                                          ?.diagnostic_data?.facebook && (
                                          <a
                                            href={`https://facebook.com/${post.clients.nutrition_profiles[0].diagnostic_data.facebook.replace("/", "")}`}
                                            target="_blank"
                                            rel="noopener noreferrer"
                                        ...
                                        {post.clients?.nutrition_profiles?.[0]
                                          ?.diagnostic_data?.twitter && (
                                          <a
                                            href={`https://twitter.com/${post.clients.nutrition_profiles[0].diagnostic_data.twitter.replace("@", "")}`}
                                            target="_blank"
                                            rel="noopener noreferrer"
                            ...
                            <div className="relative">
                              <MoreHorizontal
                                ...
                                size={18}
                                className="text-zinc-400 cursor-pointer hover:text-black transition-colors"
                              />
                              {activeMenuPostId === post.id && (
                                <div className="absolute top-6 right-0 z-30 shadow-lg bg-white dark:bg-zinc-800 rounded-xl p-2 min-w-[150px] border border-zinc-100 dark:border-zinc-700 animate-in fade-in slide-in-from-top-2">
                                  {post.client_id === clientProfile?.id ? (
                                    <button
                                      ...
                                      className="w-full flex items-center gap-2 text-left text-xs font-bold text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 p-2 rounded-lg transition-colors"
                                    >
                                      <Trash2 size={14} /> Supprimer le post
                                    </button>
                                  ) : (
                                    <button className="w-full flex items-center gap-2 text-left text-xs font-bold text-zinc-600 dark:text-zinc-300 hover:bg-zinc-50 dark:hover:bg-zinc-700 p-2 rounded-lg transition-colors">
                          ...
                          {post.is_repost && (
                            <div className="mb-3 text-[10px] text-zinc-500 font-black uppercase tracking-widest flex items-center gap-1">
                              <RefreshCcw size={12} /> Repartagé de{" "}
                              {post.original_author || "un Membre"}
                            </div>
                          )}
                          ...
                          {(post.location_name ||
                            ...
                            <div className="flex flex-wrap gap-2 mb-3">
                              {post.location_name && (
                                <span className="text-[10px] bg-zinc-100 dark:bg-zinc-800 px-2 py-1 rounded-md text-zinc-600 dark:text-zinc-300 font-bold flex items-center gap-1">
                                  <Compass size={12} /> {post.location_name}
                                </span>
                              )}
                              {post.tagged_friends?.map(
                                (f: string, i: number) => (
                                  <span
                                    key={i}
                                    className="text-[10px] bg-blue-50 dark:bg-blue-900/30 px-2 py-1 rounded-md text-blue-600 dark:text-blue-400 font-bold"
                          ...
                          {post.media_type === "text_only" ? (
                            <div
                              className={`w-full h-64 rounded-2xl ${TEXT_BACKGROUNDS[post.text_bg_index || 0]} bg-cover bg-center p-6 flex flex-col justify-center items-center relative mb-4`}
                            >
                              <p className="text-center text-white text-2xl font-black">
                                {post.content || post.texte}
                              </p>
                              <div className="absolute bottom-4 right-4 text-white/50 text-xs font-black tracking-widest">
                                NXA
                              </div>
                            ...
                            <>
                              <p className="text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-4 whitespace-pre-wrap leading-relaxed">
                                {post.content || post.texte}
                              </p>
                              ...
                              {post.image_url &&
                                post.media_type !== "video" && (
                                  <div
                                    className="w-full aspect-[4/3] rounded-2xl overflow-hidden mb-4 border border-zinc-100 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 relative cursor-pointer"
                                    onClick={() =>
                          ...
                          <div className="flex items-center justify-between pt-4 border-t border-zinc-100 relative">
                                ...
                                {activeReactionPostId === post.id && (
                                  <div className="absolute bottom-10 left-0 bg-white dark:bg-zinc-800 shadow-lg rounded-full p-2 flex gap-3 z-20 border border-zinc-100 dark:border-zinc-700 animate-in slide-in-from-bottom-2 fade-in">
                                    ...
                                    <button
                                      onClick={(e) => {
                                        e.stopPropagation();
                                        handleLikePost(post.id, "Contane");
                                      }}
                                      className="hover:scale-125 transition-transform"
                                      title="Contane"
                                    >
                            ...
                            <div className="flex items-center gap-4">
                              ...
                              <button
                                ...
                                className={`transition-colors ${post._bookmarkedByMe ? "text-[#39FF14]" : "text-zinc-400 hover:text-black"}`}
                                title="Sauvegarder"
                              >
                                <Bookmark
                                  size={18}
                                  className={
                                    post._bookmarkedByMe ? "fill-[#39FF14]" : ""
                                  }
                                />
                              </button>
                            </div>
              ...
              <div className="hidden lg:flex lg:col-span-3 flex-col gap-6">
                ...
                <div className="bg-white border border-zinc-200 dark:bg-zinc-900 dark:border-zinc-800 rounded-[2rem] p-6 shadow-sm flex-1 flex flex-col max-h-96">
                  <div className="flex justify-between items-center mb-6">
                    ...
                    <button className="text-[10px] font-black text-[#39FF14] uppercase tracking-widest hover:text-black dark:hover:text-white transition-colors">
                      See All
                    </button>
                  </div>
                      ...
                      notifications.map((notif: any) => (
                        ...
                        >
                          {notif.clients ? (
                            <img
                              src={
                                notif.clients.avatar_url ||
                                `https://ui-avatars.com/api/?name=${encodeURIComponent(notif.clients.full_name || "U")}&background=random`
                              }
                              className="w-8 h-8 rounded-full border border-zinc-200 object-cover shrink-0"
                              alt="Actor"
                            />
                          ) : (
                          ...
                          <div className="flex-1">
                            <p className="text-[10px] font-medium text-zinc-800 dark:text-zinc-200 leading-tight">
                              <span className="font-bold text-black dark:text-white">
                                {notif.clients?.full_name || "Système"}
                              </span>{" "}
                              {notif.message}
                            </p>
                          ...
                          {!notif.is_read && (
                            <div className="w-2 h-2 rounded-full bg-[#39FF14] shrink-0 mt-2"></div>
                          )}
                        </div>
                      ))
                    ) : (
        ...
        {showLeaderboard && (
          <div
            id="modal-overlay"
            onClick={(e: any) =>
              e.target.id === "modal-overlay" && setShowLeaderboard(false)
            }
          ...
          >
            <div className="bg-white p-8 rounded-[3rem] max-w-2xl w-full relative shadow-[0_0_50px_rgba(57,255,20,0.15)] border-t-[8px] border-yellow-400 animate-in zoom-in-95 my-auto max-h-[90vh] flex flex-col overflow-hidden">
              <button
                ...
                className="absolute top-6 right-6 p-3 bg-zinc-100 rounded-full hover:bg-black hover:text-[#39FF14] transition-all text-zinc-500 z-[60]"
              >
                <X size={20} />
              </button>
              <div className="text-center mb-8 shrink-0">
                ...
                <h3
                  className={`${spaceGrotesk.className} text-3xl font-black uppercase text-black tracking-tighter`}
                >
                  Classement Jongoma XP
                </h3>
                <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest mt-1">
                  Les membres les plus assidues de ce mois
                </p>
              </div>
                ...
                <div className="flex items-end justify-center gap-4 mb-10 pt-4">
                  {leaderboardData.length > 1 && (
                    <div className="flex flex-col items-center animate-in slide-in-from-bottom-8 duration-700 delay-100">
                      ...
                      <p className="text-[10px] font-black uppercase mt-2 text-zinc-600 truncate max-w-[70px]">
                  ...
                  {leaderboardData.length > 0 && (
                    <div className="flex flex-col items-center animate-in slide-in-from-bottom-8 duration-700">
                      ...
                      <div className="bg-yellow-50 w-24 h-32 rounded-t-xl flex flex-col items-center justify-start pt-2 border-t-4 border-yellow-400">
                        <span className="text-xs font-black mt-1 text-yellow-600">
                          {leaderboardData[0].xp} XP
                        </span>
                      </div>
                      <p className="text-[11px] font-black uppercase mt-2 text-yellow-600 truncate max-w-[80px]">
                  ...
                  {leaderboardData.length > 2 && (
                    <div className="flex flex-col items-center animate-in slide-in-from-bottom-8 duration-700 delay-200">
                      ...
                      <div className="bg-orange-50 w-20 h-20 rounded-t-xl flex flex-col items-center justify-start pt-2 border-t-4 border-orange-400">
                        <span className="text-[10px] font-bold mt-1 text-orange-600">
                          {leaderboardData[2].xp} XP
                        </span>
                      </div>
                      <p className="text-[10px] font-black uppercase mt-2 text-orange-500 truncate max-w-[70px]">
                ...
                <div className="space-y-2">
                  {(Array.isArray(leaderboardData) ? leaderboardData : [])
                    ...
                    .map((student, idx) => (
                      <div
                        key={student.id || idx}
                        className={`flex items-center justify-between p-3 rounded-xl border ${student.id === clientProfile?.id ? "bg-[#39FF14]/10 border-[#39FF14]/50" : "bg-zinc-50 border-zinc-100"}`}
                      >
                        <div className="flex items-center gap-3">
                          ...
                          >
                            {student.full_name}{" "}
                            {student.id === clientProfile?.id ? "(Vous)" : ""}
                          </p>
                        </div>
                        <span className="font-black text-zinc-600 text-xs">
                          {student.xp} XP
                        </span>
                      </div>
                    ))}
              ...
              <div className="pt-6 border-t border-zinc-100 shrink-0">
                <button
                  onClick={() =>
                    window.open(
                      `https://wa.me/?text=${encodeURIComponent("Salut ! Je te mets au défi de me battre sur le classement Jongoma XP de OnyxNutrition ! Rejoins-moi et voyons qui aura le plus de points cette semaine 🔥💪\n\nhttps://onyxlinks.com/nutrition")}`,
                      "_blank",
                    )
                  }
                  className="w-full bg-[#25D366] text-white py-4 rounded-[1.5rem] font-black uppercase text-xs hover:scale-105 transition-all shadow-xl flex justify-center items-center gap-2"
                >
        ...
        {showDailyReport && (
          <div
            id="daily-report-overlay"
            onClick={(e: any) =>
              e.target.id === "daily-report-overlay" &&
              setShowDailyReport(false)
            }
            className="fixed inset-0 z-[600] flex items-center justify-center p-4 sm:p-6 bg-black/90 backdrop-blur-md animate-in fade-in duration-300"
          >
            <div className="bg-white p-6 sm:p-8 rounded-[2rem] max-w-md w-full relative shadow-[0_0_50px_rgba(57,255,20,0.3)] border-t-[8px] border-[#39FF14] animate-in zoom-in-95 max-h-[90vh] flex flex-col overflow-hidden">
              <button
                ...
                className="absolute top-4 right-4 sm:top-6 sm:right-6 p-2 bg-zinc-100 rounded-full hover:bg-black hover:text-[#39FF14] transition-all z-50"
              >
                <X size={20} />
              </button>
              ...
              <div className="text-center mb-6 mt-2">
                <div className="w-16 h-16 bg-[#39FF14]/20 rounded-full flex items-center justify-center mx-auto mb-4">
                  <CheckCircle
                    size={32}
                    className="text-[#39FF14] drop-shadow-md"
                  />
                </div>
                <h2
                  className={`${spaceGrotesk.className} text-2xl font-black uppercase text-black tracking-tighter`}
                >
                  Bilan du Jour
                </h2>
                <p className="text-xs font-bold text-zinc-500 mt-2">
                  Cochez les affirmations vraies pour clôturer votre journée.
                </p>
              </div>
              ...
              <div className="space-y-4 flex-1 overflow-y-auto custom-scrollbar pr-2 pb-4">
                ...
                <label className="flex items-center gap-4 p-4 rounded-2xl border-2 transition-all cursor-pointer group hover:bg-zinc-50 border-zinc-200">
                  <div
                    className={`w-6 h-6 rounded-md flex items-center justify-center border-2 transition-colors shrink-0 ${reportData.followedMenu ? "bg-[#39FF14] border-[#39FF14]" : "bg-white border-zinc-300 group-hover:border-black"}`}
                  >
                    {reportData.followedMenu && (
                  ...
                  <input
                    type="checkbox"
                    className="hidden"
                    checked={reportData.followedMenu}
                    onChange={(e) =>
                      setReportData({
                        ...reportData,
                        followedMenu: e.target.checked,
                      })
                    }
                  />
                  <span className="text-sm font-black text-black">
                    J'AI RESPECTÉ 80% DU MENU
                  </span>
                </label>
                ...
                <label className="flex items-center gap-4 p-4 rounded-2xl border-2 transition-all cursor-pointer group hover:bg-zinc-50 border-zinc-200">
                  <div
                    className={`w-6 h-6 rounded-md flex items-center justify-center border-2 transition-colors shrink-0 ${reportData.drankWater ? "bg-[#39FF14] border-[#39FF14]" : "bg-white border-zinc-300 group-hover:border-black"}`}
                  >
                    {reportData.drankWater && (
                      <Check size={14} className="text-black font-bold" />
                    )}
                  </div>
                  <input
                    type="checkbox"
                    className="hidden"
                    checked={reportData.drankWater}
                    onChange={(e) =>
                      setReportData({
                        ...reportData,
                        drankWater: e.target.checked,
                      })
                    }
                  />
                  <span className="text-sm font-black text-black">
                    J'AI BU MON OBJECTIF D'EAU
                  </span>
                </label>
                ...
                <label className="flex items-center gap-4 p-4 rounded-2xl border-2 transition-all cursor-pointer group hover:bg-zinc-50 border-zinc-200">
                  <div
                    className={`w-6 h-6 rounded-md flex items-center justify-center border-2 transition-colors shrink-0 ${reportData.cravedRice ? "bg-[#39FF14] border-[#39FF14]" : "bg-white border-zinc-300 group-hover:border-black"}`}
                  >
                    {reportData.cravedRice && (
                      <Check size={14} className="text-black font-bold" />
                    )}
                  </div>
                  <input
                    type="checkbox"
                    className="hidden"
                    checked={reportData.cravedRice}
                    onChange={(e) =>
                      setReportData({
                        ...reportData,
                        cravedRice: e.target.checked,
                      })
                    }
                  />
                  <span className="text-sm font-black text-black">
                    J'AI FAIT UN ÉCART DE SUCRE
                  </span>
                </label>
              </div>
              ...
              <div className="mt-4 pt-4 border-t border-zinc-100 shrink-0">
                <button
                  ...
                  className="w-full bg-black text-[#39FF14] py-4 rounded-2xl font-black uppercase text-xs tracking-widest hover:scale-[1.02] transition-transform shadow-xl flex items-center justify-center gap-2 disabled:opacity-50"
                >
                  {isSubmittingReport ? (
                    <Loader2 size={18} className="animate-spin" />
                  ) : (
          ...
          >
            <div className="bg-white p-8 rounded-[2rem] max-w-sm w-full relative shadow-[0_0_50px_rgba(57,255,20,0.3)] border-t-[8px] border-[#39FF14] animate-in zoom-in-95 flex flex-col items-center text-center">
              <button
                ...
                className="absolute top-4 right-4 p-2 bg-zinc-100 rounded-full hover:bg-black hover:text-[#39FF14] transition-all"
              >
                <X size={20} />
              </button>
              ...
              <h3 className="text-2xl font-black uppercase text-black mb-2 tracking-tighter">
                Minute !
              </h3>
              <p className="text-sm font-bold text-zinc-500 mb-8">
                Tu n'as pas encore rempli ton bilan aujourd'hui. Prends 30
                secondes pour le faire et sécuriser tes XP !
              </p>
        ...
        {showRedoDiagModal && (
          <div
            id="modal-overlay"
            onClick={(e: any) =>
              e.target.id === "modal-overlay" && setShowRedoDiagModal(false)
            }
            className="fixed inset-0 z-[600] flex items-center justify-center p-4 sm:p-6 bg-black/90 backdrop-blur-md animate-in fade-in duration-300"
          >
            <div className="bg-white p-6 sm:p-8 rounded-[2rem] max-w-md w-full relative shadow-[0_0_50px_rgba(57,255,20,0.3)] border-t-[8px] border-[#39FF14] animate-in zoom-in-95 max-h-[90vh] flex flex-col overflow-hidden">
              <button
                onClick={() => setShowRedoDiagModal(false)}
                className="absolute top-4 right-4 sm:top-6 sm:right-6 p-2 bg-zinc-100 rounded-full hover:bg-black hover:text-[#39FF14] transition-all z-50"
              >
                <X size={20} />
              </button>
              ...
              <div className="overflow-y-auto custom-scrollbar flex-1 pb-4 pr-2 mt-4 sm:mt-0">
                <div className="flex items-center gap-4 mb-6 border-b border-zinc-100 pb-6">
                  <div className="relative">
                    <img
                      src="https://res.cloudinary.com/dtr2wtoty/image/upload/v1781176401/A_portrait_of_the_character_202606111113_jfaetc.jpg"
                      alt="Rokhy"
                      className="w-16 h-16 rounded-full border-2 border-[#39FF14]"
                    />
                ...
                <p className="text-sm font-bold text-zinc-700 mb-6 leading-relaxed">
                  Salut ! Je vois que tu souhaites refaire ton bilan. Avant de
                  continuer, dis-moi pourquoi ?
                </p>

                <div className="space-y-3 mb-6">
                  {[
                    "Je stagne dans ma perte de poids",
                    "J'ai atteint mon objectif !",
                    "Mes mensurations ont changé",
                    "Je veux tester un autre mode",
                  ].map((reason) => (
                    <button
                      key={reason}
                      onClick={() => setRedoReason(reason)}
                      className={`w-full text-left p-4 rounded-xl border-2 font-bold text-xs transition-all ${redoReason === reason ? "bg-black text-[#39FF14] border-black shadow-md" : "bg-zinc-50 border-zinc-200 hover:border-black"}`}
                    >
                      {reason}
                    </button>
                  ))}
                ...
                {redoReason && (
                  <div className="bg-orange-50 border border-orange-200 p-4 rounded-xl mb-6 animate-in fade-in slide-in-from-top-2">
                    <p className="text-[10px] font-black uppercase text-orange-600 tracking-widest flex items-center gap-2 mb-1">
                      <AlertTriangle size={14} /> Attention
                    </p>
                    <p className="text-xs font-medium text-orange-800 leading-relaxed">
                      Refaire le diagnostic va{" "}
                      <strong>réinitialiser ton plan actuel</strong> et
                      recalculer tes objectifs caloriques. Es-tu sûre de vouloir
                      continuer ?
                    </p>
                  </div>
                )}
              ...
              <div className="flex gap-3">
                <button
                  onClick={() => setShowRedoDiagModal(false)}
                  className="flex-1 bg-zinc-100 text-black py-4 rounded-2xl font-black uppercase text-[10px] tracking-widest hover:bg-zinc-200 transition-all shadow-sm"
                >
                  Retour au Hub
                </button>
                <button
        ...
        {diagStep > 0 && (
          <div
            id="diag-modal-overlay"
            onClick={(e: any) =>
              e.target.id === "diag-modal-overlay" && setDiagStep(0)
            }
            className="fixed inset-0 z-[600] flex items-center justify-center p-4 sm:p-6 bg-black/90 backdrop-blur-md animate-in fade-in duration-200"
          >
            <div className="w-full max-w-2xl bg-white border border-zinc-200 rounded-[2rem] shadow-2xl flex flex-col relative animate-in zoom-in-95 text-black max-h-[90vh] overflow-hidden">
              <button
                ...
                className="absolute top-4 right-4 sm:top-6 sm:right-6 p-2 bg-white/20 text-white rounded-full hover:bg-black hover:text-[#39FF14] transition z-50"
              >
                <X size={20} />
              </button>
              ...
              <div className="bg-black text-white p-6 sm:p-8 text-center relative rounded-t-[2rem] shrink-0">
                <div className="absolute top-0 left-0 w-full h-1 bg-zinc-800">
                  <div
                    ...
                    style={{ width: `${(diagStep / 4) * 100}%` }}
                  ></div>
                </div>
                <Activity className="text-[#39FF14] mx-auto mb-2" size={28} />
                <h2
                  className={`${spaceGrotesk.className} text-xl md:text-3xl font-black uppercase tracking-tighter`}
                >
                  {diagStep === 5
                    ? "Nouveau Plan Prêt !"
                    : "Bilan Nutritionnel"}
                ...
                {diagStep !== 8 ? (
                  <form onSubmit={handleDiagSubmit} className="w-full">
                    ...
                    {diagStep === 1 && (
                      <div className="flex flex-col items-center text-center animate-in slide-in-from-right-8 w-full max-w-lg mx-auto">
                        <h2 className="text-2xl md:text-3xl font-black uppercase mb-8 text-black">
                          Étape 1 : Sexe & Âge
                        </h2>
                        ...
                        <div className="w-full mb-6 text-left">
                          ...
                          <div className="grid grid-cols-2 gap-4 w-full mb-8">
                            {[
                              {
                                id: "Homme",
                                img: "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781174715/redimensionner_format_1_1_en_202606111044_rjknkg.jpg",
                              },
                              {
                                id: "Femme",
                                img: "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781174715/redimensionner_1_1_en_gardant_202606111043_unmonc.jpg",
                              },
                            ].map((option) => (
                              <div
                                key={option.id}
                                ...
                                className={`cursor-pointer border-4 rounded-[2rem] overflow-hidden relative transition-all duration-300 ${diagData.gender === option.id ? "border-[#39FF14] shadow-[0_0_30px_rgba(57,255,20,0.3)] scale-105" : "border-transparent bg-white shadow-sm hover:shadow-xl hover:scale-105"}`}
                              >
                                <img
                                  src={option.img}
                                  alt={option.id}
                                ...
                                />
                                <div className="absolute bottom-0 w-full bg-black/80 text-white py-4 font-black uppercase tracking-widest text-sm text-center backdrop-blur-md">
                                  {option.id}
                                </div>
                              </div>
                            ))}
                        ...
                        <div className="w-full text-left">
                          ...
                          <input
                            ...
                            value={diagData.age}
                            onChange={(e) =>
                              setDiagData({ ...diagData, age: e.target.value })
                            }
                            className="w-full p-4 bg-zinc-50 border-2 border-zinc-200 rounded-xl font-bold text-center text-xl outline-none focus:border-[#39FF14] transition-colors text-black"
                          />
                        </div>
                      </div>
                    )}
                            ...
                            {[
                              {
                                ...
                                img: "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781544253/A_high-end_commercial_photorealistic_full-body_202606151657_cfq5fb.jpg",
                                desc: "Déficit calorique",
                              },
                              {
                                id: "maintien",
                                label: "Maintien du poids",
                                img: "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781542708/A_high-end_commercial_photorealistic_portrait_202606151658_noabp9.jpg",
                                desc: "Stabiliser sainement",
                              },
                              {
                                id: "prise_masse",
                                label: "Prise de masse",
                                img: "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781544091/rajoute_le_logo_sur_la_202606151721_aayo61.jpg",
                                desc: "Développer le muscle",
                              },
                            ].map((goal) => (
                              <div
                                key={goal.id}
                                onClick={() =>
                                  setDiagData({ ...diagData, goal: goal.id })
                                }
                                className={`cursor-pointer border-4 rounded-[2rem] overflow-hidden relative transition-all duration-300 flex flex-col ${diagData.goal === goal.id ? "border-[#39FF14] shadow-[0_0_30px_rgba(57,255,20,0.3)] scale-105" : "border-transparent bg-white shadow-sm hover:shadow-xl hover:scale-105"}`}
                              >
                                <img
                                  src={goal.img}
                                  alt={goal.label}
                                ...
                                <div className="flex-1 bg-black/90 text-white p-4 flex flex-col justify-center items-center backdrop-blur-md">
                                  <span className="font-black uppercase tracking-widest text-xs md:text-sm mb-1 text-center">
                                    {goal.label}
                                  </span>
                                  <span className="text-[10px] text-zinc-400 font-bold leading-tight text-center">
                                    {goal.desc}
                                  </span>
                                </div>
                              </div>
                        ...
                        <div className="grid grid-cols-2 gap-4 w-full">
                          ...
                          <div className="text-left">
                            ...
                            <input
                              ...
                              className="w-full p-4 bg-zinc-50 border-2 border-zinc-200 rounded-xl font-bold text-center text-sm outline-none focus:border-[#39FF14] transition-colors text-black"
                            />
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col items-center text-center animate-in slide-in-from-right-8 w-full">
                        ...
                        <div className="w-full mb-6 text-left">
                          <label className="font-bold text-sm uppercase text-zinc-500 mb-2 flex items-center gap-2">
                            <img
                              src="https://res.cloudinary.com/dtr2wtoty/image/upload/v1782675093/3_topvyj.png"
                              className="w-8 h-8"
                            />
                            Combien d'heures de sommeil avez-vous chaque nuit ?
                          </label>
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 w-full">
                            {["Moins de 5h", "6-7h", "8h ou plus"].map(
                              (hours) => (
                                <div
                                  key={hours}
                                  onClick={() =>
                                  ...
                                  className={`cursor-pointer border-2 rounded-xl p-4 py-6 flex flex-col items-center justify-center relative transition-all duration-300 ${diagData.sleepHours === hours ? "border-[#39FF14] bg-[#39FF14]/5 shadow-[0_0_20px_rgba(57,255,20,0.2)]" : "border-zinc-200 bg-white hover:border-zinc-400"}`}
                                >
                                  <span className="font-bold text-black">
                                    {hours}
                                  </span>
                                  {diagData.sleepHours === hours && (
                                    <CheckCircle
                                      size={20}
                                      className="text-[#39FF14] absolute top-2 right-2"
                                    />
                                  )}
                                </div>
                              ),
                        ...
                        <div className="w-full text-left">
                          <label className="font-bold text-sm uppercase text-zinc-500 mb-2 flex items-center gap-2">
                            <img
                              src="https://res.cloudinary.com/dtr2wtoty/image/upload/v1782675092/5_olxege.png"
                              className="w-8 h-8"
                            />
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 w-full">
                            {[
                              ...
                              <div
                                ...
                                className={`cursor-pointer border-2 rounded-xl p-4 py-6 flex flex-col items-center justify-center relative transition-all duration-300 ${diagData.dailyCommute === commute ? "border-[#39FF14] bg-[#39FF14]/5 shadow-[0_0_20px_rgba(57,255,20,0.2)]" : "border-zinc-200 bg-white hover:border-zinc-400"}`}
                              >
                                <span className="font-bold text-black text-center text-sm">
                                  {commute}
                                </span>
                                {diagData.dailyCommute === commute && (
                                  <CheckCircle
                                    size={20}
                                    className="text-[#39FF14] absolute top-2 right-2"
                                  />
                    ...
                    {diagStep === 4 && (
                      <div className="flex flex-col items-center text-center animate-in slide-in-from-right-8 w-full">
                        ...
                        <div className="w-full mb-6 text-left">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 w-full">
                            {["Diabète", "Hypertension", "Aucun problème"].map(
                              (condition) => {
                                const isSelected =
                                  diagData.healthProfile === condition;
                                return (
                                  <div
                                    key={condition}
                                    onClick={() =>
                                    ...
                                    className={`cursor-pointer border-2 rounded-xl p-4 py-6 flex flex-col items-center justify-center relative transition-all duration-300 ${isSelected ? "border-[#39FF14] bg-[#39FF14]/5 shadow-[0_0_20px_rgba(57,255,20,0.2)]" : "border-zinc-200 bg-white hover:border-zinc-400"}`}
                                  >
                          ...
                          <div className="w-full text-left animate-in fade-in slide-in-from-top-2">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 w-full">
                              {[
                                ...
                                const isSelected =
                                  diagData.femaleSpecific === condition;
                                return (
                                  <div
                                    key={condition}
                                    onClick={() =>
                    ...
                    {diagStep === 5 && (
                      <div className="flex flex-col items-center text-center animate-in slide-in-from-right-8 w-full">
                        ...
                        <div className="w-full mb-6 text-left">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 w-full">
                            {["Moins de 50cl", "1L", "Plus de 1.5L"].map(
                              (vol) => (
                                <div
                                  key={vol}
                                  onClick={() =>
                                  ...
                                  className={`cursor-pointer border-2 rounded-xl p-4 py-6 flex flex-col items-center justify-center relative transition-all duration-300 ${diagData.waterIntake === vol ? "border-[#39FF14] bg-[#39FF14]/5 shadow-[0_0_20px_rgba(57,255,20,0.2)]" : "border-zinc-200 bg-white hover:border-zinc-400"}`}
                                >
                                  <span className="font-bold text-black">
                                    {vol}
                                  </span>
                                  {diagData.waterIntake === vol && (
                                    <CheckCircle
                                      size={20}
                                      className="text-[#39FF14] absolute top-2 right-2"
                                    />
                        ...
                        <div className="w-full mb-6 text-left">
                          <label className="font-bold text-sm uppercase text-zinc-500 mb-2 block">
                            Avez-vous enchaîné les régimes restrictifs par le
                            passé ?
                          </label>
                          <div className="grid grid-cols-2 gap-4 w-full">
                            {["Oui", "Non"].map((ans) => (
                              <div
                                key={ans}
                                onClick={() =>
                                  setDiagData({ ...diagData, pastDiets: ans })
                                }
                                className={`flex-1 cursor-pointer border-2 rounded-xl p-4 py-6 flex flex-col items-center justify-center relative transition-all duration-300 ${diagData.pastDiets === ans ? "border-[#39FF14] bg-[#39FF14]/5 shadow-[0_0_20px_rgba(57,255,20,0.2)]" : "border-zinc-200 bg-white hover:border-zinc-400"}`}
                              >
                                <span className="font-bold text-black text-lg">
                                  {ans}
                                </span>
                                {diagData.pastDiets === ans && (
                                  <CheckCircle
                                    size={20}
                                    className="text-[#39FF14] absolute top-2 right-2"
                                  />
                        ...
                        <div className="w-full text-left">
                          <label className="font-bold text-sm uppercase text-zinc-500 mb-2 flex items-center gap-2">
                            <img
                              src="https://res.cloudinary.com/dtr2wtoty/image/upload/v1782675094/4_uk6ui2.png"
                              className="w-8 h-8"
                            />
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full">
                            {[
                              "Huile de palme/Arachide",
                              "Huile d'olive/Tournesol",
                              "Beurre/Karité",
                              "Je cuisine sans huile",
                            ].map((fat) => (
                              <div
                                key={fat}
                                onClick={() => {
                                  const fats = diagData.cookingFats.includes(
                                    fat,
                                  )
                                    ? diagData.cookingFats.filter(
                                        (f) => f !== fat,
                                      )
                                    : [...diagData.cookingFats, fat];
                                  setDiagData({
                                    ...diagData,
                                    cookingFats: fats,
                                  });
                              ...
                              >
                                <div
                                  className={`w-5 h-5 rounded flex-shrink-0 flex items-center justify-center border-2 ${diagData.cookingFats.includes(fat) ? "bg-[#39FF14] border-[#39FF14]" : "border-zinc-300"}`}
                                >
                                  {diagData.cookingFats.includes(fat) && (
                                    <CheckCircle
                                      size={14}
                                      className="text-black"
                                    />
                                ...
                                <span className="font-bold text-black text-xs sm:text-sm leading-tight">
                                  {fat}
                                </span>
                              </div>
                            ))}
                    ...
                    {diagStep === 6 && (
                      <div className="flex flex-col items-center text-center animate-in slide-in-from-right-8 w-full">
                        <h2 className="text-2xl md:text-3xl font-black uppercase mb-8 text-black">
                          Étape 6 : Rythme Africain
                        </h2>

                        <div className="w-full mb-6 text-left">
                          <label className="font-bold text-sm uppercase text-zinc-500 mb-2 flex items-center gap-2">
                            <img
                              src="https://res.cloudinary.com/dtr2wtoty/image/upload/v1782675091/sauce_gmyero.png"
                              className="w-8 h-8"
                            />
                            ...
                            {[
                              ...
                              <div
                                ...
                                onClick={() =>
                                  setDiagData({
                                    ...diagData,
                                    mainMealElement: element,
                                  })
                                }
                                className={`cursor-pointer border-2 rounded-xl p-4 py-6 flex flex-col items-center justify-center relative transition-all duration-300 ${diagData.mainMealElement === element ? "border-[#39FF14] bg-[#39FF14]/5 shadow-[0_0_20px_rgba(57,255,20,0.2)]" : "border-zinc-200 bg-white hover:border-zinc-400"}`}
                              >
                                <span className="font-bold text-black text-center text-sm">
                                  {element}
                                </span>
                                {diagData.mainMealElement === element && (
                                  <CheckCircle
                                    size={20}
                                    className="text-[#39FF14] absolute top-2 right-2"
                                  />
                        ...
                        <div className="w-full text-left">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 w-full">
                            {["Très copieux", "Léger", "Je grignote"].map(
                              (meal) => (
                                <div
                                  key={meal}
                                  onClick={() =>
                                  ...
                                  className={`cursor-pointer border-2 rounded-xl p-4 py-6 flex flex-col items-center justify-center relative transition-all duration-300 ${diagData.eveningMeal === meal ? "border-[#39FF14] bg-[#39FF14]/5 shadow-[0_0_20px_rgba(57,255,20,0.2)]" : "border-zinc-200 bg-white hover:border-zinc-400"}`}
                                >
                                  <span className="font-bold text-black text-center text-sm">
                                    {meal}
                                  </span>
                                  {diagData.eveningMeal === meal && (
                                    <CheckCircle
                                      size={20}
                                      className="text-[#39FF14] absolute top-2 right-2"
                                    />
                    ...
                    {diagStep === 7 && (
                      <div className="flex flex-col items-center text-center animate-in slide-in-from-right-8 w-full">
                        <h2 className="text-2xl md:text-3xl font-black uppercase mb-8 text-black">
                          Étape 7 : Pratique Familiale
                        </h2>
                        <div className="space-y-10 w-full max-w-2xl">
                          {/* GRILLE 1 : DÉJEUNER */}
                          <div>
                            <h3 className="text-xl font-black uppercase mb-4 text-black text-left">
                              Comment déjeunez-vous le midi ?
                            </h3>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                              {[
                                {
                                  id: "En solo au bureau",
                                  img: "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781631228/La_Gamelle_ywfy3t.jpg",
                                  desc: "Avec ma gamelle / Tupperware",
                                },
                                {
                                  id: "À la maison",
                                  img: "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781631228/Le_Bol_Commun_hb9fns.jpg",
                                  desc: "Autour du grand bol familial",
                                },
                              ].map((habit) => (
                                <div
                                  key={habit.id}
                                  ...
                                  className={`cursor-pointer border-4 rounded-[2rem] overflow-hidden relative transition-all flex flex-col ${diagData.lunchHabit === habit.id ? "border-[#39FF14] scale-105" : "border-transparent bg-white shadow-sm hover:scale-105"}`}
                                >
                                  <img
                                    src={habit.img}
                                  ...
                                  <div className="flex-1 bg-black/90 text-white p-4 flex flex-col justify-center items-center">
                                    <span className="font-black uppercase text-sm mb-1 text-center">
                                      {habit.id}
                                    </span>
                          ...
                          <div>
                            <h3 className="text-xl font-black uppercase mb-4 text-black text-left">
                              Pour qui préparez-vous les repas ?
                            </h3>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                              {[
                                {
                                  id: "Je cuisine uniquement pour moi seule",
                                  img: "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781631228/Je_cuisine_pour_moi_seule_mfo6vw.jpg",
                                },
                                {
                                  id: "Je cuisine la marmite pour toute la famille",
                                  img: "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781631228/Je_cuisine_pour_la_famille_qzlwke.jpg",
                                },
                              ].map((habit) => (
                                <div
                                  key={habit.id}
                                  ...
                                  className={`cursor-pointer border-4 rounded-[2rem] overflow-hidden relative transition-all flex flex-col ${diagData.cookingHabit === habit.id ? "border-[#39FF14] scale-105" : "border-transparent bg-white shadow-sm hover:scale-105"}`}
                                >
                                  <img
                                    src={habit.img}
                                    className="w-full h-40 object-cover"
                          ...
                          <div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                              {[
                                {
                                  id: "Budget Serré",
                                  price: "8 000 F / semaine",
                                  img: "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781630660/A_cute__highly_detailed_3D_202606161723_fcl8jj.jpg",
                                },
                                {
                                  id: "Budget Famille",
                                  price: "15 000 F / semaine",
                                  img: "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781630665/A_cute__highly_detailed_3D_202606161723_1_rx6yry.jpg",
                                },
                                {
                                  id: "Budget Confort",
                                  price: "25 000 F / semaine",
                                  img: "https://res.cloudinary.com/dtr2wtoty/image/upload/v1781630664/A_cute__highly_detailed_3D_202606161723_2_xxku54.jpg",
                                },
                              ].map((budget) => (
                                <div
                                  key={budget.id}
                                  onClick={() =>
                                    setDiagData({
                                      ...diagData,
                                      weeklyBudget: budget.id,
                                    })
                                  }
                                  className={`cursor-pointer border-4 rounded-[2rem] overflow-hidden relative transition-all flex flex-col ${diagData.weeklyBudget === budget.id ? "border-[#39FF14] scale-105" : "border-transparent bg-white shadow-sm hover:scale-105"}`}
                                >
                                  <img
                                    src={budget.img}
                                  ...
                                  <div className="flex-1 bg-black/90 text-white p-3 flex flex-col justify-center items-center">
                                    <span className="font-black uppercase text-[10px] mb-1">
                                      {budget.id}
                                    </span>
                      ...
                      <div className="flex gap-4 pt-6 mt-8 border-t border-zinc-100">
                        {diagStep > 1 && (
                          <button
                            ...
                            className="px-8 py-4 bg-zinc-100 rounded-xl font-bold text-sm text-black hover:bg-zinc-200 transition"
                          >
                            Retour
                          </button>
                        )}
                        <button
                          type="button"
                          onClick={() =>
                            setDiagStep((s) => (s === 7 ? 10 : s + 1))
                          }
                          disabled={
                            (diagStep === 1 &&
                              (!diagData.gender || !diagData.age)) ||
                            (diagStep === 2 &&
                              (!diagData.goal ||
                                !diagData.height ||
                                !diagData.currentWeight ||
                                !diagData.targetWeight ||
                                !diagData.targetDate)) ||
                            (diagStep === 3 &&
                              (!diagData.sleepHours ||
                                !diagData.dailyCommute)) ||
                            (diagStep === 4 &&
                              (!diagData.healthProfile ||
                                (diagData.gender === "Femme" &&
                                  !diagData.femaleSpecific))) ||
                            (diagStep === 5 &&
                              (!diagData.waterIntake ||
                                !diagData.pastDiets ||
                                diagData.cookingFats.length === 0)) ||
                            (diagStep === 6 &&
                              (!diagData.mainMealElement ||
                                !diagData.eveningMeal)) ||
                            (diagStep === 7 &&
                              (!diagData.lunchHabit ||
                                !diagData.cookingHabit ||
                                !diagData.weeklyBudget))
                          }
                    ...
                    {diagStep === 10 && (
                      <div className="flex flex-col items-center text-center animate-in slide-in-from-right-8 w-full bg-white p-6 md:p-8 rounded-[2rem] shadow-xl">
                        {(() => {
                          ...
                          const currentW =
                            parseFloat(diagData.currentWeight) || 0;
                          const targetW =
                            parseFloat(diagData.targetWeight) || 0;
                          const weightToLose = currentW - targetW;
                          ...
                          let imcText = "Normal";
                          if (imcVal < 18.5) {
                            imcBadge = "bg-blue-100 text-blue-600";
                            imcText = "Maigreur";
                          } else if (imcVal >= 25 && imcVal < 30) {
                            imcBadge = "bg-orange-100 text-orange-600";
                            imcText = "Surpoids";
                          } else if (imcVal >= 30) {
                            imcBadge = "bg-red-100 text-red-600";
                            imcText = "Obésité";
                          }
                          ...
                          return (
                            <div className="w-full">
                              <h2 className="text-2xl md:text-3xl font-black uppercase mb-2 text-black">
                                Vos Objectifs Validés
                              </h2>
                              <p className="text-sm font-medium text-zinc-500 mb-8 max-w-lg mx-auto">
                                Voici l'analyse complète de votre profil de
                                départ.
                              </p>
                              ...
                              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                                ...
                                <div className="bg-zinc-50 border border-zinc-200 p-6 rounded-[2rem] flex flex-col items-center justify-between min-h-[220px]">
                                  ...
                                  <div className="text-center mt-2">
                                    ...
                                    <span
                                      className={`inline-block text-[9px] font-black uppercase px-2 py-0.5 rounded-md mt-1 ${imcBadge}`}
                                    >
                                      {imcText}
                                    </span>
                                  </div>
                                ...
                                <div className="bg-zinc-50 border border-zinc-200 p-6 rounded-[2rem] flex flex-col items-center justify-between min-h-[220px]">
                                  ...
                                  <img
                                    src="https://res.cloudinary.com/dtr2wtoty/image/upload/v1781443964/A_cute__highly_detailed_3D_202606141332_ggiubt.jpg"
                                  ...
                                  <div className="text-center">
                                    ...
                                    {profile.hitFloor && (
                                      <span className="text-red-600 font-bold text-[8px] uppercase tracking-wider block mt-1">
                                        Plancher de sécurité activé
                                      </span>
                                    )}
                                  </div>
                                </div>
                                  ...
                                  <div className="text-center">
                                    ...
                                    {weightToLose > 0 && (
                                      <p className="text-[10px] font-bold text-zinc-500 mt-1">
                                        -{weightToLose.toFixed(1)} kg à éliminer
                                      </p>
                                    )}
                                  </div>
                                </div>
                                ...
                                <div className="bg-zinc-50 border border-zinc-200 p-6 rounded-[2rem] flex flex-col items-center justify-between min-h-[220px]">
                                  ...
                                  <img
                                    src="https://res.cloudinary.com/dtr2wtoty/image/upload/v1781535959/A_cute__highly_detailed_3D_202606151505_1_uvgqf0.jpg"
                                    className="w-12 h-12 rounded-full object-cover"
                                    alt="Date"
                                  />
                              ...
                              <button
                                ...
                                className="w-full bg-black text-[#39FF14] py-5 rounded-[1.5rem] font-black uppercase text-sm tracking-widest shadow-xl hover:scale-[1.01] transition-transform"
                              >
                                {isSubmittingDiag
                  ...
                  <div className="text-center py-6 animate-in zoom-in">
                    <h3 className="text-2xl font-black uppercase mb-6 text-black">
                      Votre Espace a été mis à jour !
                    </h3>
                    <p className="text-zinc-600 font-medium mb-8">
                      Les nouveaux menus ont été générés selon vos nouveaux
                      paramètres, vous pouvez reprendre le suivi dès maintenant.
                    </p>
                    ...
                    <div className="flex flex-col gap-3 mt-4">
                      <button
                        onClick={() => setDiagStep(0)}
                        type="button"
                        className="w-full bg-black text-[#39FF14] py-4 rounded-xl font-black uppercase tracking-widest hover:bg-zinc-800 transition-colors shadow-lg flex justify-center items-center gap-2"
                      >
        ...
        {viewerActiveGroupIndex !== null && (
          <div className="fixed inset-0 z-[700] bg-black flex flex-col justify-between animate-in fade-in">
            {(() => {
              const currentGroup = groupedStories[viewerActiveGroupIndex];
              const currentStory =
                currentGroup?.stories[viewerActiveStoryIndex];
                  ...
                  <div className="absolute top-0 left-0 right-0 z-50 p-4 pt-safe bg-gradient-to-b from-black/80 to-transparent">
                    ...
                    <div className="flex gap-1 mb-4">
                      {currentGroup.stories.map((_: any, idx: number) => {
                        ...
                        else if (idx === viewerActiveStoryIndex)
                    ...
                    <div className="flex justify-between items-center">
                      <div className="flex items-center gap-3">
                        <img
                          src={
                            currentGroup.client.avatar_url ||
                            `https://ui-avatars.com/api/?name=${encodeURIComponent(currentGroup.client.full_name || "Membre")}&background=random`
                          }
                  ...
                  <div className="flex-1 w-full h-full relative bg-zinc-950 flex items-center justify-center">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4 z-50 bg-gradient-to-t from-black/80 to-transparent flex items-center gap-3 pb-safe">
                      ...
                      <button
                        ...
                        className="p-3 bg-black/50 border border-white/20 hover:border-red-500 hover:text-red-500 text-white rounded-full transition-colors"
                      >
                        <Heart size={20} />
                      </button>
                    </div>
        ...
        {storyPreviewUrl && (
          <div
            id="story-preview-overlay"
            onClick={(e: any) =>
              e.target.id === "story-preview-overlay" &&
              !isUploadingStory &&
              setStoryPreviewUrl(null)
            }
            className="fixed inset-0 z-[700] bg-black/95 flex items-center justify-center p-4 animate-in fade-in"
          >
            <div className="bg-zinc-900 rounded-[2rem] w-full max-w-sm overflow-hidden flex flex-col relative border border-zinc-800 h-[80vh] shadow-2xl">
              <button
                onClick={() => !isUploadingStory && setStoryPreviewUrl(null)}
                className="absolute top-4 right-4 z-50 p-2 bg-black/50 text-white rounded-full hover:bg-white hover:text-black transition"
              >
                <X size={20} />
              </button>
        ...
        {showPaymentModal && (
          <div
            id="modal-overlay"
            onClick={(e: any) =>
              e.target.id === "modal-overlay" && setShowPaymentModal(false)
            }
            className="fixed inset-0 z-[600] flex items-center justify-center p-4 sm:p-6 bg-black/90 backdrop-blur-sm animate-in fade-in duration-300"
          >
            <div className="bg-white p-8 rounded-[3rem] max-w-md w-full relative shadow-[0_0_50px_rgba(57,255,20,0.15)] border-t-[8px] border-[#39FF14] animate-in zoom-in-95 my-auto flex flex-col overflow-hidden">
              ...
              <div className="text-center mb-8 shrink-0 mt-4">
                <div className="w-20 h-20 bg-black text-[#39FF14] rounded-[2rem] mx-auto flex items-center justify-center mb-6 shadow-xl">
                  <CreditCard size={32} />
                </div>
                <h3
                  className={`${spaceGrotesk.className} text-3xl font-black uppercase text-black tracking-tighter`}
              ...
              <div className="bg-zinc-50 p-6 rounded-3xl border border-zinc-100 mb-6">
                ...
                <p className="text-xs text-zinc-500 font-medium leading-relaxed mb-4">
                  Prolongez votre accès au Smart Planner, au générateur de
                  listes de courses, et au réseau communautaire privé
                  OnyxNutrition.
                </p>
                <div className="pt-4 border-t border-zinc-200">
                  <p className="text-[10px] font-black uppercase text-green-600 tracking-widest mb-3 flex items-center gap-1">
                    <Sparkles size={12} /> Débloquez la Galerie Complète :
                  </p>
                  <div className="flex flex-wrap gap-2">
                    <span className="bg-[#39FF14]/20 text-green-800 border border-[#39FF14]/50 px-2.5 py-1 rounded-lg text-[10px] font-black uppercase tracking-widest shadow-sm">
                      📉 Low Carb
                    </span>
                    <span className="bg-[#39FF14]/20 text-green-800 border border-[#39FF14]/50 px-2.5 py-1 rounded-lg text-[10px] font-black uppercase tracking-widest shadow-sm">
                      💪 Protéinés
              ...
              <div className="space-y-3">
                <button
                  onClick={() => {
                    window.open(
                      "https://pay.onyxlinks.com/renew-nutrition",
                      "_blank",
                    );
                    if (
                      confirm(
                        "Simulation: Avez-vous terminé le paiement Wave/OM ?",
                      )
                    ) {
        ...
        {rokhyMessage && (
          <div className="fixed bottom-6 left-6 z-[110] bg-white p-5 rounded-3xl shadow-2xl border border-zinc-100 max-w-sm flex gap-4 animate-in slide-in-from-bottom-8">
            ...
            <div>
              ...
              <p
                className={`text-xs font-bold ${rokhyMessage.type === "warning" ? "text-orange-600" : "text-zinc-600"} leading-relaxed`}
              >
                {rokhyMessage.text}
              </p>
            </div>
        ...
        <footer className="bg-black text-white py-16 mt-20 border-t-4 border-[#39FF14]">
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 text-left">
            <div className="md:col-span-2">
              ...
              <p className="text-zinc-400 font-medium text-sm max-w-sm leading-relaxed mb-6">
                La première application nutritionnelle 100% adaptée aux réalités
                africaines. Atteignez vos objectifs sans abandonner vos plats
                locaux préférés.
              </p>
              <div className="flex gap-4">
                <button
                  ...
                  className="w-12 h-12 bg-white/5 rounded-2xl flex items-center justify-center hover:bg-[#39FF14] hover:text-black transition-colors text-zinc-400"
                >
                  <MessageCircle size={20} />
                </button>
                <button
                  onClick={() =>
                    window.open("https://instagram.com/onyx", "_blank")
                  }
                  className="w-12 h-12 bg-white/5 rounded-2xl flex items-center justify-center hover:bg-[#39FF14] hover:text-black transition-colors text-zinc-400"
                >
                  <Camera size={20} />
                ...
                <button
                  onClick={() =>
                    window.open("https://tiktok.com/@onyx", "_blank")
                  }
                  className="w-12 h-12 bg-white/5 rounded-2xl flex items-center justify-center hover:bg-[#39FF14] hover:text-black transition-colors text-zinc-400"
                >
                  <Video size={20} />
            ...
            <div>
              <h4 className="font-black text-lg uppercase tracking-widest mb-6 flex items-center gap-2">
                <Compass className="text-[#39FF14]" /> Ressources
              </h4>
              <ul className="space-y-4 text-zinc-400 font-bold text-sm">
                <li>
                  <button
                    onClick={() =>
                      window.open("https://rokhydiallo.com", "_blank")
                    }
                    className="hover:text-[#39FF14] transition-colors flex items-center gap-2"
                  >
                    <ArrowRight size={14} /> Notre Méthode
                  </button>
                </li>
                <li>
                  <button
                    onClick={() =>
                      window.open("https://rokhydiallo.com/boutique", "_blank")
                    }
                    className="hover:text-[#39FF14] transition-colors flex items-center gap-2"
                  >
                    <ArrowRight size={14} /> Boutique Onyx
                  </button>
                </li>
                <li>
                  <button
                    onClick={() =>
                      window.open("https://rokhydiallo.com/contact", "_blank")
                    }
                    className="hover:text-[#39FF14] transition-colors flex items-center gap-2"
                  >
                    <ArrowRight size={14} /> Espace Coaching
                  </button>
                </li>
              </ul>
            </div>
            <div>
              <h4 className="font-black text-lg uppercase tracking-widest mb-6 flex items-center gap-2">
                <Settings className="text-[#39FF14]" /> Légal & Aide
              </h4>
              <ul className="space-y-4 text-zinc-400 font-bold text-sm mb-8">
                <li>
                  <button className="hover:text-[#39FF14] transition-colors flex items-center gap-2">
                    <ArrowRight size={14} /> CGV / CGU
                  </button>
                </li>
                <li>
                  <button className="hover:text-[#39FF14] transition-colors flex items-center gap-2">
                    <ArrowRight size={14} /> Politique de Confidentialité
                  </button>
                </li>
                <li>
                  <button className="hover:text-[#39FF14] transition-colors flex items-center gap-2">
                    <ArrowRight size={14} /> Support Client (WhatsApp)
                  </button>
                </li>
              </ul>
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-3">
                  <div className="bg-white/5 border border-white/10 px-4 py-2 rounded-xl flex items-center gap-2 opacity-50 grayscale cursor-not-allowed">
                    <Apple size={20} />
                    <div>
                      <p className="text-[8px] uppercase font-bold text-zinc-400">
                        Download on
                      </p>
          ...
          <div className="max-w-7xl mx-auto px-6 mt-16 pt-8 border-t border-zinc-900 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-xs font-bold text-zinc-600">
              © {new Date().getFullYear()} Onyx Ops Elite. Tous droits réservés.
            </p>
            <p className="text-[10px] font-black tracking-widest uppercase text-zinc-700 bg-zinc-900 px-3 py-1.5 rounded-full">
              Designed in Senegal 🇸🇳
            </p>
          </div>
        </footer>
        ...
        <AnimatePresence>
          {showCartModal && (
            <div
              ...
              onClick={(e: any) =>
                e.target.id === "cart-modal-overlay" && setShowCartModal(false)
              }
              className="fixed inset-0 z-[250] bg-black/90 backdrop-blur-md flex justify-end animate-in fade-in"
            >
              <motion.div
                initial={{ x: "100%" }}
                animate={{ x: 0 }}
              ...
              >
                <div className="p-6 border-b border-zinc-200 dark:border-zinc-800 flex justify-between items-center">
                  <h2
                    className={`${spaceGrotesk.className} text-2xl font-black uppercase flex items-center gap-2 text-black dark:text-white`}
                  >
                    <ShoppingCart className="text-[#39FF14]" size={24} /> Mon
                    Panier
                  </h2>
                  <div className="flex items-center gap-4">
                    {shopCart.length > 0 && (
                      <button
                        onClick={() => {
                          if (
                            confirm("Voulez-vous vraiment vider votre panier ?")
                          )
                            setShopCart([]);
                        }}
                    ...
                    <button
                      ...
                      className="p-2 bg-zinc-100 dark:bg-zinc-900 rounded-full hover:bg-black hover:text-[#39FF14] transition-colors"
                    >
                      <X size={16} />
                    </button>
                  </div>
                ...
                <div className="p-4 bg-zinc-50 dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-800">
                  {remainingForFreeShipping > 0 ? (
                    <p className="text-xs font-bold text-black dark:text-white mb-2 text-center">
                      Plus que{" "}
                      <span className="text-[#39FF14] font-black">
                        {remainingForFreeShipping.toLocaleString()} F
                      </span>{" "}
                      pour la livraison gratuite !
                    </p>
                  ) : (
                    <p className="text-xs font-bold text-[#39FF14] mb-2 text-center flex items-center justify-center gap-1">
                      <CheckCircle size={14} /> Livraison gratuite débloquée !
                    </p>
                  )}
                  ...
                  {shopCart.length === 0 ? (
                    <div className="h-full flex flex-col items-center justify-center text-zinc-500">
                      ...
                      <button
                        ...
                        className="mt-6 bg-[#39FF14] text-black px-6 py-3 rounded-xl font-black uppercase text-xs hover:scale-105 transition-transform shadow-md"
                      >
                    ...
                    shopCart.map((item, idx) => (
                      <div
                        key={idx}
                        className={`flex gap-4 p-4 rounded-2xl border ${theme === "dark" ? "bg-zinc-900 border-zinc-800" : "bg-zinc-50 border-zinc-100"} relative`}
                      >
                        ...
                        <div className="flex-1 flex flex-col justify-center min-w-0">
                          <h4 className="font-bold text-sm text-black dark:text-white line-clamp-1">
                            {item.nom}
                          </h4>
                        ...
                        <button
                          onClick={() =>
                            setShopCart(shopCart.filter((_, i) => i !== idx))
                          }
                    ...
                    <div className="mt-4 pt-4 border-t border-zinc-200 dark:border-zinc-800">
                      ...
                      <div className="space-y-2">
                        {crossSellProducts.map((p: any) => (
                          <div
                            key={p.id}
                            className="flex items-center gap-3 bg-white dark:bg-zinc-950 p-2 rounded-xl border border-zinc-200 dark:border-zinc-800"
                          >
                            <img
                              src={
                                p.image_url ||
                            ...
                            />
                            <div className="flex-1 min-w-0">
                              <p className="font-bold text-xs truncate text-black dark:text-white">
                                {p.nom}
                              </p>
                              <p className="text-[#39FF14] font-black text-xs">
                                {(p.prix_standard || 0).toLocaleString()} F
                              </p>
                            </div>
                            <button
                              onClick={() => addToCart(p)}
                              className="p-2 bg-zinc-100 dark:bg-zinc-800 text-black dark:text-white rounded-lg hover:bg-[#39FF14] hover:text-black dark:hover:text-black transition-colors"
                            >
                              <Plus size={14} />
                            </button>
                          </div>
                ...
                {shopCart.length > 0 && (
                  <div className="p-6 border-t border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/50">
                    <div className="mb-4">
                      ...
                      <input
                        type="text"
                        placeholder="Ex: Cité Keur Gorgui, Villa 24B"
                        value={deliveryAddress}
                        onChange={(e) => setDeliveryAddress(e.target.value)}
                    ...
                    <div className="flex justify-between items-center mb-6">
                      <span className="font-black text-zinc-500 uppercase tracking-widest text-xs">
                        Total Estimé
                      </span>
                    ...
                    <button
                      ...
                      className="w-full bg-black dark:bg-white text-[#39FF14] dark:text-black py-4 rounded-2xl font-black uppercase text-xs tracking-widest shadow-xl hover:scale-105 transition-transform flex items-center justify-center gap-2"
                    >
                    ...
                    <button
                      onClick={async () => {
                        ...
                        shopCart.forEach((item) => {
                          shareMsg += `- ${item.nom} (x${item.quantity}) : ${((item.finalPrice || item.prix_premium || item.prix_standard || 0) * item.quantity).toLocaleString()} F\n`;
                        });
                        ...
                        window.open(
                          `https://wa.me/221785338417?text=${encodeURIComponent(shareMsg)}`,
                          "_blank",
                        );
                      }}
                    ...
                    >
                      <MessageSquare size={16} /> M'envoyer mon panier
                      (WhatsApp)
                    </button>
                    ...
                    {isShopPromoApplied && appliedPromoData ? (
                      <p className="text-center text-[#39FF14] font-black uppercase tracking-widest text-[10px] mt-4">
                        Code {appliedPromoData.code} appliqué !
                      </p>
                    ) : (
                      <div className="mt-4 flex gap-2">
                        <input
                          ...
                          className={`flex-1 p-3 rounded-xl border font-bold text-xs outline-none focus:border-[#39FF14] ${theme === "dark" ? "bg-zinc-950 border-zinc-800 text-white" : "bg-white border-zinc-200 text-black"}`}
                        />
                        <button
                          onClick={applyShopPromo}
                          className="bg-zinc-200 dark:bg-zinc-800 text-black dark:text-white px-4 py-3 rounded-xl font-black uppercase text-[10px] hover:bg-[#39FF14] hover:text-black transition-colors"
                        >
                          Appliquer
                        </button>
                      </div>
        ...
        {showCartExitIntent && (
          <div
            id="cart-exit-overlay"
            onClick={(e: any) =>
              e.target.id === "cart-exit-overlay" &&
              setShowCartExitIntent(false)
            }
            className="fixed inset-0 z-[300] flex items-center justify-center p-4 bg-black/90 backdrop-blur-md animate-in fade-in"
          >
            <div className="bg-white dark:bg-zinc-950 border-t-8 border-[#39FF14] rounded-[2rem] w-full max-w-md p-8 shadow-2xl relative animate-in zoom-in-95 text-center">
              <button
                onClick={() => setShowCartExitIntent(false)}
                className="absolute top-4 right-4 text-zinc-400 hover:text-black dark:hover:text-white transition"
              >
                <X size={20} />
              </button>
              ...
              <h3 className="text-3xl font-black uppercase tracking-tighter mb-4 text-black dark:text-white">
                Attendez !
              </h3>
              <p className="text-zinc-600 dark:text-zinc-400 font-medium mb-6">
                Vous allez laisser vos articles ? Voici{" "}
                <span className="font-black text-black dark:text-white">
                  10% de réduction immédiate
                </span>{" "}
                pour valider votre panier maintenant.
              </p>
              <div className="bg-zinc-100 dark:bg-zinc-900 border-2 border-dashed border-zinc-300 dark:border-zinc-700 rounded-xl p-4 mb-6">
                ...
                <p className="text-2xl font-black text-[#39FF14] tracking-widest">
                  CODE10
                </p>
              </div>
              <button
              ...
              <button
                onClick={() => setShowCartExitIntent(false)}
                className="mt-4 text-xs font-bold text-zinc-400 uppercase tracking-widest hover:text-black dark:hover:text-white transition"
              >
                Non merci, je quitte
              </button>
            </div>
      ...
      <div className="fixed bottom-6 right-6 z-[100] flex flex-col items-end">
        {isThiernoChatOpen && (
          <div
            className={`rounded-[2rem] shadow-2xl border-2 border-[#39FF14] p-0 mb-4 w-[calc(100vw-2rem)] md:w-[340px] h-[450px] max-h-[70vh] flex flex-col animate-in zoom-in duration-300 overflow-hidden ${theme === "dark" ? "bg-zinc-950" : "bg-white"}`}
          >
            <div className="bg-black p-4 flex justify-between items-center border-b border-zinc-800">
              <div className="flex items-center gap-3">
                <div className="relative">
                  <div className="w-10 h-10 rounded-full bg-zinc-800 border border-[#39FF14] flex items-center justify-center text-xl overflow-hidden">
                    <img
                      src="https://res.cloudinary.com/dtr2wtoty/image/upload/v1781448403/A_photorealistic_portrait_of_the_202606141444_qcvy4q.jpg"
                      alt="Dr. Thierno"
                      className="w-full h-full object-cover"
                    />
                  </div>
                ...
                <div>
                  <p className="text-[#39FF14] font-black uppercase text-xs">
                    Dr. Thierno
                  </p>
              ...
              <div className="flex items-center gap-3">
                <button
                  onClick={toggleThiernoVoice}
                  className={`p-2 rounded-full transition ${isThiernoVoiceEnabled ? "bg-[#39FF14]/20 text-[#39FF14]" : "bg-zinc-800 text-zinc-500 hover:text-white"}`}
                ...
                <button
                  onClick={() => setIsThiernoChatOpen(false)}
            ...
            <div
              className={`flex-1 p-4 overflow-y-auto flex flex-col space-y-4 custom-scrollbar ${theme === "dark" ? "bg-zinc-900" : "bg-zinc-50"}`}
            >
              {thiernoMessages.map((msg, i) => (
                ...
                >
                  <div
                    className={`p-3 rounded-2xl max-w-[90%] text-sm font-medium whitespace-pre-wrap ${msg.sender === "bot" ? (theme === "dark" ? "bg-zinc-800 text-white border-zinc-700" : "bg-white text-zinc-800 border-zinc-200") + " border rounded-tl-none shadow-sm" : "bg-black text-[#39FF14] rounded-tr-none shadow-md"}`}
                  >
                    {msg.text}
                  </div>
                </div>
            ...
            <div
              className={`p-3 border-t flex gap-2 ${theme === "dark" ? "bg-zinc-950 border-zinc-800" : "bg-white border-zinc-200"}`}
            >
              <input
                type="text"
                value={thiernoUserReply}
                onChange={(e) => setThiernoUserReply(e.target.value)}
                onKeyDown={(e) =>
                  e.key === "Enter" && processThiernoReply(thiernoUserReply)
                }
                placeholder="Poser une question..."
                className={`flex-1 rounded-xl px-4 outline-none text-sm font-bold focus:ring-1 focus:ring-black ${theme === "dark" ? "bg-zinc-900 text-white" : "bg-zinc-100 text-black"}`}
              />
              <button
                onClick={() => processThiernoReply(thiernoUserReply)}
                className="bg-black p-3 rounded-xl text-[#39FF14] hover:scale-105 transition"
              >
                <CheckCircle size={18} />
              </button>
            </div>
        ...
        {!isThiernoChatOpen && !isThiernoDismissed && (
          <div className="relative group animate-bounce flex items-center justify-center">
            ...
            <button
              onClick={() => setIsThiernoChatOpen(true)}
              className="w-16 h-16 rounded-full shadow-2xl overflow-hidden border-2 border-[#39FF14] hover:scale-110 transition-transform bg-black relative flex items-center justify-center text-3xl"
            >
              <img
                src="https://res.cloudinary.com/dtr2wtoty/image/upload/v1781448403/A_photorealistic_portrait_of_the_202606141444_qcvy4q.jpg"
                alt="Dr. Thierno"
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-zinc-950 border-t border-zinc-200 dark:border-zinc-800 flex justify-between items-center px-4 py-2 z-[100] pb-safe shadow-[0_-10px_30px_rgba(0,0,0,0.1)]">
        <button
          ...
          className={`flex flex-col items-center gap-1 flex-1 ${activeTab === "week" ? "opacity-100" : "opacity-50"}`}
        >
          <img
            src={MENU_ICONS.samaMenu}
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 flex-1 ${activeTab === "today" ? "opacity-100" : "opacity-50"}`}
        >
          <img
            src={MENU_ICONS.monJour}
            className="w-5 h-5 rounded-md object-cover"
        ...
        <div className="flex-1 flex justify-center -mt-6">
          <button
            onClick={() => {
              handleMealClick("Collation", null, "flexible");
              setTimeout(() => setIsScanning(true), 300);
            }}
            className="bg-black text-[#39FF14] w-14 h-14 rounded-full shadow-[0_10px_20px_rgba(57,255,20,0.3)] border-4 border-[#f4f4f5] dark:border-zinc-950 flex items-center justify-center hover:scale-110 transition-transform"
          >
            <ScanLine size={24} />
          </button>
        </div>
        <button
          ...
          className={`flex flex-col items-center gap-1 flex-1 ${activeTab === "shop" ? "opacity-100" : "opacity-50"}`}
        >
          <img
            src={MENU_ICONS.shop}
            className="w-5 h-5 rounded-md object-cover"
        ...
        <button
          onClick={() => setShowMobileHub(true)}
          className={`flex flex-col items-center gap-1 flex-1 opacity-50`}
        >
          <MenuIcon size={20} className="text-zinc-500" />
          <span className="text-[8px] font-black uppercase tracking-widest mt-0.5 text-zinc-500">
            Menu
          </span>
        </button>
      </div>
