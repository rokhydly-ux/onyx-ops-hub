...
import { 
  ChevronLeft, ChevronRight, Download, Lock, CheckCircle, Sun, Moon, Activity, Calendar, Clock, ArrowRight, Sparkles, HeartPulse, Droplet, Flame, Target, ListChecks, Utensils, RefreshCcw, Compass, X, BarChart, Settings, Save, Award, MessageCircle, AlertCircle, Search, Trash2, Info, ShoppingCart, Scale, Camera, Image as ImageIcon, Trophy, CreditCard, ScanLine, Loader2, ExternalLink, Menu as MenuIcon, PanelLeftClose, PanelLeftOpen, ShoppingBag, Tag, Filter, Star, BookOpen, Heart, Box, Eye, Share2, AlertTriangle, Package, Minus, Plus, Gift, Apple, Video, MessageSquare
} from "lucide-react";
...
const RECIPES_DB = [
  ...
  { id: "r10", type: "Petit-déjeuner", nom: "Porridge de Fonio au Lait de Coco & Bouye", calories: 310, is_bol_commun: false, ingredients: [{nom: "Fonio", quantite: 40, unite: "g", rayon: "Marché local"}, {nom: "Lait de coco", quantite: 100, unite: "ml", rayon: "Supermarché"}, {nom: "Poudre de Baobab (Bouye)", quantite: 1, unite: "càs", rayon: "Boutique Onyx"}] },
  { id: "r11", type: "Petit-déjeuner", nom: "Smoothie Vert Moringa & Banane", calories: 250, is_bol_commun: false, ingredients: [{nom: "Poudre de Moringa", quantite: 1, unite: "càc", rayon: "Boutique Onyx"}, {nom: "Banane", quantite: 1, unite: "pièce", rayon: "Marché local"}, {nom: "Épinards", quantite: 1, unite: "poignée", rayon: "Marché local"}] },
  { id: "r12", type: "Petit-déjeuner", nom: "Omelette aux Légumes Locaux", calories: 280, is_bol_commun: false, ingredients: [{nom: "Oeufs", quantite: 2, unite: "pièce", rayon: "Supermarché"}, {nom: "Tomate", quantite: 1, unite: "pièce", rayon: "Marché local"}, {nom: "Oignon", quantite: 0.5, unite: "pièce", rayon: "Marché local"}] },
  { id: "r13", type: "Petit-déjeuner", nom: "Tartines Beurre d'Arachide pur", calories: 330, is_bol_commun: false, ingredients: [{nom: "Pain complet", quantite: 2, unite: "tranche", rayon: "Supermarché"}, {nom: "Pâte d'arachide pure", quantite: 1, unite: "càs", rayon: "Boutique Onyx"}] },
  { id: "r14", type: "Petit-déjeuner", nom: "Pancakes de Patate Douce", calories: 340, is_bol_commun: false, ingredients: [{nom: "Patate douce purée", quantite: 100, unite: "g", rayon: "Marché local"}, {nom: "Oeuf", quantite: 1, unite: "pièce", rayon: "Supermarché"}, {nom: "Flocons d'avoine", quantite: 20, unite: "g", rayon: "Supermarché"}] },
  { id: "r15", type: "Petit-déjeuner", nom: "Arraw (Bouillie) Sans Sucre", calories: 280, is_bol_commun: false, ingredients: [{nom: "Boules de mil (Arraw)", quantite: 50, unite: "g", rayon: "Marché local"}, {nom: "Lait écrémé", quantite: 150, unite: "ml", rayon: "Supermarché"}] },
  { id: "r16", type: "Petit-déjeuner", nom: "Yaourt Cajou & Graines de Courge", calories: 290, is_bol_commun: false, ingredients: [{nom: "Yaourt nature", quantite: 1, unite: "pot", rayon: "Supermarché"}, {nom: "Noix de cajou", quantite: 15, unite: "g", rayon: "Boutique Onyx"}, {nom: "Graines de courge", quantite: 10, unite: "g", rayon: "Boutique Onyx"}] },
  { id: "r41", type: "Petit-déjeuner", nom: "Omelette au Soumbala et Tomates", calories: 270, is_bol_commun: false, ingredients: [{nom: "Oeufs", quantite: 2, unite: "pièce", rayon: "Supermarché"}, {nom: "Soumbala / Nététou", quantite: 1, unite: "càc", rayon: "Boutique Onyx"}, {nom: "Tomate", quantite: 1, unite: "pièce", rayon: "Marché local"}] },
  { id: "r42", type: "Petit-déjeuner", nom: "Bowl Fonio, Fromage blanc et Mangue", calories: 330, is_bol_commun: false, ingredients: [{nom: "Fonio précuit", quantite: 40, unite: "g", rayon: "Boutique Onyx"}, {nom: "Fromage blanc", quantite: 100, unite: "g", rayon: "Supermarché"}, {nom: "Mangue", quantite: 0.5, unite: "pièce", rayon: "Marché local"}] },

  // --- DÉJEUNERS ---
  { id: "r3", type: "Déjeuner", nom: "Thieboudienne (Option Fonio)", calories: 600, is_bol_commun: true, ingredients: [{nom: "Thiof (Poisson)", quantite: 150, unite: "g", rayon: "Boucherie / Pêche"}, {nom: "Fonio", quantite: 80, unite: "g", rayon: "Boutique Onyx"}, {nom: "Chou", quantite: 0.5, unite: "pièce", rayon: "Marché local"}, {nom: "Huile d'olive ou colza", quantite: 1, unite: "càs", rayon: "Supermarché"}, {nom: "Carotte", quantite: 1, unite: "pièce", rayon: "Marché local"}] },
  ...
  { id: "r5", type: "Déjeuner", nom: "Salade de Fonio au Poulet", calories: 450, is_bol_commun: false, ingredients: [{nom: "Poulet", quantite: 150, unite: "g", rayon: "Boucherie / Pêche"}, {nom: "Fonio", quantite: 60, unite: "g", rayon: "Boutique Onyx"}, {nom: "Tomate", quantite: 2, unite: "pièce", rayon: "Marché local"}, {nom: "Moutarde", quantite: 1, unite: "càc", rayon: "Supermarché"}] },
  { id: "r17", type: "Déjeuner", nom: "Yassa Poisson (Option Fonio)", calories: 500, is_bol_commun: true, ingredients: [{nom: "Poisson braisé", quantite: 150, unite: "g", rayon: "Boucherie / Pêche"}, {nom: "Oignons", quantite: 150, unite: "g", rayon: "Marché local"}, {nom: "Fonio", quantite: 60, unite: "g", rayon: "Boutique Onyx"}, {nom: "Moutarde", quantite: 1, unite: "càs", rayon: "Supermarché"}] },
  { id: "r18", type: "Déjeuner", nom: "C'est Bon (Poisson Grillé) & Légumes", calories: 480, is_bol_commun: false, ingredients: [{nom: "Poisson", quantite: 200, unite: "g", rayon: "Boucherie / Pêche"}, {nom: "Légumes (Chou, Carotte)", quantite: 200, unite: "g", rayon: "Marché local"}, {nom: "Soumbala", quantite: 1, unite: "càc", rayon: "Boutique Onyx"}] },
  { id: "r19", type: "Déjeuner", nom: "Soupe Kandia (Gombo) Diététique", calories: 520, is_bol_commun: true, ingredients: [{nom: "Bœuf maigre", quantite: 100, unite: "g", rayon: "Boucherie / Pêche"}, {nom: "Gombos frais", quantite: 150, unite: "g", rayon: "Marché local"}, {nom: "Fonio", quantite: 60, unite: "g", rayon: "Boutique Onyx"}] },
  { id: "r20", type: "Déjeuner", nom: "Chili de Niébé à la Viande", calories: 490, is_bol_commun: true, ingredients: [{nom: "Viande hachée maigre", quantite: 100, unite: "g", rayon: "Boucherie / Pêche"}, {nom: "Niébé", quantite: 80, unite: "g", rayon: "Marché local"}, {nom: "Sauce tomate pure", quantite: 100, unite: "ml", rayon: "Supermarché"}] },
  { id: "r21", type: "Déjeuner", nom: "Couscous de Mil (Thiéré) Poulet", calories: 540, is_bol_commun: true, ingredients: [{nom: "Poulet", quantite: 150, unite: "g", rayon: "Boucherie / Pêche"}, {nom: "Thiéré (Couscous mil)", quantite: 60, unite: "g", rayon: "Marché local"}, {nom: "Légumes", quantite: 150, unite: "g", rayon: "Marché local"}] },
  { id: "r22", type: "Déjeuner", nom: "Fonio aux Crevettes & Poivrons", calories: 430, is_bol_commun: false, ingredients: [{nom: "Crevettes", quantite: 150, unite: "g", rayon: "Boucherie / Pêche"}, {nom: "Fonio", quantite: 60, unite: "g", rayon: "Boutique Onyx"}, {nom: "Poivrons", quantite: 150, unite: "g", rayon: "Marché local"}] },
  { id: "r23", type: "Déjeuner", nom: "Mbakhal Saloum Allégé", calories: 510, is_bol_commun: true, ingredients: [{nom: "Viande maigre", quantite: 100, unite: "g", rayon: "Boucherie / Pêche"}, {nom: "Pâte d'arachide pure", quantite: 15, unite: "g", rayon: "Boutique Onyx"}, {nom: "Riz brisé", quantite: 60, unite: "g", rayon: "Marché local"}] },
  { id: "r43", type: "Déjeuner", nom: "Salade tiède Patate Douce, Poulet & Courge", calories: 480, is_bol_commun: false, ingredients: [{nom: "Patate douce", quantite: 150, unite: "g", rayon: "Marché local"}, {nom: "Blanc de poulet", quantite: 120, unite: "g", rayon: "Boucherie / Pêche"}, {nom: "Graines de courge", quantite: 15, unite: "g", rayon: "Boutique Onyx"}] },
  { id: "r44", type: "Déjeuner", nom: "Yassa Poulet Fonio", calories: 520, is_bol_commun: true, ingredients: [{nom: "Poulet", quantite: 150, unite: "g", rayon: "Boucherie / Pêche"}, {nom: "Oignons", quantite: 150, unite: "g", rayon: "Marché local"}, {nom: "Fonio", quantite: 60, unite: "g", rayon: "Boutique Onyx"}, {nom: "Huile d'olive", quantite: 1, unite: "càs", rayon: "Supermarché"}] },

  // --- DÎNERS ---
  { id: "r6", type: "Dîner", nom: "Salade de Niébé fraîcheur", calories: 400, is_bol_commun: false, ingredients: [{nom: "Niébé (Haricots)", quantite: 100, unite: "g", rayon: "Marché local"}, {nom: "Concombre", quantite: 1, unite: "pièce", rayon: "Marché local"}, {nom: "Vinaigrette légère", quantite: 1, unite: "càs", rayon: "Supermarché"}] },
  ...
  { id: "r24", type: "Dîner", nom: "Poisson braisé (Yaboye) & Jaxatu", calories: 380, is_bol_commun: false, ingredients: [{nom: "Yaboye", quantite: 150, unite: "g", rayon: "Boucherie / Pêche"}, {nom: "Jaxatu", quantite: 100, unite: "g", rayon: "Marché local"}] },
  { id: "r25", type: "Dîner", nom: "Blanc de Poulet sauté au Djar", calories: 350, is_bol_commun: false, ingredients: [{nom: "Blanc de poulet", quantite: 150, unite: "g", rayon: "Boucherie / Pêche"}, {nom: "Haricots verts", quantite: 150, unite: "g", rayon: "Marché local"}, {nom: "Grains de Djar", quantite: 1, unite: "pincée", rayon: "Marché local"}] },
  { id: "r26", type: "Dîner", nom: "Omelette Moringa & Champignons", calories: 320, is_bol_commun: false, ingredients: [{nom: "Oeufs", quantite: 2, unite: "pièce", rayon: "Supermarché"}, {nom: "Poudre de Moringa", quantite: 1, unite: "càc", rayon: "Boutique Onyx"}, {nom: "Champignons", quantite: 100, unite: "g", rayon: "Supermarché"}] },
  { id: "r27", type: "Dîner", nom: "Sauté de Bœuf aux Gombos", calories: 390, is_bol_commun: false, ingredients: [{nom: "Bœuf maigre", quantite: 120, unite: "g", rayon: "Boucherie / Pêche"}, {nom: "Gombo", quantite: 100, unite: "g", rayon: "Marché local"}] },
  { id: "r28", type: "Dîner", nom: "Papillote de Poisson Citronnée", calories: 310, is_bol_commun: false, ingredients: [{nom: "Poisson blanc", quantite: 150, unite: "g", rayon: "Boucherie / Pêche"}, {nom: "Citron", quantite: 1, unite: "pièce", rayon: "Marché local"}, {nom: "Courgettes", quantite: 150, unite: "g", rayon: "Marché local"}] },
  { id: "r29", type: "Dîner", nom: "Salade de Thon, Avocat & Graines", calories: 420, is_bol_commun: false, ingredients: [{nom: "Thon nature", quantite: 100, unite: "g", rayon: "Supermarché"}, {nom: "Avocat", quantite: 0.5, unite: "pièce", rayon: "Marché local"}, {nom: "Graines de courge", quantite: 10, unite: "g", rayon: "Boutique Onyx"}] },
  { id: "r30", type: "Dîner", nom: "Velouté de Courge & Moringa", calories: 280, is_bol_commun: false, ingredients: [{nom: "Courge", quantite: 200, unite: "g", rayon: "Marché local"}, {nom: "Poudre de Moringa", quantite: 1, unite: "càc", rayon: "Boutique Onyx"}] },
  { id: "r31", type: "Dîner", nom: "Émincé de Volaille aux Épices & Soumbala", calories: 360, is_bol_commun: false, ingredients: [{nom: "Volaille", quantite: 150, unite: "g", rayon: "Boucherie / Pêche"}, {nom: "Légumes mélangés", quantite: 200, unite: "g", rayon: "Marché local"}, {nom: "Soumbala", quantite: 1, unite: "càc", rayon: "Boutique Onyx"}] },
  { id: "r45", type: "Dîner", nom: "Salade Poulet, Concombre & Vinaigrette", calories: 330, is_bol_commun: false, ingredients: [{nom: "Blanc de poulet", quantite: 120, unite: "g", rayon: "Boucherie / Pêche"}, {nom: "Concombre", quantite: 1, unite: "pièce", rayon: "Marché local"}, {nom: "Vinaigrette allégée", quantite: 1, unite: "càs", rayon: "Supermarché"}] },
  { id: "r46", type: "Dîner", nom: "Brochettes de Poisson et Tomates", calories: 350, is_bol_commun: false, ingredients: [{nom: "Poisson blanc", quantite: 150, unite: "g", rayon: "Boucherie / Pêche"}, {nom: "Tomates cerises", quantite: 100, unite: "g", rayon: "Marché local"}, {nom: "Huile d'olive", quantite: 1, unite: "càc", rayon: "Supermarché"}] },
  ...
  { id: "r32", type: "Collation", nom: "Infusion Bissap Pur & Noix de Cajou", calories: 160, is_bol_commun: false, ingredients: [{nom: "Bissap rouge séché", quantite: 10, unite: "g", rayon: "Boutique Onyx"}, {nom: "Noix de cajou", quantite: 15, unite: "g", rayon: "Boutique Onyx"}] },
  { id: "r33", type: "Collation", nom: "Yaourt Nature à la poudre de Bouye", calories: 140, is_bol_commun: false, ingredients: [{nom: "Yaourt nature", quantite: 1, unite: "pot", rayon: "Supermarché"}, {nom: "Poudre de Baobab", quantite: 1, unite: "càc", rayon: "Supermarché"}] },
  { id: "r34", type: "Collation", nom: "Bâtonnets de Carotte & Concombre", calories: 80, is_bol_commun: false, ingredients: [{nom: "Carotte", quantite: 1, unite: "pièce", rayon: "Marché local"}, {nom: "Concombre", quantite: 0.5, unite: "pièce", rayon: "Marché local"}] },
  { id: "r35", type: "Collation", nom: "Graines de Courge Grillées", calories: 150, is_bol_commun: false, ingredients: [{nom: "Graines de courge", quantite: 25, unite: "g", rayon: "Boutique Onyx"}] },
  { id: "r36", type: "Collation", nom: "Infusion Kinkeliba & Chocolat Noir", calories: 120, is_bol_commun: false, ingredients: [{nom: "Kinkeliba", quantite: 1, unite: "tasse", rayon: "Marché local"}, {nom: "Chocolat noir 70%", quantite: 1, unite: "carré", rayon: "Supermarché"}] },
  { id: "r37", type: "Collation", nom: "Tranche de Pastèque Fraîche", calories: 90, is_bol_commun: false, ingredients: [{nom: "Pastèque", quantite: 200, unite: "g", rayon: "Marché local"}] },
  { id: "r38", type: "Collation", nom: "Lait Caillé (Sow) Nature", calories: 130, is_bol_commun: false, ingredients: [{nom: "Sow Nature", quantite: 150, unite: "ml", rayon: "Marché local"}] },
  { id: "r39", type: "Collation", nom: "2 Dattes & Noix de Cajou", calories: 160, is_bol_commun: false, ingredients: [{nom: "Dattes", quantite: 2, unite: "pièce", rayon: "Marché local"}, {nom: "Noix de cajou", quantite: 10, unite: "g", rayon: "Boutique Onyx"}] },
  { id: "r40", type: "Collation", nom: "Smoothie Mangue Allégé", calories: 140, is_bol_commun: false, ingredients: [{nom: "Mangue", quantite: 0.5, unite: "pièce", rayon: "Marché local"}, {nom: "Lait d'amande", quantite: 100, unite: "ml", rayon: "Supermarché"}] },
  { id: "r47", type: "Collation", nom: "Thé Vert Ataya Spécial & Amandes", calories: 130, is_bol_commun: false, ingredients: [{nom: "Thé vert Ataya Spécial", quantite: 1, unite: "tasse", rayon: "Boutique Onyx"}, {nom: "Amandes", quantite: 15, unite: "g", rayon: "Supermarché"}] }
];
