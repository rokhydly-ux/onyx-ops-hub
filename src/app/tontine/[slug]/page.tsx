                                      ...
                                      <div className="grid sm:grid-cols-2 gap-3">
                                          {hist.winners.map((w: any, i: number) => (
                                              <div key={i} className="flex items-center gap-3 bg-zinc-50 p-3 rounded-xl border border-zinc-100 hover:border-zinc-300 transition-colors">
                                                  ...
                                                  <div>
                                                  <p className="font-bold text-sm leading-tight text-black flex items-center gap-1">
                                                      {w.nom || "Inconnu"}
                                                      {currentUser?.is_admin && w.est_gagnant_force && <span title="Gagnant Forcé (Discret)" className="text-purple-500 ml-1"><Wand2 size={12} /></span>}
                                                  </p>
