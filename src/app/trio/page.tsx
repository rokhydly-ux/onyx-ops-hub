               ...
               {onboardingStep === 0 && (
                 <div className="space-y-6 animate-in slide-in-from-right-8">
                   ...
                   <div className="space-y-4">
                      ...
                      <button onClick={() => handleDirectWaClick('Démarrage Pack Trio', 'Bonjour, je souhaite démarrer un essai pour le Pack Trio.')} className="w-full bg-zinc-100 text-black py-5 rounded-[2rem] font-black uppercase text-sm shadow-sm hover:bg-zinc-200 transition flex items-center justify-center gap-3">
