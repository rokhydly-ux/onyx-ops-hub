                                      ...
                                      <div className="absolute top-4 right-4 z-[50]">
                                          <button
                                              ...
                                              onClick={(e) => {
                                                  e.preventDefault();
                                                  e.stopPropagation();
                                                  removeFromCartZustand(item.id);
                                              }}
                                              className="text-zinc-400 hover:text-red-500 transition-colors p-2 bg-zinc-50 rounded-full cursor-pointer"
                                          >
                                              <Trash2 size={16}/>
                                          </button>
                                      </div>
                                              ...
                                              <div className="flex items-center gap-4 bg-zinc-100 rounded-xl p-1 px-2 border border-zinc-200">
                                                  <button
                                                      ...
                                                      onClick={(e) => {
                                                          e.preventDefault();
                                                          e.stopPropagation();
                                                          updateQuantityZustand(item.id, parseInt(String(item.quantity || 1), 10) - 1);
                                                      }}
