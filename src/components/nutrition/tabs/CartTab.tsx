...
import { QUARTIERS, DELIVERY_ZONES, useCartStore } from '@/store/useCartStore';
                                  ...
                                  <div key={item.id} className="flex gap-4 p-4 border border-zinc-100 rounded-2xl relative shadow-sm z-10">
                                              ...
                                              <div className="flex items-center gap-3">
                                                  <button
                                                      ...
                                                      onClick={(e) => {
                                                          e.preventDefault();
                                                          e.stopPropagation();
                                                          updateQuantity(item.id, parseInt(String(item.quantity || 1), 10) - 1);
                                                      }}
                                                      className="p-1 hover:text-[#39FF14] text-black"
                                                  >
                                                      <Minus size={14}/>
                                                  </button>
                                      ...
                                      <div className="absolute top-4 right-4 z-[50]">
                                          <button
                                              ...
                                              className="text-zinc-400 hover:text-red-500 transition-colors p-2 bg-zinc-50 rounded-full cursor-pointer z-50"
                                          >
                                              <Trash2 size={16}/>
                                          </button>
                                      </div>
